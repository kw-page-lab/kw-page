...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Qn,depthTest:!1,depthWrite:!1})}function nc(){return new Nn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:No(),fragmentShader:`
		...
		`,blending:Qn,depthTest:!1,depthWrite:!1})}function ic(){return new Nn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:No(),fragmentShader:`
	...
	`}function Vm(r){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===oo||l===lo,u=l===ir||l===rr;if(c||u)if(o.isRenderTargetTexture&&o.needsPMREMUpdate===!0){o.needsPMREMUpdate=!1;let h=e.get(o);return t===null&&(t=new ec(r)),h=c?t.fromEquirectangular(o,h):t.fromCubemap(o,h),e.set(o,h),h.texture}else{if(e.has(o))return e.get(o).texture;{const h=o.image;if(c&&h&&h.height>0||u&&h&&i(h)){t===null&&(t=new ec(r));const d=c?t.fromEquirectangular(o):t.fromCubemap(o);return e.set(o,d),o.addEventListener("dispose",s),d.texture}else return null}}}return o}function i(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function Wm(r){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=r.getExtension("WEBGL_depth_texture")||r.getExtension("MOZ_WEBGL_depth_texture")||r.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=r.getExtension("EXT_texture_filter_anisotropic")||r.getExtension("MOZ_EXT_texture_filter_anisotropic")||r.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=r.getExtension("WEBGL_compressed_texture_s3tc")||r.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=r.getExtension("WEBGL_compressed_texture_pvrtc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=r.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){const i=t(n);return i===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function Xm(r,e,t,n){const i={},s=new WeakMap;function a(h){const d=h.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const _=d.morphAttributes[g];for(let p=0,f=_.length;p<f;p++)e.remove(_[p])}d.removeEventListener("dispose",a),delete i[d.id];const m=s.get(d);m&&(e.remove(m),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(h,d){return i[d.id]===!0||(d.addEventListener("dispose",a),i[d.id]=!0,t.memory.geometries++),d}function l(h){const d=h.attributes;for(const g in d)e.update(d[g],r.ARRAY_BUFFER);const m=h.morphAttributes;for(const g in m){const _=m[g];for(let p=0,f=_.length;p<f;p++)e.update(_[p],r.ARRAY_BUFFER)}}function c(h){const d=[],m=h.index,g=h.attributes.position;let _=0;if(m!==null){const E=m.array;_=m.version;for(let M=0,b=E.length;M<b;M+=3){const C=E[M+0],R=E[M+1],A=E[M+2];d.push(C,R,R,A,A,C)}}else if(g!==void 0){const E=g.array;_=g.version;for(let M=0,b=E.length/3-1;M<b;M+=3){const C=M+0,R=M+1,A=M+2;d.push(C,R,R,A,A,C)}}else return;const p=new(bu(d)?Pu:Lu)(d,1);p.version=_;const f=s.get(h);f&&e.remove(f),s.set(h,p)}function u(h){const d=s.get(h);if(d){const m=h.index;m!==null&&d.version<m.version&&c(h)}else c(h);return s.get(h)}return{get:o,update:l,getWireframeAttribute:u}}function Ym(r,e,t,n){const i=n.isWebGL2;let s;function a(m){s=m}let o,l;function c(m){o=m.type,l=m.bytesPerElement}function u(m,g){r.drawElements(s,g,o,m*l),t.update(g,s,1)}function h(m,g,_){if(_===0)return;let p,f;if(i)p=r,f="drawElementsInstanced";else if(p=e.get("ANGLE_instanced_arrays"),f="drawElementsInstancedANGLE",p===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}p[f](s,g,o,m*l,_),t.update(g,s,_)}function d(m,g,_){if(_===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let f=0;f<_;f++)this.render(m[f]/l,g[f]);else{p.multiDrawElementsWEBGL(s,g,0,o,m,0,_);let f=0;for(let E=0;E<_;E++)f+=g[E];t.update(f,s,1)}}this.setMode=a,this.setIndex=c,this.render=u,this.renderInstances=h,this.renderMultiDraw=d}function qm(r){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(t.calls++,a){case r.TRIANGLES:t.triangles+=o*(s/3);break;case r.LINES:t.lines+=o*(s/2);break;case r.LINE_STRIP:t.lines+=o*(s-1);break;case r.LINE_LOOP:t.lines+=o*s;break;case r.POINTS:t.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function jm(r,e){return r[0]-e[0]}function Km(r,e){return Math.abs(e[1])-Math.abs(r[1])}function Zm(r,e,t){const n={},i=new Float32Array(8),s=new WeakMap,a=new tt,o=[];for(let c=0;c<8;c++)o[c]=[c,0];function l(c,u,h){const d=c.morphTargetInfluences;if(e.isWebGL2===!0){const g=u.morphAttributes.position||u.morphAttributes.normal||u.morphAttributes.color,_=g!==void 0?g.length:0;let p=s.get(u);if(p===void 0||p.count!==_){let O=function(){$.dispose(),s.delete(u),u.removeEventListener("dispose",O)};var m=O;p!==void 0&&p.texture.dispose();const M=u.morphAttributes.position!==void 0,b=u.morphAttributes.normal!==void 0,C=u.morphAttributes.color!==void 0,R=u.morphAttributes.position||[],A=u.morphAttributes.normal||[],z=u.morphAttributes.color||[];let x=0;M===!0&&(x=1),b===!0&&(x=2),C===!0&&(x=3);let T=u.attributes.position.count*x,D=1;T>e.maxTextureSize&&(D=Math.ceil(T/e.maxTextureSize),T=e.maxTextureSize);const W=new Float32Array(T*D*4*_),$=new Ru(W,T,D,_);$.type=Pn,$.needsUpdate=!0;const I=x*4;for(let V=0;V<_;V++){const j=R[V],Y=A[V],K=z[V],q=T*D*4*V;for(let ie=0;ie<j.count;ie++){const Z=ie*I;M===!0&&(a.fromBufferAttribute(j,ie),W[q+Z+0]=a.x,W[q+Z+1]=a.y,W[q+Z+2]=a.z,W[q+Z+3]=0),b===!0&&(a.fromBufferAttribute(Y,ie),W[q+Z+4]=a.x,W[q+Z+5]=a.y,W[q+Z+6]=a.z,W[q+Z+7]=0),C===!0&&(a.fromBufferAttribute(K,ie),W[q+Z+8]=a.x,W[q+Z+9]=a.y,W[q+Z+10]=a.z,W[q+Z+11]=K.itemSize===4?a.w:1)}}p={count:_,texture:$,size:new be(T,D)},s.set(u,p),u.addEventListener("dispose",O)}let f=0;for(let M=0;M<d.length;M++)f+=d[M];const E=u.morphTargetsRelative?1:1-f;h.getUniforms().setValue(r,"morphTargetBaseInfluence",E),h.getUniforms().setValue(r,"morphTargetInfluences",d),h.getUniforms().setValue(r,"morphTargetsTexture",p.texture,t),h.getUniforms().setValue(r,"morphTargetsTextureSize",p.size)}else{const g=d===void 0?0:d.length;let _=n[u.id];if(_===void 0||_.length!==g){_=[];for(let b=0;b<g;b++)_[b]=[b,0];n[u.id]=_}for(let b=0;b<g;b++){const C=_[b];C[0]=b,C[1]=d[b]}_.sort(Km);for(let b=0;b<8;b++)b<g&&_[b][1]?(o[b][0]=_[b][0],o[b][1]=_[b][1]):(o[b][0]=Number.MAX_SAFE_INTEGER,o[b][1]=0);o.sort(jm);const p=u.morphAttributes.position,f=u.morphAttributes.normal;let E=0;for(let b=0;b<8;b++){const C=o[b],R=C[0],A=C[1];R!==Number.MAX_SAFE_INTEGER&&A?(p&&u.getAttribute("morphTarget"+b)!==p[R]&&u.setAttribute("morphTarget"+b,p[R]),f&&u.getAttribute("morphNormal"+b)!==f[R]&&u.setAttribute("morphNormal"+b,f[R]),i[b]=A,E+=A):(p&&u.hasAttribute("morphTarget"+b)===!0&&u.deleteAttribute("morphTarget"+b),f&&u.hasAttribute("morphNormal"+b)===!0&&u.deleteAttribute("morphNormal"+b),i[b]=0)}const M=u.morphTargetsRelative?1:1-E;h.getUniforms().setValue(r,"morphTargetBaseInfluence",M),h.getUniforms().setValue(r,"morphTargetInfluences",i)}}return{update:l}}function $m(r,e,t,n){let i=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,h=e.get(l,u);if(i.get(h)!==c&&(e.update(h),i.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),i.get(l)!==c&&(t.update(l.instanceMatrix,r.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,r.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;i.get(d)!==c&&(d.update(),i.set(d,c))}return h}function a(){i=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:a}}class Ou extends _t{constructor(e,t,n,i,s,a,o,l,c,u){if(u=u!==void 0?u:Mi,u!==Mi&&u!==sr)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===Mi&&(n=Yn),n===void 0&&u===sr&&(n=xi),super(null,i,s,a,o,l,u,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:gt,this.minFilter=l!==void 0?l:gt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Fu=new _t,Bu=new Ou(1,1);Bu.compareFunction=Tu;const Hu=new Ru,ku=new Ud,zu=new Uu,rc=[],sc=[],ac=new Float32Array(16),oc=new Float32Array(9),lc=new Float32Array(4);function pr(r,e,t){const n=r[0];if(n<=0||n>0)return r;const i=e*t;let s=rc[i];if(s===void 0&&(s=new Float32Array(i),rc[i]=s),e!==0){n.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,r[a].toArray(s,o)}return s}function St(r,e){if(r.length!==e.length)return!1;for(let t=0,n=r.length;t<n;t++)if(r[t]!==e[t])return!1;return!0}function Et(r,e){for(let t=0,n=e.length;t<n;t++)r[t]=e[t]}function Js(r,e){let t=sc[e];t===void 0&&(t=new Int32Array(e),sc[e]=t);for(let n=0;n!==e;++n)t[n]=r.allocateTextureUnit();return t}function Jm(r,e){const t=this.cache;t[0]!==e&&(r.uniform1f(this.addr,e),t[0]=e)}function Qm(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;r.uniform2fv(this.addr,e),Et(t,e)}}function eg(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(r.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(St(t,e))return;r.uniform3fv(this.addr,e),Et(t,e)}}function tg(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;r.uniform4fv(this.addr,e),Et(t,e)}}function ng(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;r.uniformMatrix2fv(this.addr,!1,e),Et(t,e)}else{if(St(t,n))return;lc.set(n),r.uniformMatrix2fv(this.addr,!1,lc),Et(t,n)}}function ig(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;r.uniformMatrix3fv(this.addr,!1,e),Et(t,e)}else{if(St(t,n))return;oc.set(n),r.uniformMatrix3fv(this.addr,!1,oc),Et(t,n)}}function rg(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;r.uniformMatrix4fv(this.addr,!1,e),Et(t,e)}else{if(St(t,n))return;ac.set(n),r.uniformMatrix4fv(this.addr,!1,ac),Et(t,n)}}function sg(r,e){const t=this.cache;t[0]!==e&&(r.uniform1i(this.addr,e),t[0]=e)}function ag(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;r.uniform2iv(this.addr,e),Et(t,e)}}function og(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(St(t,e))return;r.uniform3iv(this.addr,e),Et(t,e)}}function lg(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;r.uniform4iv(this.addr,e),Et(t,e)}}function cg(r,e){const t=this.cache;t[0]!==e&&(r.uniform1ui(this.addr,e),t[0]=e)}function ug(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;r.uniform2uiv(this.addr,e),Et(t,e)}}function hg(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(St(t,e))return;r.uniform3uiv(this.addr,e),Et(t,e)}}function dg(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;r.uniform4uiv(this.addr,e),Et(t,e)}}function fg(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i);const s=this.type===r.SAMPLER_2D_SHADOW?Bu:Fu;t.setTexture2D(e||s,i)}function pg(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||ku,i)}function mg(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||zu,i)}function gg(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||Hu,i)}function _g(r){switch(r){case 5126:return Jm;case 35664:return Qm;case 35665:return eg;case 35666:return tg;case 35674:return ng;case 35675:return ig;case 35676:return rg;case 5124:case 35670:return sg;case 35667:case 35671:return ag;case 35668:case 35672:return og;case 35669:case 35673:return lg;case 5125:return cg;case 36294:return ug;case 36295:return hg;case 36296:return dg;case 35678:case 36198:case 36298:case 36306:case 35682:return fg;case 35679:case 36299:case 36307:return pg;case 35680:case 36300:case 36308:case 36293:return mg;case 36289:case 36303:case 36311:case 36292:return gg}}function vg(r,e){r.uniform1fv(this.addr,e)}function xg(r,e){const t=pr(e,this.size,2);r.uniform2fv(this.addr,t)}function Mg(r,e){const t=pr(e,this.size,3);r.uniform3fv(this.addr,t)}function yg(r,e){const t=pr(e,this.size,4);r.uniform4fv(this.addr,t)}function Sg(r,e){const t=pr(e,this.size,4);r.uniformMatrix2fv(this.addr,!1,t)}function Eg(r,e){const t=pr(e,this.size,9);r.uniformMatrix3fv(this.addr,!1,t)}function Tg(r,e){const t=pr(e,this.size,16);r.uniformMatrix4fv(this.addr,!1,t)}function bg(r,e){r.uniform1iv(this.addr,e)}function Ag(r,e){r.uniform2iv(this.addr,e)}function wg(r,e){r.uniform3iv(this.addr,e)}function Rg(r,e){r.uniform4iv(this.addr,e)}function Cg(r,e){r.uniform1uiv(this.addr,e)}function Lg(r,e){r.uniform2uiv(this.addr,e)}function Pg(r,e){r.uniform3uiv(this.addr,e)}function Ig(r,e){r.uniform4uiv(this.addr,e)}function Dg(r,e,t){const n=this.cache,i=e.length,s=Js(t,i);St(n,s)||(r.uniform1iv(this.addr,s),Et(n,s));for(let a=0;a!==i;++a)t.setTexture2D(e[a]||Fu,s[a])}function Ug(r,e,t){const n=this.cache,i=e.length,s=Js(t,i);St(n,s)||(r.uniform1iv(this.addr,s),Et(n,s));for(let a=0;a!==i;++a)t.setTexture3D(e[a]||ku,s[a])}function Ng(r,e,t){const n=this.cache,i=e.length,s=Js(t,i);St(n,s)||(r.uniform1iv(this.addr,s),Et(n,s));for(let a=0;a!==i;++a)t.setTextureCube(e[a]||zu,s[a])}function Og(r,e,t){const n=this.cache,i=e.length,s=Js(t,i);St(n,s)||(r.uniform1iv(this.addr,s),Et(n,s));for(let a=0;a!==i;++a)t.setTexture2DArray(e[a]||Hu,s[a])}function Fg(r){switch(r){case 5126:return vg;case 35664:return xg;case 35665:return Mg;case 35666:return yg;case 35674:return Sg;case 35675:return Eg;case 35676:return Tg;case 5124:case 35670:return bg;case 35667:case 35671:return Ag;case 35668:case 35672:return wg;case 35669:case 35673:return Rg;case 5125:return Cg;case 36294:return Lg;case 36295:return Pg;case 36296:return Ig;case 35678:case 36198:case 36298:case 36306:case 35682:return Dg;case 35679:case 36299:case 36307:return Ug;case 35680:case 36300:case 36308:case 36293:return Ng;case 36289:case 36303:case 36311:case 36292:return Og}}class Bg{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=_g(t.type)}}class Hg{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Fg(t.type)}}class kg{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let s=0,a=i.length;s!==a;++s){const o=i[s];o.setValue(e,t[o.id],n)}}}const Fa=/(\w+)(\])?(\[|\.)?/g;function cc(r,e){r.seq.push(e),r.map[e.id]=e}function zg(r,e,t){const n=r.name,i=n.length;for(Fa.lastIndex=0;;){const s=Fa.exec(n),a=Fa.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===i){cc(t,c===void 0?new Bg(o,r,e):new Hg(o,r,e));break}else{let h=t.map[o];h===void 0&&(h=new kg(o),cc(t,h)),t=h}}}class Ls{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const s=e.getActiveUniform(t,i),a=e.getUniformLocation(t,s.name);zg(s,a,this)}}setValue(e,t,n,i){const s=this.map[t];s!==void 0&&s.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,s=e.length;i!==s;++i){const a=e[i];a.id in t&&n.push(a)}return n}}function uc(r,e,t){const n=r.createShader(e);return r.shaderSource(n,t),r.compileShader(n),n}const Gg=37297;let Vg=0;function Wg(r,e){const t=r.split(`
`),n=[],i=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=i;a<s;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}function Xg(r){const e=$e.getPrimaries($e.workingColorSpace),t=$e.getPrimaries(r);let n;switch(e===t?n="":e===Hs&&t===Bs?n="LinearDisplayP3ToLinearSRGB":e===Bs&&t===Hs&&(n="LinearSRGBToLinearDisplayP3"),r){case wt:case Ks:return[n,"LinearTransferOETF"];case Qe:case Po:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",r),[n,"LinearTransferOETF"]}}function hc(r,e,t){const n=r.getShaderParameter(e,r.COMPILE_STATUS),i=r.getShaderInfoLog(e).trim();if(n&&i==="")return"";const s=/ERROR: 0:(\d+)/.exec(i);if(s){const a=parseInt(s[1]);return t.toUpperCase()+`

`+i+`

`+Wg(r.getShaderSource(e),a)}else return i}function Yg(r,e){const t=Xg(e);return`vec4 ${r}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function qg(r,e){let t;switch(e){case Vh:t="Linear";break;case Wh:t="Reinhard";break;case Xh:t="OptimizedCineon";break;case hu:t="ACESFilmic";break;case qh:t="AgX";break;case Yh:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function jg(r){return[r.extensionDerivatives||r.envMapCubeUVHeight||r.bumpMap||r.normalMapTangentSpace||r.clearcoatNormalMap||r.flatShading||r.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(r.extensionFragDepth||r.logarithmicDepthBuffer)&&r.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",r.extensionDrawBuffers&&r.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(r.extensionShaderTextureLOD||r.envMap||r.transmission)&&r.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(Zi).join(`
`)}function Kg(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(Zi).join(`
`)}function Zg(r){const e=[];for(const t in r){const n=r[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function $g(r,e){const t={},n=r.getProgramParameter(e,r.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const s=r.getActiveAttrib(e,i),a=s.name;let o=1;s.type===r.FLOAT_MAT2&&(o=2),s.type===r.FLOAT_MAT3&&(o=3),s.type===r.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:r.getAttribLocation(e,a),locationSize:o}}return t}function Zi(r){return r!==""}function dc(r,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function fc(r,e){return r.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Jg=/^[ \t]*#include +<([\w\d./]+)>/gm;function mo(r){return r.replace(Jg,e_)}const Qg=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function e_(r,e){let t=He[e];if(t===void 0){const n=Qg.get(e);if(n!==void 0)t=He[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return mo(t)}const t_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function pc(r){return r.replace(t_,n_)}function n_(r,e,t,n){let i="";for(let s=parseInt(e);s<parseInt(t);s++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return i}function mc(r){let e="precision "+r.precision+` float;
precision `+r.precision+" int;";return r.precision==="highp"?e+=`
#define HIGH_PRECISION`:r.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:r.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function i_(r){let e="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===lu?e="SHADOWMAP_TYPE_PCF":r.shadowMapType===cu?e="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===Cn&&(e="SHADOWMAP_TYPE_VSM"),e}function r_(r){let e="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case ir:case rr:e="ENVMAP_TYPE_CUBE";break;case js:e="ENVMAP_TYPE_CUBE_UV";break}return e}function s_(r){let e="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case rr:e="ENVMAP_MODE_REFRACTION";break}return e}function a_(r){let e="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case uu:e="ENVMAP_BLENDING_MULTIPLY";break;case zh:e="ENVMAP_BLENDING_MIX";break;case Gh:e="ENVMAP_BLENDING_ADD";break}return e}function o_(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function l_(r,e,t,n){const i=r.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=i_(t),c=r_(t),u=s_(t),h=a_(t),d=o_(t),m=t.isWebGL2?"":jg(t),g=Kg(t),_=Zg(s),p=i.createProgram();let f,E,M=t.glslVersion?"#version "+t.glslVersion+`
...
`;function w0(){const r=new Vu,e=new $s(-1,1,1,-1,0,1),t=new Nn({vertexShader:b0,fragmentShader:A0,uniforms:{uTime:{value:0},uDarkness:{value:.8},uOffset:{value:.25}},transparent:!0,depthWrite:!1,depthTest:!1}),n=new fr(2,2),i=new Ft(n,t);return r.add(i),{overlayScene:r,overlayCamera:e,update:o=>{t.uniforms.uTime.value=o},destroy:()=>{n.dispose(),t.dispose()}}}function R0(r){const e=new c0(16777215,.008);r.add(e);const t=new Gs(Yi.spotlightColor,15,30,Math.PI/4.8,.6,1.2);t.position.set(0,8,0),t.castShadow=!0,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,t.shadow.camera.near=.5,t.shadow.camera.far=15,t.shadow.bias=-1e-4,r.add(t);const n=new nt;return n.position.set(0,0,0),r.add(n),t.target=n,{ambientLight:e,spotlight:t,spotTarget:n,update:s=>{const a=Math.sin(s*.85)*.75,o=Math.cos(s*.85)*.75;t.position.x=a,t.position.z=12+o,n.position.x=a*4.2,n.position.z=12+o*4.2}}}const Xa=(r,e=64)=>{const t=document.createElement("canvas");t.width=e,t.height=e;const n=t.getContext("2d"),i=n.createRadialGradient(e/2,e/2,0,e/2,e/2,e/2);return i.addColorStop(0,r),i.addColorStop(1,"rgba(0,0,0,0)"),n.fillStyle=i,n.fillRect(0,0,e,e),new qr(t)};function C0(r){const t=new Vt,n=new Float32Array(150*3),i=[];for(let C=0;C<150;C++){const R=Math.random()*Math.PI*2,A=Math.random()*3.8,z=Math.cos(R)*A,x=Math.sin(R)*A,T=Math.random()*8;n[C*3]=z,n[C*3+1]=T,n[C*3+2]=x,i.push({baseX:z,baseY:T,baseZ:x,speedX:(Math.random()-.5)*.002,speedY:Math.random()*.012+.004,speedZ:(Math.random()-.5)*.002,swaySpeed:Math.random()*1.5+.4,swayAmp:Math.random()*.12+.03})}t.setAttribute("position",new At(n,3));const s=new Or({size:.065,map:Xa("rgba(195, 235, 255, 0.75)"),transparent:!0,blending:Us,depthWrite:!1,depthTest:!0}),a=new Ps(t,s);r.add(a);const o=110,l=new Vt,c=new Float32Array(o*3),u=[];for(let C=0;C<o;C++){const R=Math.random()*Math.PI*2,A=Math.random()*3.8,z=Math.cos(R)*A,x=Math.sin(R)*A,T=Math.random()*8;c[C*3]=z,c[C*3+1]=T,c[C*3+2]=x,u.push({baseX:z,baseY:T,baseZ:x,speedX:(Math.random()-.5)*.002,speedY:Math.random()*.01+.004,speedZ:(Math.random()-.5)*.002,swaySpeed:Math.random()*1.4+.5,swayAmp:Math.random()*.1+.02})}l.setAttribute("position",new At(c,3));const h=new Or({size:.055,map:Xa("rgba(255, 222, 175, 0.75)"),transparent:!0,blending:Us,depthWrite:!1,depthTest:!0}),d=new Ps(l,h);r.add(d);const m=140,g=new Vt,_=new Float32Array(m*3),p=[];for(let C=0;C<m;C++){const R=Math.random()*Math.PI*2,A=Math.random()*10+1.5,z=Math.cos(R)*A,x=Math.sin(R)*A,T=Math.random()*9;_[C*3]=z,_[C*3+1]=T,_[C*3+2]=x,p.push({baseX:z,baseY:T,baseZ:x,speedX:(Math.random()-.5)*.003,speedY:-(Math.random()*.008+.004),speedZ:(Math.random()-.5)*.003,swaySpeed:Math.random()*.8+.2,swayAmp:Math.random()*.2+.05})}g.setAttribute("position",new At(_,3));const f=new Or({size:.18,map:Xa("rgba(28, 28, 28, 0.72)"),transparent:!0,blending:vi,depthWrite:!1,depthTest:!0}),E=new Ps(g,f);return r.add(E),{coldParticles:a,warmParticles:d,sootParticles:E,update:C=>{const R=t.attributes.position.array;for(let x=0;x<150;x++){const T=x*3,D=i[x];if(D.baseY+=D.speedY,D.baseX+=D.speedX,D.baseZ+=D.speedZ,D.baseY>8){D.baseY=0;const W=Math.random()*Math.PI*2,$=Math.random()*3.8;D.baseX=Math.cos(W)*$,D.baseZ=Math.sin(W)*$}R[T]=D.baseX+Math.sin(C*D.swaySpeed)*D.swayAmp,R[T+1]=D.baseY,R[T+2]=D.baseZ+Math.cos(C*D.swaySpeed)*D.swayAmp}t.attributes.position.needsUpdate=!0;const A=l.attributes.position.array;for(let x=0;x<o;x++){const T=x*3,D=u[x];if(D.baseY+=D.speedY,D.baseX+=D.speedX,D.baseZ+=D.speedZ,D.baseY>8){D.baseY=0;const W=Math.random()*Math.PI*2,$=Math.random()*3.8;D.baseX=Math.cos(W)*$,D.baseZ=Math.sin(W)*$}A[T]=D.baseX+Math.sin(C*D.swaySpeed)*D.swayAmp,A[T+1]=D.baseY,A[T+2]=D.baseZ+Math.cos(C*D.swaySpeed)*D.swayAmp}l.attributes.position.needsUpdate=!0;const z=g.attributes.position.array;for(let x=0;x<m;x++){const T=x*3,D=p[x];if(D.baseY+=D.speedY,D.baseX+=D.speedX,D.baseZ+=D.speedZ,D.baseY<0){D.baseY=9;const W=Math.random()*Math.PI*2,$=Math.random()*10+1.5;D.baseX=Math.cos(W)*$,D.baseZ=Math.sin(W)*$}z[T]=D.baseX+Math.sin(C*D.swaySpeed)*D.swayAmp,z[T+1]=D.baseY,z[T+2]=D.baseZ+Math.cos(C*D.swaySpeed)*D.swayAmp}g.attributes.position.needsUpdate=!0},destroy:()=>{t.dispose(),s.dispose(),l.dispose(),h.dispose(),g.dispose(),f.dispose()}}}function Wc(r,e){if(e===rd)return console.warn("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles."),r;if(e===uo||e===yu){let t=r.getIndex();if(t===null){const a=[],o=r.getAttribute("position");if(o!==void 0){for(let l=0;l<o.count;l++)a.push(l);r.setIndex(a),t=r.getIndex()}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible."),r}const n=t.count-2,i=[];if(e===uo)for(let a=1;a<=n;a++)i.push(t.getX(0)),i.push(t.getX(a)),i.push(t.getX(a+1));else for(let a=0;a<n;a++)a%2===0?(i.push(t.getX(a)),i.push(t.getX(a+1)),i.push(t.getX(a+2))):(i.push(t.getX(a+2)),i.push(t.getX(a+1)),i.push(t.getX(a)));i.length/3!==n&&console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.");const s=r.clone();return s.setIndex(i),s.clearGroups(),s}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:",e),r}class L0 extends _r{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(t){return new N0(t)}),this.register(function(t){return new W0(t)}),this.register(function(t){return new X0(t)}),this.register(function(t){return new Y0(t)}),this.register(function(t){return new F0(t)}),this.register(function(t){return new B0(t)}),this.register(function(t){return new H0(t)}),this.register(function(t){return new k0(t)}),this.register(function(t){return new U0(t)}),this.register(function(t){return new z0(t)}),this.register(function(t){return new O0(t)}),this.register(function(t){return new V0(t)}),this.register(function(t){return new G0(t)}),this.register(function(t){return new I0(t)}),this.register(function(t){return new q0(t)}),this.register(function(t){return new j0(t)})}load(e,t,n,i){const s=this;let a;if(this.resourcePath!=="")a=this.resourcePath;else if(this.path!==""){const c=Fr.extractUrlBase(e);a=Fr.resolveURL(c,this.path)}else a=Fr.extractUrlBase(e);this.manager.itemStart(e);const o=function(c){i?i(c):console.error(c),s.manager.itemError(e),s.manager.itemEnd(e)},l=new Ku(this.manager);l.setPath(this.path),l.setResponseType("arraybuffer"),l.setRequestHeader(this.requestHeader),l.setWithCredentials(this.withCredentials),l.load(e,function(c){try{s.parse(c,a,function(u){t(u),s.manager.itemEnd(e)},o)}catch(u){o(u)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setDDSLoader(){throw new Error('THREE.GLTFLoader: "MSFT_texture_dds" no longer supported. Please update to "KHR_texture_basisu".')}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,i){let s;const a={},o={},l=new TextDecoder;if(typeof e=="string")s=JSON.parse(e);else if(e instanceof ArrayBuffer)if(l.decode(new Uint8Array(e,0,4))===$u){try{a[je.KHR_BINARY_GLTF]=new K0(e)}catch(h){i&&i(h);return}s=JSON.parse(a[je.KHR_BINARY_GLTF].content)}else s=JSON.parse(l.decode(e));else s=e;if(s.asset===void 0||s.asset.version[0]<2){i&&i(new Error("THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported."));return}const c=new lv(s,{path:t||this.resourcePath||"",crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let u=0;u<this.pluginCallbacks.length;u++){const h=this.pluginCallbacks[u](c);h.name||console.error("THREE.GLTFLoader: Invalid plugin found: missing name"),o[h.name]=h,a[h.name]=!0}if(s.extensionsUsed)for(let u=0;u<s.extensionsUsed.length;++u){const h=s.extensionsUsed[u],d=s.extensionsRequired||[];switch(h){case je.KHR_MATERIALS_UNLIT:a[h]=new D0;break;case je.KHR_DRACO_MESH_COMPRESSION:a[h]=new Z0(s,this.dracoLoader);break;case je.KHR_TEXTURE_TRANSFORM:a[h]=new $0;break;case je.KHR_MESH_QUANTIZATION:a[h]=new J0;break;default:d.indexOf(h)>=0&&o[h]===void 0&&console.warn('THREE.GLTFLoader: Unknown extension "'+h+'".')}}c.setExtensions(a),c.setPlugins(o),c.parse(n,i)}parseAsync(e,t){const n=this;return new Promise(function(i,s){n.parse(e,t,i,s)})}}function P0(){let r={};return{get:function(e){return r[e]},add:function(e,t){r[e]=t},remove:function(e){delete r[e]},removeAll:function(){r={}}}}const je={KHR_BINARY_GLTF:"KHR_binary_glTF",KHR_DRACO_MESH_COMPRESSION:"KHR_draco_mesh_compression",KHR_LIGHTS_PUNCTUAL:"KHR_lights_punctual",KHR_MATERIALS_CLEARCOAT:"KHR_materials_clearcoat",KHR_MATERIALS_IOR:"KHR_materials_ior",KHR_MATERIALS_SHEEN:"KHR_materials_sheen",KHR_MATERIALS_SPECULAR:"KHR_materials_specular",KHR_MATERIALS_TRANSMISSION:"KHR_materials_transmission",KHR_MATERIALS_IRIDESCENCE:"KHR_materials_iridescence",KHR_MATERIALS_ANISOTROPY:"KHR_materials_anisotropy",KHR_MATERIALS_UNLIT:"KHR_materials_unlit",KHR_MATERIALS_VOLUME:"KHR_materials_volume",KHR_TEXTURE_BASISU:"KHR_texture_basisu",KHR_TEXTURE_TRANSFORM:"KHR_texture_transform",KHR_MESH_QUANTIZATION:"KHR_mesh_quantization",KHR_MATERIALS_EMISSIVE_STRENGTH:"KHR_materials_emissive_strength",EXT_MATERIALS_BUMP:"EXT_materials_bump",EXT_TEXTURE_WEBP:"EXT_texture_webp",EXT_TEXTURE_AVIF:"EXT_texture_avif",EXT_MESHOPT_COMPRESSION:"EXT_meshopt_compression",EXT_MESH_GPU_INSTANCING:"EXT_mesh_gpu_instancing"};class I0{constructor(e){this.parser=e,this.name=je.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){const e=this.parser,t=this.parser.json.nodes||[];for(let n=0,i=t.length;n<i;n++){const s=t[n];s.extensions&&s.extensions[this.name]&&s.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,s.extensions[this.name].light)}}_loadLight(e){const t=this.parser,n="light:"+e;let i=t.cache.get(n);if(i)return i;const s=t.json,l=((s.extensions&&s.extensions[this.name]||{}).lights||[])[e];let c;const u=new Ce(16777215);l.color!==void 0&&u.setRGB(l.color[0],l.color[1],l.color[2],wt);const h=l.range!==void 0?l.range:0;switch(l.type){case"directional":c=new l0(u),c.target.position.set(0,0,-1),c.add(c.target);break;case"point":c=new a0(u),c.distance=h;break;case"spot":c=new Gs(u),c.distance=h,l.spot=l.spot||{},l.spot.innerConeAngle=l.spot.innerConeAngle!==void 0?l.spot.innerConeAngle:0,l.spot.outerConeAngle=l.spot.outerConeAngle!==void 0?l.spot.outerConeAngle:Math.PI/4,c.angle=l.spot.outerConeAngle,c.penumbra=1-l.spot.innerConeAngle/l.spot.outerConeAngle,c.target.position.set(0,0,-1),c.add(c.target);break;default:throw new Error("THREE.GLTFLoader: Unexpected light type: "+l.type)}return c.position.set(0,0,0),c.decay=2,Vn(c,l),l.intensity!==void 0&&(c.intensity=l.intensity),c.name=t.createUniqueName(l.name||"light_"+e),i=Promise.resolve(c),t.cache.add(n,i),i}getDependency(e,t){if(e==="light")return this._loadLight(t)}createNodeAttachment(e){const t=this,n=this.parser,s=n.json.nodes[e],o=(s.extensions&&s.extensions[this.name]||{}).light;return o===void 0?null:this._loadLight(o).then(function(l){return n._getNodeRef(t.cache,o,l)})}}class D0{constructor(){this.name=je.KHR_MATERIALS_UNLIT}getMaterialType(){return _i}extendParams(e,t,n){const i=[];e.color=new Ce(1,1,1),e.opacity=1;const s=t.pbrMetallicRoughness;if(s){if(Array.isArray(s.baseColorFactor)){const a=s.baseColorFactor;e.color.setRGB(a[0],a[1],a[2],wt),e.opacity=a[3]}s.baseColorTexture!==void 0&&i.push(n.assignTexture(e,"map",s.baseColorTexture,Qe))}return Promise.all(i)}}class U0{constructor(e){this.parser=e,this.name=je.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){const i=this.parser.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=i.extensions[this.name].emissiveStrength;return s!==void 0&&(t.emissiveIntensity=s),Promise.resolve()}}class N0{constructor(e){this.parser=e,this.name=je.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:On}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],a=i.extensions[this.name];if(a.clearcoatFactor!==void 0&&(t.clearcoat=a.clearcoatFactor),a.clearcoatTexture!==void 0&&s.push(n.assignTexture(t,"clearcoatMap",a.clearcoatTexture)),a.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=a.clearcoatRoughnessFactor),a.clearcoatRoughnessTexture!==void 0&&s.push(n.assignTexture(t,"clearcoatRoughnessMap",a.clearcoatRoughnessTexture)),a.clearcoatNormalTexture!==void 0&&(s.push(n.assignTexture(t,"clearcoatNormalMap",a.clearcoatNormalTexture)),a.clearcoatNormalTexture.scale!==void 0)){const o=a.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new be(o,o)}return Promise.all(s)}}class O0{constructor(e){this.parser=e,this.name=je.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:On}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],a=i.extensions[this.name];return a.iridescenceFactor!==void 0&&(t.iridescence=a.iridescenceFactor),a.iridescenceTexture!==void 0&&s.push(n.assignTexture(t,"iridescenceMap",a.iridescenceTexture)),a.iridescenceIor!==void 0&&(t.iridescenceIOR=a.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),a.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=a.iridescenceThicknessMinimum),a.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=a.iridescenceThicknessMaximum),a.iridescenceThicknessTexture!==void 0&&s.push(n.assignTexture(t,"iridescenceThicknessMap",a.iridescenceThicknessTexture)),Promise.all(s)}}class F0{constructor(e){this.parser=e,this.name=je.KHR_MATERIALS_SHEEN}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:On}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[];t.sheenColor=new Ce(0,0,0),t.sheenRoughness=0,t.sheen=1;const a=i.extensions[this.name];if(a.sheenColorFactor!==void 0){const o=a.sheenColorFactor;t.sheenColor.setRGB(o[0],o[1],o[2],wt)}return a.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=a.sheenRoughnessFactor),a.sheenColorTexture!==void 0&&s.push(n.assignTexture(t,"sheenColorMap",a.sheenColorTexture,Qe)),a.sheenRoughnessTexture!==void 0&&s.push(n.assignTexture(t,"sheenRoughnessMap",a.sheenRoughnessTexture)),Promise.all(s)}}class B0{constructor(e){this.parser=e,this.name=je.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:On}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],a=i.extensions[this.name];return a.transmissionFactor!==void 0&&(t.transmission=a.transmissionFactor),a.transmissionTexture!==void 0&&s.push(n.assignTexture(t,"transmissionMap",a.transmissionTexture)),Promise.all(s)}}class H0{constructor(e){this.parser=e,this.name=je.KHR_MATERIALS_VOLUME}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:On}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],a=i.extensions[this.name];t.thickness=a.thicknessFactor!==void 0?a.thicknessFactor:0,a.thicknessTexture!==void 0&&s.push(n.assignTexture(t,"thicknessMap",a.thicknessTexture)),t.attenuationDistance=a.attenuationDistance||1/0;const o=a.attenuationColor||[1,1,1];return t.attenuationColor=new Ce().setRGB(o[0],o[1],o[2],wt),Promise.all(s)}}class k0{constructor(e){this.parser=e,this.name=je.KHR_MATERIALS_IOR}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:On}extendMaterialParams(e,t){const i=this.parser.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=i.extensions[this.name];return t.ior=s.ior!==void 0?s.ior:1.5,Promise.resolve()}}class z0{constructor(e){this.parser=e,this.name=je.KHR_MATERIALS_SPECULAR}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:On}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],a=i.extensions[this.name];t.specularIntensity=a.specularFactor!==void 0?a.specularFactor:1,a.specularTexture!==void 0&&s.push(n.assignTexture(t,"specularIntensityMap",a.specularTexture));const o=a.specularColorFactor||[1,1,1];return t.specularColor=new Ce().setRGB(o[0],o[1],o[2],wt),a.specularColorTexture!==void 0&&s.push(n.assignTexture(t,"specularColorMap",a.specularColorTexture,Qe)),Promise.all(s)}}class G0{constructor(e){this.parser=e,this.name=je.EXT_MATERIALS_BUMP}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:On}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],a=i.extensions[this.name];return t.bumpScale=a.bumpFactor!==void 0?a.bumpFactor:1,a.bumpTexture!==void 0&&s.push(n.assignTexture(t,"bumpMap",a.bumpTexture)),Promise.all(s)}}class V0{constructor(e){this.parser=e,this.name=je.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:On}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],a=i.extensions[this.name];return a.anisotropyStrength!==void 0&&(t.anisotropy=a.anisotropyStrength),a.anisotropyRotation!==void 0&&(t.anisotropyRotation=a.anisotropyRotation),a.anisotropyTexture!==void 0&&s.push(n.assignTexture(t,"anisotropyMap",a.anisotropyTexture)),Promise.all(s)}}class W0{constructor(e){this.parser=e,this.name=je.KHR_TEXTURE_BASISU}loadTexture(e){const t=this.parser,n=t.json,i=n.textures[e];if(!i.extensions||!i.extensions[this.name])return null;const s=i.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures");return null}return t.loadTextureImage(e,s.source,a)}}class X0{constructor(e){this.parser=e,this.name=je.EXT_TEXTURE_WEBP,this.isSupported=null}loadTexture(e){const t=this.name,n=this.parser,i=n.json,s=i.textures[e];if(!s.extensions||!s.extensions[t])return null;const a=s.extensions[t],o=i.images[a.source];let l=n.textureLoader;if(o.uri){const c=n.options.manager.getHandler(o.uri);c!==null&&(l=c)}return this.detectSupport().then(function(c){if(c)return n.loadTextureImage(e,a.source,l);if(i.extensionsRequired&&i.extensionsRequired.indexOf(t)>=0)throw new Error("THREE.GLTFLoader: WebP required by asset but unsupported.");return n.loadTexture(e)})}detectSupport(){return this.isSupported||(this.isSupported=new Promise(function(e){const t=new Image;t.src="data:image/webp;base64,UklGRiIAAABXRUJQVlA4IBYAAAAwAQCdASoBAAEADsD+JaQAA3AAAAAA",t.onload=t.onerror=function(){e(t.height===1)}})),this.isSupported}}class Y0{constructor(e){this.parser=e,this.name=je.EXT_TEXTURE_AVIF,this.isSupported=null}loadTexture(e){const t=this.name,n=this.parser,i=n.json,s=i.textures[e];if(!s.extensions||!s.extensions[t])return null;const a=s.extensions[t],o=i.images[a.source];let l=n.textureLoader;if(o.uri){const c=n.options.manager.getHandler(o.uri);c!==null&&(l=c)}return this.detectSupport().then(function(c){if(c)return n.loadTextureImage(e,a.source,l);if(i.extensionsRequired&&i.extensionsRequired.indexOf(t)>=0)throw new Error("THREE.GLTFLoader: AVIF required by asset but unsupported.");return n.loadTexture(e)})}detectSupport(){return this.isSupported||(this.isSupported=new Promise(function(e){const t=new Image;t.src="data:image/avif;base64,",t.onload=t.onerror=function(){e(t.height===1)}})),this.isSupported}}class q0{constructor(e){this.name=je.EXT_MESHOPT_COMPRESSION,this.parser=e}loadBufferView(e){const t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){const i=n.extensions[this.name],s=this.parser.getDependency("buffer",i.buffer),a=this.parser.options.meshoptDecoder;if(!a||!a.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files");return null}return s.then(function(o){const l=i.byteOffset||0,c=i.byteLength||0,u=i.count,h=i.byteStride,d=new Uint8Array(o,l,c);return a.decodeGltfBufferAsync?a.decodeGltfBufferAsync(u,h,d,i.mode,i.filter).then(function(m){return m.buffer}):a.ready.then(function(){const m=new ArrayBuffer(u*h);return a.decodeGltfBuffer(new Uint8Array(m),u,h,d,i.mode,i.filter),m})})}else return null}}class j0{constructor(e){this.name=je.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){const t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;const i=t.meshes[n.mesh];for(const c of i.primitives)if(c.mode!==jt.TRIANGLES&&c.mode!==jt.TRIANGLE_STRIP&&c.mode!==jt.TRIANGLE_FAN&&c.mode!==void 0)return null;const a=n.extensions[this.name].attributes,o=[],l={};for(const c in a)o.push(this.parser.getDependency("accessor",a[c]).then(u=>(l[c]=u,l[c])));return o.length<1?null:(o.push(this.parser.createNodeMesh(e)),Promise.all(o).then(c=>{const u=c.pop(),h=u.isGroup?u.children:[u],d=c[0].count,m=[];for(const g of h){const _=new We,p=new P,f=new un,E=new P(1,1,1),M=new G_(g.geometry,g.material,d);for(let b=0;b<d;b++)l.TRANSLATION&&p.fromBufferAttribute(l.TRANSLATION,b),l.ROTATION&&f.fromBufferAttribute(l.ROTATION,b),l.SCALE&&E.fromBufferAttribute(l.SCALE,b),M.setMatrixAt(b,_.compose(p,f,E));for(const b in l)if(b==="_COLOR_0"){const C=l[b];M.instanceColor=new go(C.array,C.itemSize,C.normalized)}else b!=="TRANSLATION"&&b!=="ROTATION"&&b!=="SCALE"&&g.geometry.setAttribute(b,l[b]);nt.prototype.copy.call(M,g),this.parser.assignFinalMaterial(M),m.push(M)}return u.isGroup?(u.clear(),u.add(...m),u):m[0]}))}}const $u="glTF",wr=12,Xc={JSON:1313821514,BIN:5130562};class K0{constructor(e){this.name=je.KHR_BINARY_GLTF,this.content=null,this.body=null;const t=new DataView(e,0,wr),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==$u)throw new Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");if(this.header.version<2)throw new Error("THREE.GLTFLoader: Legacy binary file detected.");const i=this.header.length-wr,s=new DataView(e,wr);let a=0;for(;a<i;){const o=s.getUint32(a,!0);a+=4;const l=s.getUint32(a,!0);if(a+=4,l===Xc.JSON){const c=new Uint8Array(e,wr+a,o);this.content=n.decode(c)}else if(l===Xc.BIN){const c=wr+a;this.body=e.slice(c,c+o)}a+=o}if(this.content===null)throw new Error("THREE.GLTFLoader: JSON content not found.")}}class Z0{constructor(e,t){if(!t)throw new Error("THREE.GLTFLoader: No DRACOLoader instance provided.");this.name=je.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){const n=this.json,i=this.dracoLoader,s=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,o={},l={},c={};for(const u in a){const h=xo[u]||u.toLowerCase();o[h]=a[u]}for(const u in e.attributes){const h=xo[u]||u.toLowerCase();if(a[u]!==void 0){const d=n.accessors[e.attributes[u]],m=Qi[d.componentType];c[h]=m.name,l[h]=d.normalized===!0}}return t.getDependency("bufferView",s).then(function(u){return new Promise(function(h,d){i.decodeDracoFile(u,function(m){for(const g in m.attributes){const _=m.attributes[g],p=l[g];p!==void 0&&(_.normalized=p)}h(m)},o,c,wt,d)})})}}class $0{constructor(){this.name=je.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0||(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0),e}}class J0{constructor(){this.name=je.KHR_MESH_QUANTIZATION}}class Ju extends jr{constructor(e,t,n,i){super(e,t,n,i)}copySampleValue_(e){const t=this.resultBuffer,n=this.sampleValues,i=this.valueSize,s=e*i*3+i;for(let a=0;a!==i;a++)t[a]=n[s+a];return t}interpolate_(e,t,n,i){const s=this.resultBuffer,a=this.sampleValues,o=this.valueSize,l=o*2,c=o*3,u=i-t,h=(n-t)/u,d=h*h,m=d*h,g=e*c,_=g-c,p=-2*m+3*d,f=m-d,E=1-p,M=f-d+h;for(let b=0;b!==o;b++){const C=a[_+b+o],R=a[_+b+l]*u,A=a[g+b+o],z=a[g+b]*u;s[b]=E*C+M*R+p*A+f*z}return s}}const Q0=new un;class ev extends Ju{interpolate_(e,t,n,i){const s=super.interpolate_(e,t,n,i);return Q0.fromArray(s).normalize().toArray(s),s}}const jt={POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6},Qi={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},Yc={9728:gt,9729:ft,9984:co,9985:fu,9986:Cs,9987:Ei},qc={33071:$t,33648:Os,10497:ii},Ya={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},xo={POSITION:"position",NORMAL:"normal",TANGENT:"tangent",TEXCOORD_0:"uv",TEXCOORD_1:"uv1",TEXCOORD_2:"uv2",TEXCOORD_3:"uv3",COLOR_0:"color",WEIGHTS_0:"skinWeight",JOINTS_0:"skinIndex"},Gn={scale:"scale",translation:"position",rotation:"quaternion",weights:"morphTargetInfluences"},tv={CUBICSPLINE:void 0,LINEAR:ar,STEP:Vr},qa={OPAQUE:"OPAQUE",MASK:"MASK",BLEND:"BLEND"};function nv(r){return r.DefaultMaterial===void 0&&(r.DefaultMaterial=new Qs({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:Un})),r.DefaultMaterial}function hi(r,e,t){for(const n in t.extensions)r[n]===void 0&&(e.userData.gltfExtensions=e.userData.gltfExtensions||{},e.userData.gltfExtensions[n]=t.extensions[n])}function Vn(r,e){e.extras!==void 0&&(typeof e.extras=="object"?Object.assign(r.userData,e.extras):console.warn("THREE.GLTFLoader: Ignoring primitive type .extras, "+e.extras))}function iv(r,e,t){let n=!1,i=!1,s=!1;for(let c=0,u=e.length;c<u;c++){const h=e[c];if(h.POSITION!==void 0&&(n=!0),h.NORMAL!==void 0&&(i=!0),h.COLOR_0!==void 0&&(s=!0),n&&i&&s)break}if(!n&&!i&&!s)return Promise.resolve(r);const a=[],o=[],l=[];for(let c=0,u=e.length;c<u;c++){const h=e[c];if(n){const d=h.POSITION!==void 0?t.getDependency("accessor",h.POSITION):r.attributes.position;a.push(d)}if(i){const d=h.NORMAL!==void 0?t.getDependency("accessor",h.NORMAL):r.attributes.normal;o.push(d)}if(s){const d=h.COLOR_0!==void 0?t.getDependency("accessor",h.COLOR_0):r.attributes.color;l.push(d)}}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(l)]).then(function(c){const u=c[0],h=c[1],d=c[2];return n&&(r.morphAttributes.position=u),i&&(r.morphAttributes.normal=h),s&&(r.morphAttributes.color=d),r.morphTargetsRelative=!0,r})}function rv(r,e){if(r.updateMorphTargets(),e.weights!==void 0)for(let t=0,n=e.weights.length;t<n;t++)r.morphTargetInfluences[t]=e.weights[t];if(e.extras&&Array.isArray(e.extras.targetNames)){const t=e.extras.targetNames;if(r.morphTargetInfluences.length===t.length){r.morphTargetDictionary={};for(let n=0,i=t.length;n<i;n++)r.morphTargetDictionary[t[n]]=n}else console.warn("THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.")}}function sv(r){let e;const t=r.extensions&&r.extensions[je.KHR_DRACO_MESH_COMPRESSION];if(t?e="draco:"+t.bufferView+":"+t.indices+":"+ja(t.attributes):e=r.indices+":"+ja(r.attributes)+":"+r.mode,r.targets!==void 0)for(let n=0,i=r.targets.length;n<i;n++)e+=":"+ja(r.targets[n]);return e}function ja(r){let e="";const t=Object.keys(r).sort();for(let n=0,i=t.length;n<i;n++)e+=t[n]+":"+r[t[n]]+";";return e}function Mo(r){switch(r){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw new Error("THREE.GLTFLoader: Unsupported normalized accessor component type.")}}function av(r){return r.search(/\.jpe?g($|\?)/i)>0||r.search(/^data\:image\/jpeg/)===0?"image/jpeg":r.search(/\.webp($|\?)/i)>0||r.search(/^data\:image\/webp/)===0?"image/webp":"image/png"}const ov=new We;class lv{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new P0,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,i=!1,s=-1;typeof navigator<"u"&&(n=/^((?!chrome|android).)*safari/i.test(navigator.userAgent)===!0,i=navigator.userAgent.indexOf("Firefox")>-1,s=i?navigator.userAgent.match(/Firefox\/([0-9]+)\./)[1]:-1),typeof createImageBitmap>"u"||n||i&&s<98?this.textureLoader=new Zu(this.options.manager):this.textureLoader=new u0(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new Ku(this.options.manager),this.fileLoader.setResponseType("arraybuffer"),this.options.crossOrigin==="use-credentials"&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){const n=this,i=this.json,s=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(a){return a._markDefs&&a._markDefs()}),Promise.all(this._invokeAll(function(a){return a.beforeRoot&&a.beforeRoot()})).then(function(){return Promise.all([n.getDependencies("scene"),n.getDependencies("animation"),n.getDependencies("camera")])}).then(function(a){const o={scene:a[0][i.scene||0],scenes:a[0],animations:a[1],cameras:a[2],asset:i.asset,parser:n,userData:{}};return hi(s,o,i),Vn(o,i),Promise.all(n._invokeAll(function(l){return l.afterRoot&&l.afterRoot(o)})).then(function(){e(o)})}).catch(t)}_markDefs(){const e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let i=0,s=t.length;i<s;i++){const a=t[i].joints;for(let o=0,l=a.length;o<l;o++)e[a[o]].isBone=!0}for(let i=0,s=e.length;i<s;i++){const a=e[i];a.mesh!==void 0&&(this._addNodeRef(this.meshCache,a.mesh),a.skin!==void 0&&(n[a.mesh].isSkinnedMesh=!0)),a.camera!==void 0&&this._addNodeRef(this.cameraCache,a.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;const i=n.clone(),s=(a,o)=>{const l=this.associations.get(a);l!=null&&this.associations.set(o,l);for(const[c,u]of a.children.entries())s(u,o.children[c])};return s(n,i),i.name+="_instance_"+e.uses[t]++,i}_invokeOne(e){const t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){const i=e(t[n]);if(i)return i}return null}_invokeAll(e){const t=Object.values(this.plugins);t.unshift(this);const n=[];for(let i=0;i<t.length;i++){const s=e(t[i]);s&&n.push(s)}return n}getDependency(e,t){const n=e+":"+t;let i=this.cache.get(n);if(!i){switch(e){case"scene":i=this.loadScene(t);break;case"node":i=this._invokeOne(function(s){return s.loadNode&&s.loadNode(t)});break;case"mesh":i=this._invokeOne(function(s){return s.loadMesh&&s.loadMesh(t)});break;case"accessor":i=this.loadAccessor(t);break;case"bufferView":i=this._invokeOne(function(s){return s.loadBufferView&&s.loadBufferView(t)});break;case"buffer":i=this.loadBuffer(t);break;case"material":i=this._invokeOne(function(s){return s.loadMaterial&&s.loadMaterial(t)});break;case"texture":i=this._invokeOne(function(s){return s.loadTexture&&s.loadTexture(t)});break;case"skin":i=this.loadSkin(t);break;case"animation":i=this._invokeOne(function(s){return s.loadAnimation&&s.loadAnimation(t)});break;case"camera":i=this.loadCamera(t);break;default:if(i=this._invokeOne(function(s){return s!=this&&s.getDependency&&s.getDependency(e,t)}),!i)throw new Error("Unknown type: "+e);break}this.cache.add(n,i)}return i}getDependencies(e){let t=this.cache.get(e);if(!t){const n=this,i=this.json[e+(e==="mesh"?"es":"s")]||[];t=Promise.all(i.map(function(s,a){return n.getDependency(e,a)})),this.cache.add(e,t)}return t}loadBuffer(e){const t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!=="arraybuffer")throw new Error("THREE.GLTFLoader: "+t.type+" buffer type is not supported.");if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[je.KHR_BINARY_GLTF].body);const i=this.options;return new Promise(function(s,a){n.load(Fr.resolveURL(t.uri,i.path),s,void 0,function(){a(new Error('THREE.GLTFLoader: Failed to load buffer "'+t.uri+'".'))})})}loadBufferView(e){const t=this.json.bufferViews[e];return this.getDependency("buffer",t.buffer).then(function(n){const i=t.byteLength||0,s=t.byteOffset||0;return n.slice(s,s+i)})}loadAccessor(e){const t=this,n=this.json,i=this.json.accessors[e];if(i.bufferView===void 0&&i.sparse===void 0){const a=Ya[i.type],o=Qi[i.componentType],l=i.normalized===!0,c=new o(i.count*a);return Promise.resolve(new At(c,a,l))}const s=[];return i.bufferView!==void 0?s.push(this.getDependency("bufferView",i.bufferView)):s.push(null),i.sparse!==void 0&&(s.push(this.getDependency("bufferView",i.sparse.indices.bufferView)),s.push(this.getDependency("bufferView",i.sparse.values.bufferView))),Promise.all(s).then(function(a){const o=a[0],l=Ya[i.type],c=Qi[i.componentType],u=c.BYTES_PER_ELEMENT,h=u*l,d=i.byteOffset||0,m=i.bufferView!==void 0?n.bufferViews[i.bufferView].byteStride:void 0,g=i.normalized===!0;let _,p;if(m&&m!==h){const f=Math.floor(d/m),E="InterleavedBuffer:"+i.bufferView+":"+i.componentType+":"+f+":"+i.count;let M=t.cache.get(E);M||(_=new c(o,f*m,i.count*m/u),M=new O_(_,m/u),t.cache.add(E,M)),p=new Fo(M,l,d%m/u,g)}else o===null?_=new c(i.count*l):_=new c(o,d,i.count*l),p=new At(_,l,g);if(i.sparse!==void 0){const f=Ya.SCALAR,E=Qi[i.sparse.indices.componentType],M=i.sparse.indices.byteOffset||0,b=i.sparse.values.byteOffset||0,C=new E(a[1],M,i.sparse.count*f),R=new c(a[2],b,i.sparse.count*l);o!==null&&(p=new At(p.array.slice(),p.itemSize,p.normalized));for(let A=0,z=C.length;A<z;A++){const x=C[A];if(p.setX(x,R[A*l]),l>=2&&p.setY(x,R[A*l+1]),l>=3&&p.setZ(x,R[A*l+2]),l>=4&&p.setW(x,R[A*l+3]),l>=5)throw new Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.")}}return p})}loadTexture(e){const t=this.json,n=this.options,s=t.textures[e].source,a=t.images[s];let o=this.textureLoader;if(a.uri){const l=n.manager.getHandler(a.uri);l!==null&&(o=l)}return this.loadTextureImage(e,s,o)}loadTextureImage(e,t,n){const i=this,s=this.json,a=s.textures[e],o=s.images[t],l=(o.uri||o.bufferView)+":"+a.sampler;if(this.textureCache[l])return this.textureCache[l];const c=this.loadImageSource(t,n).then(function(u){u.flipY=!1,u.name=a.name||o.name||"",u.name===""&&typeof o.uri=="string"&&o.uri.startsWith("data:image/")===!1&&(u.name=o.uri);const d=(s.samplers||{})[a.sampler]||{};return u.magFilter=Yc[d.magFilter]||ft,u.minFilter=Yc[d.minFilter]||Ei,u.wrapS=qc[d.wrapS]||ii,u.wrapT=qc[d.wrapT]||ii,i.associations.set(u,{textures:e}),u}).catch(function(){return null});return this.textureCache[l]=c,c}loadImageSource(e,t){const n=this,i=this.json,s=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(h=>h.clone());const a=i.images[e],o=self.URL||self.webkitURL;let l=a.uri||"",c=!1;if(a.bufferView!==void 0)l=n.getDependency("bufferView",a.bufferView).then(function(h){c=!0;const d=new Blob([h],{type:a.mimeType});return l=o.createObjectURL(d),l});else if(a.uri===void 0)throw new Error("THREE.GLTFLoader: Image "+e+" is missing URI and bufferView");const u=Promise.resolve(l).then(function(h){return new Promise(function(d,m){let g=d;t.isImageBitmapLoader===!0&&(g=function(_){const p=new _t(_);p.needsUpdate=!0,d(p)}),t.load(Fr.resolveURL(h,s.path),g,void 0,m)})}).then(function(h){return c===!0&&o.revokeObjectURL(l),h.userData.mimeType=a.mimeType||av(a.uri),h}).catch(function(h){throw console.error("THREE.GLTFLoader: Couldn't load texture",l),h});return this.sourceCache[e]=u,u}assignTexture(e,t,n,i){const s=this;return this.getDependency("texture",n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),s.extensions[je.KHR_TEXTURE_TRANSFORM]){const o=n.extensions!==void 0?n.extensions[je.KHR_TEXTURE_TRANSFORM]:void 0;if(o){const l=s.associations.get(a);a=s.extensions[je.KHR_TEXTURE_TRANSFORM].extendTexture(a,o),s.associations.set(a,l)}}return i!==void 0&&(a.colorSpace=i),e[t]=a,a})}assignFinalMaterial(e){const t=e.geometry;let n=e.material;const i=t.attributes.tangent===void 0,s=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){const o="PointsMaterial:"+n.uuid;let l=this.cache.get(o);l||(l=new Or,vn.prototype.copy.call(l,n),l.color.copy(n.color),l.map=n.map,l.sizeAttenuation=!1,this.cache.add(o,l)),n=l}else if(e.isLine){const o="LineBasicMaterial:"+n.uuid;let l=this.cache.get(o);l||(l=new Xu,vn.prototype.copy.call(l,n),l.color.copy(n.color),l.map=n.map,this.cache.add(o,l)),n=l}if(i||s||a){let o="ClonedMaterial:"+n.uuid+":";i&&(o+="derivative-tangents:"),s&&(o+="vertex-colors:"),a&&(o+="flat-shading:");let l=this.cache.get(o);l||(l=n.clone(),s&&(l.vertexColors=!0),a&&(l.flatShading=!0),i&&(l.normalScale&&(l.normalScale.y*=-1),l.clearcoatNormalScale&&(l.clearcoatNormalScale.y*=-1)),this.cache.add(o,l),this.associations.set(l,this.associations.get(n))),n=l}e.material=n}getMaterialType(){return Qs}loadMaterial(e){const t=this,n=this.json,i=this.extensions,s=n.materials[e];let a;const o={},l=s.extensions||{},c=[];if(l[je.KHR_MATERIALS_UNLIT]){const h=i[je.KHR_MATERIALS_UNLIT];a=h.getMaterialType(),c.push(h.extendParams(o,s,t))}else{const h=s.pbrMetallicRoughness||{};if(o.color=new Ce(1,1,1),o.opacity=1,Array.isArray(h.baseColorFactor)){const d=h.baseColorFactor;o.color.setRGB(d[0],d[1],d[2],wt),o.opacity=d[3]}h.baseColorTexture!==void 0&&c.push(t.assignTexture(o,"map",h.baseColorTexture,Qe)),o.metalness=h.metallicFactor!==void 0?h.metallicFactor:1,o.roughness=h.roughnessFactor!==void 0?h.roughnessFactor:1,h.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(o,"metalnessMap",h.metallicRoughnessTexture)),c.push(t.assignTexture(o,"roughnessMap",h.metallicRoughnessTexture))),a=this._invokeOne(function(d){return d.getMaterialType&&d.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(d){return d.extendMaterialParams&&d.extendMaterialParams(e,o)})))}s.doubleSided===!0&&(o.side=mn);const u=s.alphaMode||qa.OPAQUE;if(u===qa.BLEND?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,u===qa.MASK&&(o.alphaTest=s.alphaCutoff!==void 0?s.alphaCutoff:.5)),s.normalTexture!==void 0&&a!==_i&&(c.push(t.assignTexture(o,"normalMap",s.normalTexture)),o.normalScale=new be(1,1),s.normalTexture.scale!==void 0)){const h=s.normalTexture.scale;o.normalScale.set(h,h)}if(s.occlusionTexture!==void 0&&a!==_i&&(c.push(t.assignTexture(o,"aoMap",s.occlusionTexture)),s.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=s.occlusionTexture.strength)),s.emissiveFactor!==void 0&&a!==_i){const h=s.emissiveFactor;o.emissive=new Ce().setRGB(h[0],h[1],h[2],wt)}return s.emissiveTexture!==void 0&&a!==_i&&c.push(t.assignTexture(o,"emissiveMap",s.emissiveTexture,Qe)),Promise.all(c).then(function(){const h=new a(o);return s.name&&(h.name=s.name),Vn(h,s),t.associations.set(h,{materials:e}),s.extensions&&hi(i,h,s),h})}createUniqueName(e){const t=Je.sanitizeNodeName(e||"");return t in this.nodeNamesUsed?t+"_"+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){const t=this,n=this.extensions,i=this.primitiveCache;function s(o){return n[je.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(o,t).then(function(l){return jc(l,o,t)})}const a=[];for(let o=0,l=e.length;o<l;o++){const c=e[o],u=sv(c),h=i[u];if(h)a.push(h.promise);else{let d;c.extensions&&c.extensions[je.KHR_DRACO_MESH_COMPRESSION]?d=s(c):d=jc(new Vt,c,t),i[u]={primitive:c,promise:d},a.push(d)}}return Promise.all(a)}loadMesh(e){const t=this,n=this.json,i=this.extensions,s=n.meshes[e],a=s.primitives,o=[];for(let l=0,c=a.length;l<c;l++){const u=a[l].material===void 0?nv(this.cache):this.getDependency("material",a[l].material);o.push(u)}return o.push(t.loadGeometries(a)),Promise.all(o).then(function(l){const c=l.slice(0,l.length-1),u=l[l.length-1],h=[];for(let m=0,g=u.length;m<g;m++){const _=u[m],p=a[m];let f;const E=c[m];if(p.mode===jt.TRIANGLES||p.mode===jt.TRIANGLE_STRIP||p.mode===jt.TRIANGLE_FAN||p.mode===void 0)f=s.isSkinnedMesh===!0?new B_(_,E):new Ft(_,E),f.isSkinnedMesh===!0&&f.normalizeSkinWeights(),p.mode===jt.TRIANGLE_STRIP?f.geometry=Wc(f.geometry,yu):p.mode===jt.TRIANGLE_FAN&&(f.geometry=Wc(f.geometry,uo));else if(p.mode===jt.LINES)f=new V_(_,E);else if(p.mode===jt.LINE_STRIP)f=new Ho(_,E);else if(p.mode===jt.LINE_LOOP)f=new W_(_,E);else if(p.mode===jt.POINTS)f=new Ps(_,E);else throw new Error("THREE.GLTFLoader: Primitive mode unsupported: "+p.mode);Object.keys(f.geometry.morphAttributes).length>0&&rv(f,s),f.name=t.createUniqueName(s.name||"mesh_"+e),Vn(f,s),p.extensions&&hi(i,f,p),t.assignFinalMaterial(f),h.push(f)}for(let m=0,g=h.length;m<g;m++)t.associations.set(h[m],{meshes:e,primitives:m});if(h.length===1)return s.extensions&&hi(i,h[0],s),h[0];const d=new jn;s.extensions&&hi(i,d,s),t.associations.set(d,{meshes:e});for(let m=0,g=h.length;m<g;m++)d.add(h[m]);return d})}loadCamera(e){let t;const n=this.json.cameras[e],i=n[n.type];if(!i){console.warn("THREE.GLTFLoader: Missing camera parameters.");return}return n.type==="perspective"?t=new Ot(qn.radToDeg(i.yfov),i.aspectRatio||1,i.znear||1,i.zfar||2e6):n.type==="orthographic"&&(t=new $s(-i.xmag,i.xmag,i.ymag,-i.ymag,i.znear,i.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),Vn(t,n),Promise.resolve(t)}loadSkin(e){const t=this.json.skins[e],n=[];for(let i=0,s=t.joints.length;i<s;i++)n.push(this._loadNodeShallow(t.joints[i]));return t.inverseBindMatrices!==void 0?n.push(this.getDependency("accessor",t.inverseBindMatrices)):n.push(null),Promise.all(n).then(function(i){const s=i.pop(),a=i,o=[],l=[];for(let c=0,u=a.length;c<u;c++){const h=a[c];if(h){o.push(h);const d=new We;s!==null&&d.fromArray(s.array,c*16),l.push(d)}else console.warn('THREE.GLTFLoader: Joint "%s" could not be found.',t.joints[c])}return new Bo(o,l)})}loadAnimation(e){const t=this.json,n=this,i=t.animations[e],s=i.name?i.name:"animation_"+e,a=[],o=[],l=[],c=[],u=[];for(let h=0,d=i.channels.length;h<d;h++){const m=i.channels[h],g=i.samplers[m.sampler],_=m.target,p=_.node,f=i.parameters!==void 0?i.parameters[g.input]:g.input,E=i.parameters!==void 0?i.parameters[g.output]:g.output;_.node!==void 0&&(a.push(this.getDependency("node",p)),o.push(this.getDependency("accessor",f)),l.push(this.getDependency("accessor",E)),c.push(g),u.push(_))}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(l),Promise.all(c),Promise.all(u)]).then(function(h){const d=h[0],m=h[1],g=h[2],_=h[3],p=h[4],f=[];for(let E=0,M=d.length;E<M;E++){const b=d[E],C=m[E],R=g[E],A=_[E],z=p[E];if(b===void 0)continue;b.updateMatrix&&b.updateMatrix();const x=n._createAnimationTracks(b,C,R,A,z);if(x)for(let T=0;T<x.length;T++)f.push(x[T])}return new $_(s,void 0,f)})}createNodeMesh(e){const t=this.json,n=this,i=t.nodes[e];return i.mesh===void 0?null:n.getDependency("mesh",i.mesh).then(function(s){const a=n._getNodeRef(n.meshCache,i.mesh,s);return i.weights!==void 0&&a.traverse(function(o){if(o.isMesh)for(let l=0,c=i.weights.length;l<c;l++)o.morphTargetInfluences[l]=i.weights[l]}),a})}loadNode(e){const t=this.json,n=this,i=t.nodes[e],s=n._loadNodeShallow(e),a=[],o=i.children||[];for(let c=0,u=o.length;c<u;c++)a.push(n.getDependency("node",o[c]));const l=i.skin===void 0?Promise.resolve(null):n.getDependency("skin",i.skin);return Promise.all([s,Promise.all(a),l]).then(function(c){const u=c[0],h=c[1],d=c[2];d!==null&&u.traverse(function(m){m.isSkinnedMesh&&m.bind(d,ov)});for(let m=0,g=h.length;m<g;m++)u.add(h[m]);return u})}_loadNodeShallow(e){const t=this.json,n=this.extensions,i=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];const s=t.nodes[e],a=s.name?i.createUniqueName(s.name):"",o=[],l=i._invokeOne(function(c){return c.createNodeMesh&&c.createNodeMesh(e)});return l&&o.push(l),s.camera!==void 0&&o.push(i.getDependency("camera",s.camera).then(function(c){return i._getNodeRef(i.cameraCache,s.camera,c)})),i._invokeAll(function(c){return c.createNodeAttachment&&c.createNodeAttachment(e)}).forEach(function(c){o.push(c)}),this.nodeCache[e]=Promise.all(o).then(function(c){let u;if(s.isBone===!0?u=new Wu:c.length>1?u=new jn:c.length===1?u=c[0]:u=new nt,u!==c[0])for(let h=0,d=c.length;h<d;h++)u.add(c[h]);if(s.name&&(u.userData.name=s.name,u.name=a),Vn(u,s),s.extensions&&hi(n,u,s),s.matrix!==void 0){const h=new We;h.fromArray(s.matrix),u.applyMatrix4(h)}else s.translation!==void 0&&u.position.fromArray(s.translation),s.rotation!==void 0&&u.quaternion.fromArray(s.rotation),s.scale!==void 0&&u.scale.fromArray(s.scale);return i.associations.has(u)||i.associations.set(u,{}),i.associations.get(u).nodes=e,u}),this.nodeCache[e]}loadScene(e){const t=this.extensions,n=this.json.scenes[e],i=this,s=new jn;n.name&&(s.name=i.createUniqueName(n.name)),Vn(s,n),n.extensions&&hi(t,s,n);const a=n.nodes||[],o=[];for(let l=0,c=a.length;l<c;l++)o.push(i.getDependency("node",a[l]));return Promise.all(o).then(function(l){for(let u=0,h=l.length;u<h;u++)s.add(l[u]);const c=u=>{const h=new Map;for(const[d,m]of i.associations)(d instanceof vn||d instanceof _t)&&h.set(d,m);return u.traverse(d=>{const m=i.associations.get(d);m!=null&&h.set(d,m)}),h};return i.associations=c(s),s})}_createAnimationTracks(e,t,n,i,s){const a=[],o=e.name?e.name:e.uuid,l=[];Gn[s.path]===Gn.weights?e.traverse(function(d){d.morphTargetInfluences&&l.push(d.name?d.name:d.uuid)}):l.push(o);let c;switch(Gn[s.path]){case Gn.weights:c=cr;break;case Gn.rotation:c=bi;break;case Gn.position:case Gn.scale:c=ur;break;default:switch(n.itemSize){case 1:c=cr;break;case 2:case 3:default:c=ur;break}break}const u=i.interpolation!==void 0?tv[i.interpolation]:ar,h=this._getArrayFromAccessor(n);for(let d=0,m=l.length;d<m;d++){const g=new c(l[d]+"."+Gn[s.path],t.array,h,u);i.interpolation==="CUBICSPLINE"&&this._createCubicSplineTrackInterpolant(g),a.push(g)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){const n=Mo(t.constructor),i=new Float32Array(t.length);for(let s=0,a=t.length;s<a;s++)i[s]=t[s]*n;t=i}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(n){const i=this instanceof bi?ev:Ju;return new i(this.times,this.values,this.getValueSize()/3,n)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}}function cv(r,e,t){const n=e.attributes,i=new hn;if(n.POSITION!==void 0){const o=t.json.accessors[n.POSITION],l=o.min,c=o.max;if(l!==void 0&&c!==void 0){if(i.set(new P(l[0],l[1],l[2]),new P(c[0],c[1],c[2])),o.normalized){const u=Mo(Qi[o.componentType]);i.min.multiplyScalar(u),i.max.multiplyScalar(u)}}else{console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.");return}}else return;const s=e.targets;if(s!==void 0){const o=new P,l=new P;for(let c=0,u=s.length;c<u;c++){const h=s[c];if(h.POSITION!==void 0){const d=t.json.accessors[h.POSITION],m=d.min,g=d.max;if(m!==void 0&&g!==void 0){if(l.setX(Math.max(Math.abs(m[0]),Math.abs(g[0]))),l.setY(Math.max(Math.abs(m[1]),Math.abs(g[1]))),l.setZ(Math.max(Math.abs(m[2]),Math.abs(g[2]))),d.normalized){const _=Mo(Qi[d.componentType]);l.multiplyScalar(_)}o.max(l)}else console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.")}}i.expandByVector(o)}r.boundingBox=i;const a=new Mn;i.getCenter(a.center),a.radius=i.min.distanceTo(i.max)/2,r.boundingSphere=a}function jc(r,e,t){const n=e.attributes,i=[];function s(a,o){return t.getDependency("accessor",a).then(function(l){r.setAttribute(o,l)})}for(const a in n){const o=xo[a]||a.toLowerCase();o in r.attributes||i.push(s(n[a],o))}if(e.indices!==void 0&&!r.index){const a=t.getDependency("accessor",e.indices).then(function(o){r.setIndex(o)});i.push(a)}return $e.workingColorSpace!==wt&&"COLOR_0"in n&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${$e.workingColorSpace}" not supported.`),Vn(r,e),cv(r,e,t),Promise.all(i).then(function(){return e.targets!==void 0?iv(r,e.targets,t):r})}const uv=`varying vec2 vUv;
void main() {
  vUv = uv;
  vec3 pos = position;
...
`,Ka=document.getElementById("loading-splash"),dv=document.getElementById("loading-bar-fill"),fv=document.getElementById("loading-text");let Yt={scene:10,overlay:5,lights:5,particles:10,texture1:0,texture2:0,model:0},Vs=!1;function Qu(r,e){if(Vs)return;const t=Math.min(Math.max(Math.round(r),0),100);dv.style.width=`${t}%`,e&&(fv.textContent=e)}function Pr(r,e){if(Vs)return;Yt[r]=e;const t=Math.min(Yt.scene+Yt.overlay+Yt.lights+Yt.particles+Yt.texture1+Yt.texture2+Yt.model,100);let n="Cargando...";t<30?n="Preparando escena...":Yt.model<50?n=`Cargando modelo 3D... ${Math.round(Yt.model/50*100)}%`:Yt.texture1<10||Yt.texture2<10?n="Cargando texturas...":n="Listo.",Qu(t,n)}function ta(r){const e={scene:10,overlay:5,lights:5,particles:10};e[r]!==void 0&&Pr(r,e[r])}function Kc(){Vs||(Vs=!0,Qu(100,"Listo."),setTimeout(()=>{Ka.classList.add("done"),Ka.addEventListener("animationend",()=>Ka.remove(),{once:!0})},350))}function Is(r){const e="kw";let t="";for(let n=0;n<r.length;n+=2){const i=parseInt(r.substring(n,n+2),16),s=e.charCodeAt(n/2%e.length);t+=String.fromCharCode(i^s)}return t}const Nt={mode:"default",slideshow:{images:[],slideDuration:12,transitionDuration:.45},video:{url:"",loop:!0,muted:!0,autoplay:!0}};let Zn=null,Si=null,xn=null;const Zc={};let ge=null,dt=null,_n=null,yt=null,ct="",Zt="idle",Br=0,Hr="#ffffff",er="center",Ds=!1,yo=!1,qi=8,ji=1e3,Kt=!1,xt=null,qt=null,$c=0,ln=null,tr=null,Ws=null,eh=3,th=5,nh=5;const pv=()=>window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?"ws://localhost:8088":"wss://kimeraware.macrostasis.dev/ws",ih=r=>window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?r:`https://kimeraware.macrostasis.dev${r}`;function Xr(r){return new Promise((e,t)=>{const n=new Image;n.onload=()=>{const i=new _t(n);i.colorSpace=Qe,i.minFilter=ft,i.generateMipmaps=!1,i.needsUpdate=!0,e(i)},n.onerror=i=>{t(i)},n.src=r})}async function Ir(r){Nt.mode=r.mode||"default",ct=r.text||"",er=r.textPosition||"center",Ys=null,qs=null,eh=r.minDuration||3,th=r.maxDuration||5,nh=r.frequencyPerMinute||5,So=-1;const e={default:0,green:1,red:2,yellow:3,rainbow:4,custom:5},t=r.filterMode||"default";Br=e[t]!==void 0?e[t]:0,Hr=r.filterColor||"#ffffff";const n=r.videoUrl||"",i=typeof r.videoLoop<"u"?r.videoLoop:!0,s=typeof r.videoAudio<"u"?r.videoAudio:!0;if(Nt.mode==="video"?bo(n,i,s):bo(null,!1,!1),r.mainImageData){const a=yt;yt=await Xr(r.mainImageData),Nt.mode==="custom_image"?Zt="custom_image":Zt="idle",a&&a.dispose()}else Zt="idle",yt&&yt.dispose(),yt=null;if(r.childImageData){const a=Si;Si=await Xr(r.childImageData),a&&a!==Zn&&a!==Ws&&a.dispose()}else Si=Ws||Zn}function rh(r,e){if(!ge||ge.paused||!r)return;const t=(Date.now()-r)/1e3,n=e||1/0;if(t<0||t>=n)return;const i=Math.abs(ge.currentTime-t);i>.3&&(console.log(`[Sync] Drift detected: ${i.toFixed(2)}s — correcting to ${t.toFixed(2)}s`),ge.currentTime=t)}function sh(){tr&&clearInterval(tr),tr=setInterval(()=>{if(!Kt||!ln){Xs();return}rh(ln.startTime,ln.originalDuration)},2e3)}function Xs(){tr&&(clearInterval(tr),tr=null)}let As=null;async function mv(){if(As)return As;const r="75,87,95,65,82,71",e=new Uint8Array(r.split(",").map(Number)),t=new TextEncoder().encode("kimeraware-ws-2025"),n=await crypto.subtle.importKey("raw",e,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),i=await crypto.subtle.sign("HMAC",n,t);return As=await crypto.subtle.importKey("raw",i,{name:"AES-GCM"},!1,["decrypt"]),As}async function gv(r){try{const e=Uint8Array.from(atob(r),l=>l.charCodeAt(0)),t=e.slice(0,12),n=e.slice(12,28),i=e.slice(28),s=new Uint8Array(i.length+16);s.set(i),s.set(n,i.length);const a=await mv(),o=await crypto.subtle.decrypt({name:"AES-GCM",iv:t},a,s);return JSON.parse(new TextDecoder().decode(o))}catch(e){try{return JSON.parse(r)}catch{throw e}}}function Vo(){const r=pv();_n=new WebSocket(r),_n.onopen=()=>{console.log("Connected to KimeraWare Event Server"),Ds=!0,yo=!0,ji=1e3,qi=0},_n.onmessage=async e=>{try{const t=await gv(e.data);if(console.log("WS Event received:",t.type),t.type==="apply_preset"){if(qt=t,t.textPosition&&(er=t.textPosition),Kt){console.log("Immediate video is active. Storing preset for later restoration.");return}await Ir(t)}if(t.type==="trigger_video"){console.log("WS Event received: trigger_video",t),Kt||qt||(qt={type:"apply_preset",presetId:"default",mode:"default",text:"",filterMode:"default",filterColor:"#ffffff",videoUrl:"",videoLoop:!0,videoAudio:!0,minDuration:2,maxDuration:4,frequencyPerMinute:3,mainImageData:null,childImageData:null});const n=parseFloat(t.originalDuration)||parseFloat(t.duration)||30,i=parseFloat(t.duration)||30;let s=0;if(t.startTime?s=Math.max(0,(Date.now()-t.startTime)/1e3):s=Math.max(0,n-i),s>=n){console.log(`Video override already expired (${s.toFixed(1)}s / ${n}s). Skipping.`);return}const a=performance.now();Zt="static",ct="SINTONIZANDO...";const o=++$c;let l=t.videoUrl||"";const c=oh(l);if(c){console.log("Resolving general YouTube ID for immediate video:",c);try{l=await lh(c)}catch(g){console.error("Failed to resolve stream for immediate video:",g),Zt="idle",ct="";return}}if(o!==$c){console.log("Immediate video trigger superseded by a newer request.");return}ge&&(ge.pause(),ge.src="",ge.load()),dt&&dt.dispose(),ge=document.createElement("video"),ge.preload="auto",ge.playsInline=!0,ge.webkitPlaysInline=!0,ge.loop=typeof t.videoLoop<"u"?t.videoLoop:!0,ge.muted=typeof t.videoAudio<"u"?!t.videoAudio:!0,l.startsWith("http")&&!l.includes(window.location.hostname)&&(ge.crossOrigin="anonymous");let h=!1;const d=()=>{if(h)return;h=!0;const g=(performance.now()-a)/1e3,_=t.startTime?Math.max(0,(Date.now()-t.startTime)/1e3):s+g;_>0&&_<n&&(console.log(`[Seek] Jumping to ${_.toFixed(2)}s (load delay: ${g.toFixed(2)}s)`),ge.currentTime=_)};ge.addEventListener("loadedmetadata",d,{once:!0}),ge.addEventListener("canplay",d,{once:!0}),ge.src=l,ge.load(),ge.loop||ge.addEventListener("ended",async()=>{console.log("Immediate video ended naturally. Reverting to active preset locally."),Kt=!1,xt&&(clearTimeout(xt),xt=null),qt&&await Ir(qt)});try{ah(ge)}catch(g){console.error("Audio filter setup failed:",g)}dt=new Yu(ge),dt.colorSpace=Qe,dt.minFilter=ft,dt.generateMipmaps=!1,Zt="idle",Kt=!0,Nt.mode="video",ct=t.text||"",er=t.textPosition||"center",Br=0,Hr="#ffffff",xt&&clearTimeout(xt),ge.play().then(()=>{console.log("Immediate video play started successfully.")}).catch(g=>{console.log("Immediate video autoplay blocked, waiting for interaction.")});let m;t.startTime?m=Math.max(.1,n-(Date.now()-t.startTime)/1e3):m=Math.max(.1,n-s),ln={startTime:t.startTime,originalDuration:n},sh(),xt=setTimeout(()=>{console.log("Immediate video override duration expired. Reverting to active preset."),Kt=!1,xt=null,Xs(),ln=null,qt&&Ir(qt)},m*1e3)}if(t.type==="video_sync"&&ge&&Kt&&t.startTime&&rh(t.startTime,t.originalDuration),t.type==="trigger_static"){Zt="static";const n=t.duration||1;setTimeout(()=>{Zt="idle"},n*1e3)}if(t.type==="image"&&t.imageData){const n=yt;yt=await Xr(t.imageData),Zt="custom_image",n&&n.dispose()}if(t.type==="text"&&(ct=t.text||"",t.textPosition&&(er=t.textPosition),Ys=null,qs=null),t.type==="filter"){const n={default:0,green:1,red:2,yellow:3,rainbow:4,custom:5},i=t.filterMode||"default";Br=n[i]!==void 0?n[i]:0,Hr=t.filterColor||"#ffffff"}t.type==="reset"&&(Kt=!1,xt&&(clearTimeout(xt),xt=null),Xs(),ln=null,Zt="idle",ct="",Br=0,Hr="#ffffff",bo(null,!1,!1),yt&&yt.dispose(),yt=null,Si=Ws||Zn,qt&&(console.log("Reset received. Restoring last applied preset:",qt),await Ir(qt))),t.type==="trigger_easter_egg"&&(Kt=!1,xt&&(clearTimeout(xt),xt=null),t.imageData?Xr(t.imageData).then(n=>{xn&&xn.dispose(),xn=n,Xn(t)}).catch(()=>Xn(t)):Xn(t))}catch(t){console.error("Error handling WS event:",t)}},_n.onclose=()=>{console.log(`WS connection closed. Reconnecting in ${ji}ms...`),Ds=!1,setTimeout(()=>{Vo(),ji=Math.min(ji*2,4e3)},ji)},_n.onerror=e=>{console.error("WS error:",e),Ds=!1}}document.addEventListener("visibilitychange",()=>{if(document.visibilityState==="visible"){if(console.log("[Visibility] Tab is visible again — checking sync..."),!_n||_n.readyState===WebSocket.CLOSED||_n.readyState===WebSocket.CLOSING){console.log("[Visibility] WS was closed. Reconnecting now..."),ji=1e3,Vo();return}if(Kt&&ln&&ln.startTime){console.log("[Visibility] Forcing immediate video resync.");const r=(Date.now()-ln.startTime)/1e3;if(r>=ln.originalDuration)console.log("[Visibility] Video expired while backgrounded. Reverting to preset."),Kt=!1,xt&&(clearTimeout(xt),xt=null),Xs(),ln=null,qt&&Ir(qt);else if(ge){const e=Math.abs(ge.currentTime-r);console.log(`[Visibility] Drift: ${e.toFixed(2)}s → correcting to ${r.toFixed(2)}s`),ge.currentTime=r,ge.paused&&ge.play().catch(()=>{})}sh()}}});const pn=document.createElement("canvas");pn.width=1024;pn.height=1586;const di=pn.getContext("2d"),$n=new qr(pn);$n.colorSpace=Qe;$n.minFilter=ft;$n.generateMipmaps=!1;const hr=document.createElement("canvas");hr.width=256;hr.height=256;const Jc=hr.getContext("2d"),Mt=new qr(hr);Mt.colorSpace=Qe;Mt.wrapS=ii;Mt.wrapT=ii;Mt.minFilter=gt;Mt.magFilter=gt;Mt.generateMipmaps=!1;let ws=null;const Jn=document.createElement("canvas");Jn.width=1024;Jn.height=1024;const Gt=Jn.getContext("2d"),vr=new qr(Jn);vr.colorSpace=Qe;vr.minFilter=ft;vr.generateMipmaps=!1;let Za=0,Rr=0,So=-1,$a=[],Ja=0,vt=!1,Wn="idle",an=0;const Qc=.3;let Eo=7,Qa=0,eo={};function Xn(r){Wn==="idle"&&(eo=r||{},typeof eo.duration=="number"?Eo=eo.duration:Eo=7,Wn="transition_in",an=0,vt=!0)}window[Is("1f0502100c1219320a041f1219320c10")]=async function(){try{const r=await fetch(ih("/api/mx-cfg"));if(!r.ok){Xn({});return}const e=await r.json();e.imageData?Xr(e.imageData).then(t=>{xn&&xn.dispose(),xn=t,Xn(e)}).catch(()=>Xn(e)):Xn(e)}catch(r){console.error("[Macrostasis]",r),Xn({})}};function rn(){ws||(ws=Jc.createImageData(hr.width,hr.height));const r=ws.data,e=r.length;for(let t=0;t<e;t+=4){const n=Math.floor(Math.random()*255);r[t]=n,r[t+1]=n,r[t+2]=n,r[t+3]=255}Jc.putImageData(ws,0,0),Mt.needsUpdate=!0}const To='"Sixtyfour", "SLNTHLN", monospace';function _v(r,e,t,n){e.font=`${n}px ${To}`;const i=r.split(`
`),s=[];for(const a of i){if(a.trim()===""){s.push("");continue}const o=a.split(" ");let l="";for(let c=0;c<o.length;c++){const u=o[c];if(u==="")continue;const h=l?l+" "+u:u;e.measureText(h).width>t?l?(s.push(l),l=u):(s.push(u),l=""):l=h}l&&s.push(l)}return s}let Ys=null,qs=null;function st(r,e){const t=e||er||"center";if(!(r===Ys&&t===qs)){if(Ys=r,qs=t,Gt.clearRect(0,0,Jn.width,Jn.height),r){Gt.save(),Gt.fillStyle="#ffffff",Gt.shadowColor="#ffffff";const n=850,i=850,s=16;let a=64,o=[],l=0,c=0;for(;a>=s;){if(l=Math.floor(a*1.35),o=_v(r,Gt,n,a),c=o.length*l,c<=i){let p=!0;Gt.font=`${a}px ${To}`;for(const f of o)if(Gt.measureText(f).width>n){p=!1;break}if(p)break}a-=2}Gt.font=`${a}px ${To}`,Gt.shadowBlur=Math.max(2,Math.floor(a*.15));const u=40,h=Jn.width,d=Jn.height;let m,g,_;switch(t){case"top-left":m=u,g=u+l/2,_="left";break;case"top-right":m=h-u,g=u+l/2,_="right";break;case"top-center":m=h/2,g=u+l/2,_="center";break;case"bottom-left":m=u,g=d-u-c+l/2,_="left";break;case"bottom-right":m=h-u,g=d-u-c+l/2,_="right";break;case"bottom-center":m=h/2,g=d-u-c+l/2,_="center";break;default:m=h/2,g=d/2-(o.length-1)*l/2,_="center"}Gt.textAlign=_,Gt.textBaseline="middle";for(let p=0;p<o.length;p++){const f=o[p];f&&Gt.fillText(f,m,g+p*l)}Gt.restore()}vr.needsUpdate=!0}}let to=null,sn=null,Rs=null,Cr=null,Lr=null,fi=null;function ah(r){try{if(!sn){sn=new(window.AudioContext||window.webkitAudioContext);const e=()=>{sn.state==="suspended"&&sn.resume()};window.addEventListener("click",e),window.addEventListener("mousemove",e),window.addEventListener("touchstart",e)}Rs&&Rs.disconnect(),Rs=sn.createMediaElementSource(r),Cr=sn.createBiquadFilter(),Cr.type="highpass",Cr.frequency.value=180,Lr=sn.createBiquadFilter(),Lr.type="lowpass",Lr.frequency.value=4e3,fi=sn.createBiquadFilter(),fi.type="peaking",fi.frequency.value=1e3,fi.Q.value=1.2,fi.gain.value=8,Rs.connect(Cr),Cr.connect(Lr),Lr.connect(fi),fi.connect(sn.destination),sn.state==="suspended"&&sn.resume()}catch(e){console.error("Web Audio API setup failed:",e)}}function oh(r){if(!r)return null;const e=/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/,t=r.match(e);return t&&t[2].length===11?t[2]:null}async function vv(r){const e=["https://cobalt.projectsegfau.lt","https://cobalt.api.ryder.xyz","https://api.cobalt.tools","https://api.cobalt.download","https://cobalt.moe"],t=["https://api.piped.private.coffee"],n=["https://inv.thepixora.com","https://invidious.flokinet.to","https://invidious.nerdvpn.de","https://invidious.tiekoetter.com","https://inv.nadeko.net","https://yewtu.be"],i=async c=>{const u=new AbortController,h=setTimeout(()=>u.abort(),6e3);try{const d=await fetch(c.endsWith("/")?c:c+"/",{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify({url:`https://www.youtube.com/watch?v=${r}`,videoQuality:"720"}),signal:u.signal});if(clearTimeout(h),!d.ok)throw new Error(`HTTP ${d.status}`);const m=await d.json();if((m.status==="stream"||m.status==="redirect"||m.status==="success")&&m.url)return console.log(`[YouTube Client] Success from Cobalt instance: ${c}`),m.url;throw new Error(`Invalid Cobalt response status: ${m.status}`)}catch(d){throw clearTimeout(h),d}},s=async c=>{const u=new AbortController,h=setTimeout(()=>u.abort(),6e3);try{const d=await fetch(`${c}/streams/${r}`,{signal:u.signal});if(clearTimeout(h),!d.ok)throw new Error(`HTTP ${d.status}`);const m=await d.json();if(!m.videoStreams||m.videoStreams.length===0)throw new Error("No videoStreams");const g=m.videoStreams.find(_=>_.format==="MPEG_4"||_.mimeType.includes("video/mp4"));if(!g||!g.url)throw new Error("No MP4 stream found");return console.log(`[YouTube Client] Success from Piped instance: ${c}`),g.url}catch(d){throw clearTimeout(h),d}},a=async c=>{const u=new AbortController,h=setTimeout(()=>u.abort(),6e3);try{const d=await fetch(`${c}/api/v1/videos/${r}`,{signal:u.signal});if(clearTimeout(h),!d.ok)throw new Error(`HTTP ${d.status}`);const m=await d.json();if(!m.formatStreams||m.formatStreams.length===0)throw new Error("No formatStreams");const g=m.formatStreams.find(p=>p.container==="mp4"||p.type.includes("video/mp4"));if(!g||!g.url)throw new Error("No MP4 stream found");let _=g.url;if(_.includes("local=true")||(_+=_.includes("?")?"&local=true":"?local=true"),_.startsWith("/"))_=c+_;else if(_.startsWith("http")){const p=new URL(_),f=new URL(c);p.host=f.host,p.protocol=f.protocol,p.searchParams.has("local")||p.searchParams.set("local","true"),_=p.toString()}return console.log(`[YouTube Client] Success from Invidious instance: ${c}`),_}catch(d){throw clearTimeout(h),d}},o=c=>new Promise((u,h)=>{let d=[],m=0;c.forEach(g=>{Promise.resolve(g).then(u).catch(_=>{d.push(_),m++,m===c.length&&h(new Error("All client instances failed: "+d.map(p=>p.message).join(", ")))})})}),l=[...e.map(i),...t.map(s),...n.map(a)];try{return await o(l)}catch(c){throw console.error("[YouTube Client] All client-side resolution attempts failed:",c),c}}async function lh(r){try{const e=await fetch(ih(`/api/yt-resolve?id=${r}`));if(!e.ok)throw new Error(`Server returned HTTP ${e.status}`);const t=await e.json();if(!t.url)throw new Error("Server response missing URL");return t.url}catch(e){return console.warn("[YouTube] Server proxy failed. Falling back to client-side Piped/Invidious racing...",e.message),await vv(r)}}async function bo(r,e,t){let n=r;if(!r){to=null,ge&&(ge.pause(),ge.src="",ge.load()),dt&&(dt.dispose(),dt=null);return}const i=oh(r);if(i)try{n=await lh(i)}catch(a){console.error("Failed to resolve YouTube video:",a);return}if(n===to&&ge){ge.loop=e,ge.muted=!t;return}to=n,ge&&(ge.pause(),ge.src="",ge.load()),dt&&(dt.dispose(),dt=null),ge=document.createElement("video"),ge.preload="auto",ge.playsInline=!0,ge.webkitPlaysInline=!0,ge.loop=e,ge.muted=!t,n.startsWith("http")&&!n.includes(window.location.hostname)&&(ge.crossOrigin="anonymous"),ge.src=n,ge.load();try{ah(ge)}catch(a){console.error("Audio filter setup failed:",a)}dt=new Yu(ge),dt.colorSpace=Qe,dt.minFilter=ft,dt.generateMipmaps=!1,ge.play().catch(()=>{console.log("Video play failed or autoplay blocked, waiting for interaction")})}function xv(){new Zu;const r=document.createElement("canvas");r.width=1,r.height=1;const e=new qr(r);return e.colorSpace=Qe,Zn=null,Si=e,Ws=e,xn=null,Vo(),Promise.resolve()}function eu(r){const e=Math.floor(r/60),t=r%60;if(e!==So){So=e,$a=[];const s=Math.max(1,nh),a=Math.max(.1,eh),o=Math.max(a,th),l=60/s;for(let c=0;c<s;c++){const u=a+Math.random()*(o-a),h=c*l,d=Math.max(0,l-u),m=h+Math.random()*d;$a.push({start:m,end:m+u})}}let n=!1;for(const s of $a)if(t>=s.start&&t<=s.end){n=!0;break}return Ja+=((n?1:0)-Ja)*.12,Math.min(Math.max(Ja,0),1)}function Mv(r,e,t){if(!r)return;if(r.uIsVideo&&(r.uIsVideo.value=Nt.mode==="video"?1:0),r.uPowerOff&&(r.uPowerOff.value=Nt.mode==="custom_image"&&!yt?1:0),r.uScaleX&&r.uScaleY&&(r.uScaleX.value=1,r.uScaleY.value=1),r.uTextureText.value=vr,typeof r.uFilterMode<"u"&&(r.uFilterMode.value=Br),r.uFilterColor&&r.uFilterColor.value.set(Hr),Ds)qi=8;else{if(!yo)qi>0?(qi-=t,rn(),r.uTexture.value=Mt,r.uChildVisibility.value=0,st("CONECTANDO...")):(rn(),r.uTexture.value=Mt,r.uChildVisibility.value=0,st("404 NO CONNECTION"));else if(qi>0)qi-=t;else{rn(),r.uTexture.value=Mt,r.uChildVisibility.value=0,st("404 NO CONNECTION");return}if(!yo)return}const n=()=>{ct?st(ct):Qa>0?(Qa-=t,st(Is("283f4b3c3c"),"top-left")):st("")};if(Wn==="transition_in"){if(an+=t,vt=!0,rn(),st(""),r.uTexture.value=Mt,r.uChildVisibility.value=0,an>=Qc){if(Wn="active",an=0,vt=!1,di.clearRect(0,0,pn.width,pn.height),xn&&xn.image){di.save(),di.filter="invert(1)";const i=720,s=i*(769/612),a=(pn.width-i)/2,o=(pn.height-s)/2;di.drawImage(xn.image,a,o,i,s),di.restore()}$n.needsUpdate=!0}return}if(Wn==="active"){an+=t,vt=!1,ct?st(ct,er):an<=2?st(Is("283f4b3a3f342f2f"),"top-left"):st(""),r.uScaleX&&(r.uScaleX.value=1.936872),r.uTexture.value=$n,r.uChildVisibility.value=0,an>=Eo&&(Wn="transition_out",an=0,vt=!0);return}if(Wn==="transition_out"){an+=t,vt=!0,rn(),st(""),r.uTexture.value=Mt,r.uChildVisibility.value=0,an>=Qc&&(Wn="idle",an=0,vt=!1,Qa=2);return}if(Zt==="static"){vt=!1,rn(),r.uTexture.value=Mt,r.uChildVisibility.value=0,st(ct||"");return}if(Zt==="custom_image"&&yt){vt=!1,r.uTexture.value=yt,r.uChildVisibility.value=0,st(ct||"");return}if(Nt.mode==="static"){vt=!1,rn(),r.uTexture.value=Mt,st(ct||""),r.uChildVisibility.value=0;return}if(Nt.mode==="custom_image"){vt=!1,yt?r.uTexture.value=yt:(di.fillStyle="#000000",di.fillRect(0,0,pn.width,pn.height),$n.needsUpdate=!0,r.uTexture.value=$n),st(ct||""),r.uChildVisibility.value=0;return}if(Nt.mode==="default"){vt=!1,n(),yt||Zn?(r.uScaleX&&(r.uScaleX.value=1.936872),r.uTexture.value=yt||Zn,r.uTextureChild.value=Si,r.uChildVisibility.value=eu(e)):(rn(),r.uTexture.value=Mt,ct||st("SEÑAL PENDIENTE"),r.uChildVisibility.value=0);return}if(Nt.mode==="video"){vt=!1,dt&&ge&&ge.readyState>=2?(dt.needsUpdate=!0,r.uTexture.value=dt):(rn(),r.uTexture.value=Mt),st(ct||""),r.uChildVisibility.value=0;return}if(Nt.mode==="slideshow"){const i=Nt.slideshow.images;if(!i||i.length===0){vt=!1,rn(),r.uTexture.value=Mt,ct||st("SEÑAL PENDIENTE"),r.uChildVisibility.value=0;return}if(i.length<=1){vt=!1;const s=i[0],a=Zc[s]||Zn;n(),r.uTexture.value=a,r.uChildVisibility.value=0;return}if(Rr+=t,vt)rn(),st(""),r.uTexture.value=Mt,r.uChildVisibility.value=0,Rr>=Nt.slideshow.transitionDuration&&(Za=(Za+1)%i.length,Rr=0,vt=!1);else{const s=i[Za],a=Zc[s]||Zn;n(),r.uTexture.value=a,s===Is("4407340345130a03")?(r.uScaleX&&(r.uScaleX.value=1.936872),r.uTextureChild.value=Si,r.uChildVisibility.value=eu(e)):r.uChildVisibility.value=0,Rr>=Nt.slideshow.slideDuration&&(Rr=0,vt=!0)}}}function yv(){xt&&(clearTimeout(xt),xt=null),Kt=!1,ge&&(ge.pause(),ge.src="",ge.load()),_n&&_n.close(),yt&&yt.dispose(),$n.dispose(),Mt.dispose(),vr.dispose(),dt&&dt.dispose()}const Wo=()=>{Nt.mode==="video"&&ge&&ge.paused&&ge.play().catch(()=>{})};window.addEventListener("click",Wo);window.addEventListener("pointerdown",Wo);window.addEventListener("touchstart",Wo);/*! REJECTED FALSE ICONS (5/7) */const tu=r=>{const e=new hn;let t=!1;return r.traverse(n=>{if(n.isMesh){const i=new hn().setFromObject(n);t?e.union(i):(e.copy(i),t=!0)}}),e};function Sv(r,e,t,n){const i=new L0,s=new Promise((a,o)=>{i.load("/crt-tv.glb",l=>{Pr("model",50),a(l)},l=>{let c=l.total;(!c||c===0)&&(c=4862760);const u=Math.min(l.loaded/c,1);Pr("model",u*50)},l=>{console.error("Error loading TV GLTF:",l),o(l)})});return Pr("texture1",10),Pr("texture2",10),s.then(a=>xv().then(()=>a)).then(a=>{const o=new jn;r.add(o);const l=a.scene;o.add(l),l.position.set(0,0,0),l.rotation.set(0,0,0),l.scale.set(1,1,1),l.updateMatrixWorld(!0);const c=2.4,h=tu(l).getSize(new P),d=c/h.y;l.scale.setScalar(d),l.updateMatrixWorld(!0);const m=tu(l),g=m.getCenter(new P);l.position.x=-g.x,l.position.y=-m.min.y,l.position.z=-g.z,l.rotation.y=Math.PI,l.updateMatrixWorld(!0),l.traverse(Z=>{Z.isMesh&&(Z.castShadow=!0,Z.receiveShadow=!0,Z.material&&(Z.material.roughness=Math.max(Z.material.roughness,.45),Z.material.metalness=Math.min(Z.material.metalness,.8)))});const _=new fr(1.75,1.54,16,16),p=new Nn({vertexShader:uv,fragmentShader:hv,uniforms:{uTime:{value:0},uTexture:{value:null},uTextureChild:{value:null},uTextureText:{value:null},uChildVisibility:{value:0},uMagneticCenter:{value:new be(-10,-10)},uMagneticTime:{value:0},uMagneticIntensity:{value:0},uMagneticBuildup:{value:0},uMagneticVelocity:{value:new be(0,0)},uFilterMode:{value:0},uFilterColor:{value:new Ce("#ffffff")},uScaleX:{value:1},uScaleY:{value:1},uIsVideo:{value:0},uPowerOff:{value:0}}}),f=new Ft(_,p),E=m.max.z-g.z;f.position.set(0,1.3,E+2.01),o.add(f);const M=new Gs(11196671,12,9,Math.PI/2.2,.95,1.1);M.position.set(0,1.3,E+2.05);const b=new nt;b.position.set(0,0,E+5.5),o.add(b),M.target=b,o.add(M);const C=new Gs(16733457,14,3.2,Math.PI/2.5,.9,2);C.position.set(0,1.3,E+.3);const R=new nt;R.position.set(0,1.3,E-.5),o.add(R),C.target=R,o.add(C),o.position.set(0,0,12),e.target.set(0,1.3,12),n.position.set(0,1.3,12),t.target=n;let A=!1,z=0;const x=3.5,T=.22;let D=0,W=0,$=0,I=0,O=0,V=0;return{tvGroup:o,crtScreen:f,crtLight:M,internalCabinetLight:C,update:(Z,B)=>{if(p.uniforms.uTime.value=Z,V=Math.max(V-B*5,0),I*=Math.max(1-B*6,0),O*=Math.max(1-B*6,0),A){z=Math.min(z+B,x);const X=z/x;p.uniforms.uMagneticIntensity.value=Math.min(.15+X*.85+V*.4,1.3),p.uniforms.uMagneticBuildup.value=X,p.uniforms.uMagneticTime.value+=B,p.uniforms.uMagneticVelocity.value.set(I,O);const ae=Math.min(X*.032,.032);ae>.001?o.position.set((Math.random()-.5)*ae,(Math.random()-.5)*ae,12+(Math.random()-.5)*ae):o.position.set(0,0,12)}else if(W>0)if($+=B,p.uniforms.uMagneticTime.value+=B,p.uniforms.uMagneticVelocity.value.set(0,0),$<0){const X=($+T)/T,ae=Math.sin(X*Math.PI)*.55,he=Math.min(D+ae,1.4);p.uniforms.uMagneticIntensity.value=he,p.uniforms.uMagneticBuildup.value=he,o.position.set(0,0,12)}else{const X=Math.min($/W,1),ae=1-X*X,he=D*ae;if(he<=.001||X>=1)p.uniforms.uMagneticIntensity.value=0,p.uniforms.uMagneticBuildup.value=0,W=0,o.position.set(0,0,12);else{p.uniforms.uMagneticIntensity.value=he,p.uniforms.uMagneticBuildup.value=he;const pe=he*.032;o.position.set((Math.random()-.5)*pe,(Math.random()-.5)*pe,12+(Math.random()-.5)*pe)}}else p.uniforms.uMagneticVelocity.value.set(0,0),vt?o.position.set((Math.random()-.5)*.012,(Math.random()-.5)*.012,12+(Math.random()-.5)*.012):o.position.set(0,0,12);Mv(p.uniforms,Z,B),M.intensity=(1.4+Math.sin(Z*35)*.18+Math.sin(Z*7)*.06)*16,C.intensity=10+Math.sin(Z*22)*.8+Math.sin(Z*4)*.25,l.position.set(-g.x,-m.min.y,-g.z)},destroy:()=>{_.dispose(),p.dispose(),yv(),r.remove(o)},startMagneticHold:Z=>{A=!0,z=p.uniforms.uMagneticBuildup.value*x,W=0,$=0,p.uniforms.uMagneticCenter.value.copy(Z)},stopMagneticHold:()=>{A&&(A=!1,D=p.uniforms.uMagneticBuildup.value,W=1.5+D*9,$=-T)},setVelocityBoost:(Z,B)=>{const X=Math.sqrt(Z*Z+B*B);V=Math.min(X*12,.6),I=Z*8,O=B*8}}})}/*! EL Psy Koongro (6/7) */function Ev(r,e,t){let n=-10,i=!1,s=!0,a=-10,o=0;const l=r.position.distanceTo(e.target);let c=0,u=Math.PI/2-.15,h=l,d=0,m=Math.PI/2-.15,g=l,_=1;const p=5.5,f=z=>{n=z},E=()=>{i=!0,s=!0,o=0},M=()=>{i&&(s=!0,o=0)},b=()=>{i=!1,s=!0,o=0},C=()=>{s=!0,o=0};return t.addEventListener("pointerdown",E),t.addEventListener("pointermove",M),t.addEventListener("pointerup",b),t.addEventListener("wheel",C),{update:(z,x)=>{i&&f(z);const T=z-n;if(!i&&T>5){const I=r.position.x,O=r.position.y-1.3,V=r.position.z-12,j=Math.sqrt(I*I+O*O+V*V),Y=Math.acos(O/j),K=Math.atan2(I,V);z-a>5.5&&(s?(c=K,u=Y,h=j,s=!1):(c=d,u=m,h=g),d=(Math.random()-.5)*.28,m=Math.PI/2-.15+(Math.random()-.5)*.06,window.innerWidth<768?g=6.8+Math.random()*.7:g=5.2+Math.random()*.5,_=0,a=z),_=Math.min(_+x/p,1);const q=_,ie=q*q*q*(q*(q*6-15)+10),Z=qn.lerp(c,d,ie),B=qn.lerp(u,m,ie),X=qn.lerp(h,g,ie);o=qn.lerp(o,1,.015);const ae=Z+Math.sin(z*.15)*.02*o,he=B+Math.cos(z*.2)*.015*o,pe=X+Math.sin(z*.1)*.08*o;r.position.x=pe*Math.sin(he)*Math.sin(ae),r.position.y=1.3+pe*Math.cos(he),r.position.z=12+pe*Math.sin(he)*Math.cos(ae)}e.update(),r.position.y<.2&&(r.position.y=.2),e.target.y<0&&(e.target.y=0)},destroy:()=>{t.removeEventListener("pointerdown",E),t.removeEventListener("pointermove",M),t.removeEventListener("pointerup",b),t.removeEventListener("wheel",C)}}}const ri=document.getElementById("webgl-canvas"),Tv=document.getElementById("app-container"),{scene:na,camera:ia,renderer:no,controls:ra}=T0(Tv,ri);ta("scene");const io=w0();ta("overlay");const Ao=R0(na);ta("lights");const bv=C0(na);ta("particles");const Av=Ev(ia,ra,ri);let wo=null,ni=null;Sv(na,ra,Ao.spotlight,Ao.spotTarget).then(r=>{wo=r.update,ni=r,window.tvGroup=r.tvGroup,window.crtScreen=r.crtScreen,window.crtLight=r.crtLight,window.internalCabinetLight=r.internalCabinetLight,Kc()}).catch(r=>{console.error("TV Model failed to load:",r),Kc()});const kr=new y0,nr=new be;let zr=null,$i=null,Ro={x:0,y:0},Xo=!1;const wv=950,Rv=6,nu=new un,iu=new P,ru=new P,ro=new P,su=new Ln,au=new be(-1,-1),Cv=r=>{if(!window.crtScreen||!ni)return;const e=ri.getBoundingClientRect();nr.x=(r.clientX-e.left)/e.width*2-1,nr.y=-((r.clientY-e.top)/e.height)*2+1,kr.setFromCamera(nr,ia);const t=window.crtScreen.material.uniforms.uMagneticCenter.value,n=t.x,i=t.y,s=kr.intersectObject(window.crtScreen);s.length>0&&s[0].uv?t.copy(s[0].uv):(window.crtScreen.updateWorldMatrix(!0,!1),window.crtScreen.getWorldQuaternion(nu),window.crtScreen.getWorldPosition(iu),su.setFromNormalAndCoplanarPoint(new P(0,0,1).applyQuaternion(nu),iu),kr.ray.intersectPlane(su,ru)&&(window.crtScreen.worldToLocal(ro.copy(ru)),t.set(qn.clamp(ro.x/1.75+.5,.02,.98),qn.clamp(ro.y/1.54+.5,.02,.98)))),au.x>=0&&ni.setVelocityBoost&&ni.setVelocityBoost(t.x-n,t.y-i),au.set(t.x,t.y)},ch=()=>{zr&&(clearTimeout(zr),zr=null),$i=null},sa=()=>{ch(),Xo=!1,ra.enabled=!0,ni&&ni.stopMagneticHold()};ri.addEventListener("pointerdown",r=>{const e=ri.getBoundingClientRect();if(Ro={x:r.clientX,y:r.clientY},nr.x=(r.clientX-e.left)/e.width*2-1,nr.y=-((r.clientY-e.top)/e.height)*2+1,kr.setFromCamera(nr,ia),window.crtScreen&&ni){const t=kr.intersectObject(window.crtScreen);t.length>0&&t[0].uv&&($i=t[0].uv.clone(),zr=setTimeout(()=>{$i&&(ra.enabled=!1,Xo=!0,ni.startMagneticHold($i),$i=null),zr=null},wv))}});ri.addEventListener("pointermove",r=>{if($i&&r.buttons>0){const e=r.clientX-Ro.x,t=r.clientY-Ro.y;Math.sqrt(e*e+t*t)>Rv&&ch()}Xo&&Cv(r)});ri.addEventListener("pointerup",sa);ri.addEventListener("pointercancel",sa);document.addEventListener("visibilitychange",()=>{document.hidden&&sa()});window.addEventListener("blur",sa);const ou=new h0,uh=()=>{requestAnimationFrame(uh);const r=Math.min(ou.getDelta(),.1),e=ou.getElapsedTime();io.update(e),Ao.update(e),bv.update(e),wo&&wo(e,r),Av.update(e,r),no.clear(),no.render(na,ia),no.render(io.overlayScene,io.overlayCamera)};uh();
