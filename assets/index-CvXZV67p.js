...
`)}function i_(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function Ji(i){return i!==""}function gc(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function _c(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const r_=/^[ \t]*#include +<([\w\d./]+)>/gm;function _a(i){return i.replace(r_,o_)}const s_=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function o_(i,e){let t=He[e];if(t===void 0){const n=s_.get(e);if(n!==void 0)t=He[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return _a(t)}const a_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function vc(i){return i.replace(a_,l_)}function l_(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function xc(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function c_(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===pu?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===mu?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Ln&&(e="SHADOWMAP_TYPE_VSM"),e}function u_(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case sr:case or:e="ENVMAP_TYPE_CUBE";break;case Ks:e="ENVMAP_TYPE_CUBE_UV";break}return e}function h_(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case or:e="ENVMAP_MODE_REFRACTION";break}return e}function d_(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case gu:e="ENVMAP_BLENDING_MULTIPLY";break;case qh:e="ENVMAP_BLENDING_MIX";break;case jh:e="ENVMAP_BLENDING_ADD";break}return e}function f_(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function p_(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=c_(t),c=u_(t),u=h_(t),h=d_(t),d=f_(t),m=t.isWebGL2?"":e_(t),g=t_(t),_=n_(s),p=r.createProgram();let f,E,M=t.glslVersion?"#version "+t.glslVersion+`
...
`,$o=document.getElementById("loading-splash"),vv=document.getElementById("loading-bar-fill"),xv=document.getElementById("loading-text");let Zt={scene:10,overlay:5,lights:5,particles:10,texture1:0,texture2:0,model:0},Xs=!1;function sh(i,e){if(Xs)return;const t=Math.min(Math.max(Math.round(i),0),100);vv.style.width=`${t}%`,e&&(xv.textContent=e)}function Dr(i,e){if(Xs)return;Zt[i]=e;const t=Math.min(Zt.scene+Zt.overlay+Zt.lights+Zt.particles+Zt.texture1+Zt.texture2+Zt.model,100);let n="Cargando...";t<30?n="Preparando escena...":Zt.model<50?n=`Cargando modelo 3D... ${Math.round(Zt.model/50*100)}%`:Zt.texture1<10||Zt.texture2<10?n="Cargando texturas...":n="Listo.",sh(t,n)}function no(i){const e={scene:10,overlay:5,lights:5,particles:10};e[i]!==void 0&&Dr(i,e[i])}function Qc(){Xs||(Xs=!0,sh(100,"Listo."),setTimeout(()=>{$o.classList.add("done"),$o.addEventListener("animationend",()=>$o.remove(),{once:!0})},350))}function Ns(i){const e="kw";let t="";for(let n=0;n<i.length;n+=2){const r=parseInt(i.substring(n,n+2),16),s=e.charCodeAt(n/2%e.length);t+=String.fromCharCode(r^s)}return t}const Ft={mode:"default",slideshow:{images:[],slideDuration:12,transitionDuration:.45}};let Qn=null,bi=null,Mn=null;const eu={};let $=null,At=null,ot=null,Yt=null,yt=null,ft="",cn="idle",In=0,Yr="#ffffff",nr="center",Zi=1e3;const Ur=new we(11196671),Wa=document.createElement("canvas");Wa.width=1;Wa.height=1;const tu=Wa.getContext("2d",{willReadFrequently:!0});let Qt=!1,Mt=null,$t=null,nu=0,un=null,ir=null,Ys=null,oh=3,ah=5,lh=5,Xt=null;const Mv=()=>window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?"ws://localhost:8088":"wss://kimeraware.macrostasis.dev/ws",qs=i=>window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?i:`https://kimeraware.macrostasis.dev${i}`,ch=i=>{const e=window.location.hostname;return e==="localhost"||e==="127.0.0.1"||e.includes("macrostasis.dev")?i:`https://kimeraware.macrostasis.dev${i}`},uh=i=>{if(!i)return i;let e=i;if(i.includes("/assets/")){const t=i.substring(i.indexOf("/assets/"));e=ch(t)}if((e.startsWith("http://")||e.startsWith("https://"))&&!e.includes("/api/yt-proxy")){const t=window.location.hostname;let n=!0;if(t==="localhost"||t==="127.0.0.1")try{const r=new URL(i);(r.hostname==="localhost"||r.hostname==="127.0.0.1")&&(n=!1)}catch{}(e.includes("local=true")||e.includes("/assets/")||e.includes("assets/")||e.includes("piped")||e.includes("cobalt")||e.includes("invidious")||e.includes("yewtu.be")||e.includes("nadeko.net"))&&(n=!1),n&&(e=qs(`/api/yt-proxy?url=${encodeURIComponent(e)}`))}return e+=(e.includes("?")?"&":"?")+"t_cb="+Date.now(),e};function qr(i){return new Promise((e,t)=>{const n=new Image;n.onload=()=>{const s=new vt(n);s.colorSpace=Qe,s.minFilter=pt,s.generateMipmaps=!1,s.needsUpdate=!0,e(s)},n.onerror=s=>{t(s)};let r=i;if(i&&i.includes("/assets/")){const s=i.substring(i.indexOf("/assets/"));r=ch(s)}r&&(r.startsWith("http://")||r.startsWith("https://"))&&(n.crossOrigin="anonymous"),n.src=r})}async function Nr(i){Ft.mode=i.mode||"default",ft=i.text||"",nr=i.textPosition||"center",jr=null,Kr=null,oh=i.minDuration||3,ah=i.maxDuration||5,lh=i.frequencyPerMinute||5,Ea=-1;const e={default:0,green:1,red:2,yellow:3,rainbow:4,custom:5},t=i.filterMode||"default";In=e[t]!==void 0?e[t]:0,Yr=i.filterColor||"#ffffff";const n=i.videoUrl||"",r=typeof i.videoLoop<"u"?i.videoLoop:!0,s=typeof i.videoAudio<"u"?i.videoAudio:!0;if(Ft.mode==="video"?Aa(n,r,s):Aa(null,!1,!1),i.mainImageData){const o=yt;yt=await qr(i.mainImageData),Ft.mode==="custom_image"?cn="custom_image":cn="idle",o&&o.dispose()}else cn="idle",yt&&yt.dispose(),yt=null;if(i.childImageData){const o=bi;bi=await qr(i.childImageData),o&&o!==Qn&&o!==Ys&&o.dispose()}else bi=Ys||Qn}let iu=0;function hh(i,e){if(!$||$.paused||!i)return;if($.readyState<3){console.log(`[Sync] Skipping sync: Video is buffering/loading (readyState: ${$.readyState})`);return}let t=(Date.now()-i)/1e3;const n=e||1/0;if(t<0||t>=n)return;$.duration&&$.loop&&(t=t%$.duration);const r=Math.abs($.currentTime-t),s=$.currentTime<8?2:.8;if(r>s){const o=Date.now();if(o-iu<6e3){console.log(`[Sync] Drift detected (${r.toFixed(2)}s) but throttling seek to let Hls.js buffer...`);return}let a=!1;try{const l=$.buffered;for(let c=0;c<l.length;c++)if(t>=l.start(c)&&t<=l.end(c)){a=!0;break}}catch{}if(!a&&r<4){console.log(`[Sync] Drift of ${r.toFixed(2)}s detected, but target position ${t.toFixed(2)}s is not in buffer yet. Waiting for Hls.js buffering...`);return}console.log(`[Sync] Correcting drift of ${r.toFixed(2)}s (threshold: ${s}s) — seeking to ${t.toFixed(2)}s`),iu=o,$.currentTime=t}}function dh(){ir&&clearInterval(ir),ir=setInterval(()=>{if(!Qt||!un){js();return}hh(un.startTime,un.originalDuration)},2e3)}function js(){ir&&(clearInterval(ir),ir=null)}let Ls=null;async function yv(){if(Ls)return Ls;const i="75,87,95,65,82,71",e=new Uint8Array(i.split(",").map(Number)),t=new TextEncoder().encode("kimeraware-ws-2025"),n=await crypto.subtle.importKey("raw",e,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),r=await crypto.subtle.sign("HMAC",n,t);return Ls=await crypto.subtle.importKey("raw",r,{name:"AES-GCM"},!1,["decrypt"]),Ls}async function Sv(i){try{const e=Uint8Array.from(atob(i),l=>l.charCodeAt(0)),t=e.slice(0,12),n=e.slice(12,28),r=e.slice(28),s=new Uint8Array(r.length+16);s.set(r),s.set(n,r.length);const o=await yv(),a=await crypto.subtle.decrypt({name:"AES-GCM",iv:t},o,s);return JSON.parse(new TextDecoder().decode(a))}catch(e){try{return JSON.parse(i)}catch{throw e}}}function Xa(){const i=Mv();Yt=new WebSocket(i),Yt.onopen=()=>{console.log("Connected to KimeraWare Event Server"),Zi=1e3},Yt.onmessage=async t=>{try{const n=await Sv(t.data);console.log("WS Event received:",n.type),await e(n)}catch(n){console.error("Error handling WS event:",n)}finally{Xt&&(Xt(),Xt=null)}};async function e(t){if(jr=null,Kr=null,t.type==="apply_preset"){if($t=t,t.textPosition&&(nr=t.textPosition),Qt){console.log("Immediate video is active. Storing preset for later restoration.");return}await Nr(t)}if(t.type==="trigger_video"){console.log("WS Event received: trigger_video",t),Qt||$t||($t={type:"apply_preset",presetId:"default",mode:"default",text:"",filterMode:"default",filterColor:"#ffffff",videoUrl:"",videoLoop:!0,videoAudio:!0,minDuration:2,maxDuration:4,frequencyPerMinute:3,mainImageData:null,childImageData:null});const n=parseFloat(t.originalDuration)||parseFloat(t.duration)||30,r=parseFloat(t.duration)||30;let s=0;if(t.startTime?s=Math.max(0,(Date.now()-t.startTime)/1e3):s=Math.max(0,n-r),s>=n){console.log(`Video override already expired (${s.toFixed(1)}s / ${n}s). Skipping.`);return}const o=Date.now()-t.startTime<5e3,a=performance.now(),l=++nu;let c=t.videoUrl||"";const u=fh(c);if(u){console.log("Resolving general YouTube ID for immediate video:",u);try{c=await ph(u)}catch(p){console.error("Failed to resolve stream for immediate video:",p),cn="idle",ft="";return}}if(l!==nu){console.log("Immediate video trigger superseded by a newer request.");return}ot&&(ot.destroy(),ot=null),$&&($.pause(),$.removeAttribute("src"),$.load());let h=!1;$||($=document.createElement("video"),$.preload="auto",$.playsInline=!0,$.webkitPlaysInline=!0,$.crossOrigin="anonymous",h=!0),$.loop=typeof t.videoLoop<"u"?t.videoLoop:!0,$.muted=typeof t.videoAudio<"u"?!t.videoAudio:!0,$.dataset.shouldPlayAudio=typeof t.videoAudio<"u"?!!t.videoAudio:!0;let d=!1;const m=()=>{if(!d&&(d=!0,!o)){const p=(performance.now()-a)/1e3,f=t.startTime?Math.max(0,(Date.now()-t.startTime)/1e3):s+p;f>0&&f<n&&(console.log(`[Seek] Jumping to ${f.toFixed(2)}s (load delay: ${p.toFixed(2)}s)`),$.currentTime=f)}};$.addEventListener("loadedmetadata",m,{once:!0}),$.addEventListener("canplay",m,{once:!0}),$.crossOrigin="anonymous";const g=uh(c);if(g.includes(".m3u8")&&typeof Hls<"u"?Hls.isSupported()?(ot=new Hls({maxBufferLength:8,maxMaxBufferLength:12,enableWorker:!0,lowLatencyMode:!0}),ot.attachMedia($),ot.loadSource(g),ot.on(Hls.Events.MANIFEST_PARSED,()=>{console.log("[HLS.js WS] Manifest loaded, playing...")}),ot.on(Hls.Events.ERROR,(p,f)=>{if(f.fatal)switch(f.type){case Hls.ErrorTypes.NETWORK_ERROR:console.warn("[HLS.js WS] Network error, attempting recovery...",f),ot.startLoad();break;case Hls.ErrorTypes.MEDIA_ERROR:console.warn("[HLS.js WS] Media error, attempting recovery...",f),ot.recoverMediaError();break;default:console.error("[HLS.js WS] Unrecoverable error",f);break}})):$.canPlayType("application/vnd.apple.mpegurl")&&($.src=g,$.load()):($.src=g,$.load()),$.loop||$.addEventListener("ended",async()=>{console.log("Immediate video ended naturally. Reverting to active preset locally."),Qt=!1,Mt&&(clearTimeout(Mt),Mt=null),$t&&await Nr($t)}),h)try{qa($)}catch(p){console.error("Audio filter setup failed:",p)}At||(At=new Ju($),At.colorSpace=Qe,At.minFilter=pt,At.generateMipmaps=!1);const _=()=>{cn="idle",Qt=!0,Ft.mode="video",ft=t.text||"",nr=t.textPosition||"center",Mt&&clearTimeout(Mt);let p;if(o){if(p=n,Yt&&Yt.readyState===WebSocket.OPEN)try{Yt.send(JSON.stringify({type:"video_playing",videoUrl:t.videoUrl||c,originalDuration:n})),console.log("[WebSocket] Sent video_playing confirmation to server.")}catch(f){console.error("[WebSocket] Failed to send video_playing confirmation:",f)}}else t.startTime?p=Math.max(.1,n-(Date.now()-t.startTime)/1e3):p=Math.max(.1,n-s);o||(un={startTime:t.startTime,originalDuration:n},dh()),Mt=setTimeout(()=>{console.log("Immediate video override duration expired. Reverting to active preset."),Qt=!1,Mt=null,js(),un=null,$t&&Nr($t)},p*1e3)};$.addEventListener("playing",_,{once:!0}),$.play().then(()=>{console.log("Immediate video play started successfully.")}).catch(p=>{console.log("Immediate video autoplay blocked. Retrying with mute...",p),$.muted=!0,$.play().then(()=>{console.log("Muted fallback autoplay succeeded! Click to unmute listener added.");const f=()=>{$.muted=typeof t.videoAudio<"u"?!t.videoAudio:!1,at&&at.state==="suspended"&&at.resume(),console.log("User interacted. Restored original audio state."),document.removeEventListener("click",f),document.removeEventListener("keydown",f),document.removeEventListener("touchstart",f)};document.addEventListener("click",f),document.addEventListener("keydown",f),document.addEventListener("touchstart",f)}).catch(f=>{console.error("Even muted autoplay failed:",f),_()})})}if(t.type==="video_sync"&&$&&Qt&&t.startTime&&hh(t.startTime,t.originalDuration),t.type==="trigger_static"){cn="static";const n=t.duration||1;setTimeout(()=>{cn="idle"},n*1e3)}if(t.type==="image"&&t.imageData){const n=yt;yt=await qr(t.imageData),cn="custom_image",n&&n.dispose()}if(t.type==="text"&&(ft=t.text||"",t.textPosition&&(nr=t.textPosition),jr=null,Kr=null),t.type==="filter"){const n={default:0,green:1,red:2,yellow:3,rainbow:4,custom:5},r=t.filterMode||"default";In=n[r]!==void 0?n[r]:0,Yr=t.filterColor||"#ffffff"}t.type==="reset"&&(Qt=!1,Mt&&(clearTimeout(Mt),Mt=null),js(),un=null,cn="idle",ft="",In=0,Yr="#ffffff",Aa(null,!1,!1),yt&&yt.dispose(),yt=null,bi=Ys||Qn,$t&&(console.log("Reset received. Restoring last applied preset:",$t),await Nr($t))),t.type==="trigger_easter_egg"&&(Qt=!1,Mt&&(clearTimeout(Mt),Mt=null),t.imageData?qr(t.imageData).then(n=>{Mn&&Mn.dispose(),Mn=n,jn(t)}).catch(()=>jn(t)):jn(t))}Yt.onclose=()=>{console.log(`WS connection closed. Reconnecting in ${Zi}ms...`),Xt&&(Xt(),Xt=null),setTimeout(()=>{Xa(),Zi=Math.min(Zi*2,4e3)},Zi)},Yt.onerror=t=>{console.error("WS error:",t),Xt&&(Xt(),Xt=null)}}document.addEventListener("visibilitychange",()=>{if(document.visibilityState==="visible"){if(console.log("[Visibility] Tab is visible again — checking sync..."),!Yt||Yt.readyState===WebSocket.CLOSED||Yt.readyState===WebSocket.CLOSING){console.log("[Visibility] WS was closed. Reconnecting now..."),Zi=1e3,Xa();return}if(Qt&&un&&un.startTime){console.log("[Visibility] Forcing immediate video resync.");const i=(Date.now()-un.startTime)/1e3;if(i>=un.originalDuration)console.log("[Visibility] Video expired while backgrounded. Reverting to preset."),Qt=!1,Mt&&(clearTimeout(Mt),Mt=null),js(),un=null,$t&&Nr($t);else if($){const e=Math.abs($.currentTime-i);console.log(`[Visibility] Drift: ${e.toFixed(2)}s → correcting to ${i.toFixed(2)}s`),$.currentTime=i,$.paused&&$.play().catch(()=>{})}dh()}}});const gn=document.createElement("canvas");gn.width=1024;gn.height=1586;const mi=gn.getContext("2d"),ei=new $r(gn);ei.colorSpace=Qe;ei.minFilter=pt;ei.generateMipmaps=!1;const fr=document.createElement("canvas");fr.width=256;fr.height=256;const ru=fr.getContext("2d"),Ut=new $r(fr);Ut.colorSpace=Qe;Ut.wrapS=oi;Ut.wrapT=oi;Ut.minFilter=_t;Ut.magFilter=_t;Ut.generateMipmaps=!1;let Ps=null;const ti=document.createElement("canvas");ti.width=1024;ti.height=1024;const Wt=ti.getContext("2d"),Mr=new $r(ti);Mr.colorSpace=Qe;Mr.minFilter=pt;Mr.generateMipmaps=!1;let Jo=0,Lr=0,Ea=-1,Qo=[],ea=0,xt=!1,qn="idle",an=0;const su=.3;let Ta=7,ta=0,na={};function jn(i){qn==="idle"&&(na=i||{},typeof na.duration=="number"?Ta=na.duration:Ta=7,qn="transition_in",an=0,xt=!0)}window[Ns("1f0502100c1219320a041f1219320c10")]=async function(){try{const i=await fetch(qs("/api/mx-cfg"));if(!i.ok){jn({});return}const e=await i.json();e.imageData?qr(e.imageData).then(t=>{Mn&&Mn.dispose(),Mn=t,jn(e)}).catch(()=>jn(e)):jn(e)}catch(i){console.error("[Macrostasis]",i),jn({})}};function Xn(){Ps||(Ps=ru.createImageData(fr.width,fr.height));const i=Ps.data,e=i.length;for(let t=0;t<e;t+=4){const n=Math.floor(Math.random()*255);i[t]=n,i[t+1]=n,i[t+2]=n,i[t+3]=255}ru.putImageData(Ps,0,0),Ut.needsUpdate=!0}const ba='"Sixtyfour", "SLNTHLN", monospace';function Ev(i,e,t,n){e.font=`${n}px ${ba}`;const r=i.split(`
`),s=[];for(const o of r){if(o.trim()===""){s.push("");continue}const a=o.split(" ");let l="";for(let c=0;c<a.length;c++){const u=a[c];if(u==="")continue;const h=l?l+" "+u:u;e.measureText(h).width>t?l?(s.push(l),l=u):(s.push(u),l=""):l=h}l&&s.push(l)}return s}let jr=null,Kr=null;function dt(i,e){const t=e||nr||"center";if(!(i===jr&&t===Kr)){if(jr=i,Kr=t,Wt.clearRect(0,0,ti.width,ti.height),i){Wt.save(),Wt.fillStyle="#ffffff",Wt.shadowColor="#ffffff";const n=850,r=850,s=16;let o=64,a=[],l=0,c=0;for(;o>=s;){if(l=Math.floor(o*1.35),a=Ev(i,Wt,n,o),c=a.length*l,c<=r){let p=!0;Wt.font=`${o}px ${ba}`;for(const f of a)if(Wt.measureText(f).width>n){p=!1;break}if(p)break}o-=2}Wt.font=`${o}px ${ba}`,Wt.shadowBlur=Math.max(2,Math.floor(o*.15));const u=40,h=ti.width,d=ti.height;let m,g,_;switch(t){case"top-left":m=u,g=u+l/2,_="left";break;case"top-right":m=h-u,g=u+l/2,_="right";break;case"top-center":m=h/2,g=u+l/2,_="center";break;case"bottom-left":m=u,g=d-u-c+l/2,_="left";break;case"bottom-right":m=h-u,g=d-u-c+l/2,_="right";break;case"bottom-center":m=h/2,g=d-u-c+l/2,_="center";break;default:m=h/2,g=d/2-(a.length-1)*l/2,_="center"}Wt.textAlign=_,Wt.textBaseline="middle";for(let p=0;p<a.length;p++){const f=a[p];f&&Wt.fillText(f,m,g+p*l)}Wt.restore()}Mr.needsUpdate=!0}}let ia=null,at=null,ra=null,Pr=null,Ir=null,gi=null;const Ya=()=>{if(!at)try{at=new(window.AudioContext||window.webkitAudioContext),console.log("[Brute Force Audio] Created new AudioContext on user interaction."),$&&qa($)}catch(i){console.error("[Brute Force Audio] Failed to create AudioContext:",i)}at&&at.state==="suspended"&&at.resume().then(()=>console.log("[Brute Force Audio] audioCtx resumed successfully! State:",at.state)).catch(i=>console.error("[Brute Force Audio] Failed to resume audioCtx:",i)),$&&$.dataset.shouldPlayAudio!=="false"&&($.muted&&($.muted=!1,console.log("[Brute Force Audio] activeVideo unmuted!")),$.volume!==1&&($.volume=1),$.paused&&$.play().then(()=>console.log("[Brute Force Audio] Forced activeVideo playback to start!")).catch(e=>console.error("[Brute Force Audio] Forced activeVideo play failed:",e)))};window.addEventListener("click",Ya);window.addEventListener("touchstart",Ya);window.addEventListener("keydown",Ya);function qa(i){try{if(!at){at=new(window.AudioContext||window.webkitAudioContext);const e=()=>{at.state==="suspended"&&at.resume()};window.addEventListener("click",e),window.addEventListener("mousemove",e),window.addEventListener("touchstart",e),window.addEventListener("keydown",e)}ra?console.log("[Web Audio] Reusing existing MediaElementSourceNode connection."):(ra=at.createMediaElementSource(i),Pr=at.createBiquadFilter(),Pr.type="highpass",Pr.frequency.value=180,Ir=at.createBiquadFilter(),Ir.type="lowpass",Ir.frequency.value=4e3,gi=at.createBiquadFilter(),gi.type="peaking",gi.frequency.value=1e3,gi.Q.value=1.2,gi.gain.value=8,ra.connect(Pr),Pr.connect(Ir),Ir.connect(gi),gi.connect(at.destination),console.log("[Web Audio] Filter chain connected and created successfully.")),at.state==="suspended"&&at.resume()}catch(e){console.error("Web Audio API setup failed:",e)}}function fh(i){if(!i)return null;const e=/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/,t=i.match(e);return t&&t[2].length===11?t[2]:null}async function Tv(i){const e=["https://cobalt.projectsegfau.lt","https://cobalt.api.ryder.xyz","https://api.cobalt.tools","https://api.cobalt.download","https://cobalt.moe"],t=["https://api.piped.private.coffee"],n=["https://inv.thepixora.com","https://invidious.flokinet.to","https://invidious.nerdvpn.de","https://invidious.tiekoetter.com","https://inv.nadeko.net","https://yewtu.be"],r=async c=>{const u=new AbortController,h=setTimeout(()=>u.abort(),6e3);try{const d=await fetch(c.endsWith("/")?c:c+"/",{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify({url:`https://www.youtube.com/watch?v=${i}`,videoQuality:"720"}),signal:u.signal});if(clearTimeout(h),!d.ok)throw new Error(`HTTP ${d.status}`);const m=await d.json();if((m.status==="stream"||m.status==="redirect"||m.status==="success")&&m.url)return console.log(`[YouTube Client] Success from Cobalt instance: ${c}`),m.url;throw new Error(`Invalid Cobalt response status: ${m.status}`)}catch(d){throw clearTimeout(h),d}},s=async c=>{const u=new AbortController,h=setTimeout(()=>u.abort(),6e3);try{const d=await fetch(`${c}/streams/${i}`,{signal:u.signal});if(clearTimeout(h),!d.ok)throw new Error(`HTTP ${d.status}`);const m=await d.json();if(!m.videoStreams||m.videoStreams.length===0)throw new Error("No videoStreams");const g=m.videoStreams.find(_=>_.format==="MPEG_4"||_.mimeType.includes("video/mp4"));if(!g||!g.url)throw new Error("No MP4 stream found");return console.log(`[YouTube Client] Success from Piped instance: ${c}`),g.url}catch(d){throw clearTimeout(h),d}},o=async c=>{const u=new AbortController,h=setTimeout(()=>u.abort(),6e3);try{const d=await fetch(`${c}/api/v1/videos/${i}`,{signal:u.signal});if(clearTimeout(h),!d.ok)throw new Error(`HTTP ${d.status}`);const m=await d.json();if(!m.formatStreams||m.formatStreams.length===0)throw new Error("No formatStreams");const g=m.formatStreams.find(p=>p.container==="mp4"||p.type.includes("video/mp4"));if(!g||!g.url)throw new Error("No MP4 stream found");let _=g.url;if(_.includes("local=true")||(_+=_.includes("?")?"&local=true":"?local=true"),_.startsWith("/"))_=c+_;else if(_.startsWith("http")){const p=new URL(_),f=new URL(c);p.host=f.host,p.protocol=f.protocol,p.searchParams.has("local")||p.searchParams.set("local","true"),_=p.toString()}return console.log(`[YouTube Client] Success from Invidious instance: ${c}`),_}catch(d){throw clearTimeout(h),d}},a=c=>new Promise((u,h)=>{let d=[],m=0;c.forEach(g=>{Promise.resolve(g).then(u).catch(_=>{d.push(_),m++,m===c.length&&h(new Error("All client instances failed: "+d.map(p=>p.message).join(", ")))})})}),l=[...e.map(r),...t.map(s),...n.map(o)];try{return await a(l)}catch(c){throw console.error("[YouTube Client] All client-side resolution attempts failed:",c),c}}async function ph(i){try{const e=await fetch(qs(`/api/yt-resolve?id=${i}`));if(!e.ok)throw new Error(`Server returned HTTP ${e.status}`);const t=await e.json();if(!t.url)throw new Error("Server response missing URL");return t.url.startsWith("/api/")?qs(t.url):t.url}catch(e){return console.warn("[YouTube] Server proxy failed. Falling back to client-side Piped/Invidious racing...",e.message),await Tv(i)}}async function Aa(i,e,t){let n=i;if(!i){ia=null,ot&&(ot.destroy(),ot=null),$&&($.pause(),$.removeAttribute("src"),$.load()),At&&(At.dispose(),At=null);return}const r=fh(i);if(r)try{n=await ph(r)}catch(a){console.error("Failed to resolve YouTube video:",a);return}if(n===ia&&$){$.loop=e,$.muted=!t,$.dataset.shouldPlayAudio=!!t;return}ia=n,ot&&(ot.destroy(),ot=null);let s=!1;$||($=document.createElement("video"),$.preload="auto",$.playsInline=!0,$.webkitPlaysInline=!0,$.crossOrigin="anonymous",s=!0),$.loop=e,$.muted=!t,$.dataset.shouldPlayAudio=!!t,$.crossOrigin="anonymous";const o=uh(n);if(o.includes(".m3u8")&&typeof Hls<"u"?Hls.isSupported()?(ot=new Hls({maxBufferLength:8,maxMaxBufferLength:12,enableWorker:!0,lowLatencyMode:!0}),ot.attachMedia($),ot.loadSource(o),ot.on(Hls.Events.MANIFEST_PARSED,()=>{console.log("[HLS.js] Manifest loaded, playing...")}),ot.on(Hls.Events.ERROR,(a,l)=>{if(l.fatal)switch(l.type){case Hls.ErrorTypes.NETWORK_ERROR:console.warn("[HLS.js] Network error, attempting recovery...",l),ot.startLoad();break;case Hls.ErrorTypes.MEDIA_ERROR:console.warn("[HLS.js] Media error, attempting recovery...",l),ot.recoverMediaError();break;default:console.error("[HLS.js] Unrecoverable error",l);break}})):$.canPlayType("application/vnd.apple.mpegurl")&&($.src=o,$.load()):($.src=o,$.load()),s)try{qa($)}catch(a){console.error("Audio filter setup failed:",a)}At||(At=new Ju($),At.colorSpace=Qe,At.minFilter=pt,At.generateMipmaps=!1),$.play().then(()=>{console.log("Preset video play started successfully.")}).catch(a=>{console.log("Preset video autoplay blocked. Retrying with mute...",a),$.muted=!0,$.play().then(()=>{console.log("Preset muted fallback autoplay succeeded!");const l=()=>{$.muted=!t,at&&at.state==="suspended"&&at.resume(),console.log("User interacted. Restored preset audio state."),document.removeEventListener("click",l),document.removeEventListener("keydown",l),document.removeEventListener("touchstart",l)};document.addEventListener("click",l),document.addEventListener("keydown",l),document.addEventListener("touchstart",l)}).catch(l=>{console.error("Preset even muted autoplay failed:",l)})})}function bv(){new nh;const i=document.createElement("canvas");i.width=1,i.height=1;const e=new $r(i);return e.colorSpace=Qe,Qn=null,bi=e,Ys=e,Mn=null,new Promise(t=>{Xt=t,setTimeout(()=>{Xt&&(Xt(),Xt=null)},1800),Xa()})}function ou(i){const e=Math.floor(i/60),t=i%60;if(e!==Ea){Ea=e,Qo=[];const s=Math.max(1,lh),o=Math.max(.1,oh),a=Math.max(o,ah),l=60/s;for(let c=0;c<s;c++){const u=o+Math.random()*(a-o),h=c*l,d=Math.max(0,l-u),m=h+Math.random()*d;Qo.push({start:m,end:m+u})}}let n=!1;for(const s of Qo)if(t>=s.start&&t<=s.end){n=!0;break}return ea+=((n?1:0)-ea)*.12,Math.min(Math.max(ea,0),1)}function Av(i,e,t){if(!i)return;i.uIsVideo&&(i.uIsVideo.value=Ft.mode==="video"?1:0),i.uPowerOff&&(i.uPowerOff.value=Ft.mode==="custom_image"&&!yt?1:0),i.uScaleX&&i.uScaleY&&(i.uScaleX.value=1,i.uScaleY.value=1),i.uTextureText.value=Mr,typeof i.uFilterMode<"u"&&(i.uFilterMode.value=In),i.uFilterColor&&i.uFilterColor.value.set(Yr);const n=()=>{ft?dt(ft):ta>0?(ta-=t,dt(Ns("283f4b3c3c"),"top-left")):dt("")};if(qn==="transition_in"){if(an+=t,xt=!0,Xn(),dt(""),i.uTexture.value=Ut,i.uChildVisibility.value=0,an>=su){if(qn="active",an=0,xt=!1,mi.clearRect(0,0,gn.width,gn.height),Mn&&Mn.image){mi.save(),mi.filter="invert(1)";const s=720,o=s*(769/612),a=(gn.width-s)/2,l=(gn.height-o)/2;mi.drawImage(Mn.image,a,l,s,o),mi.restore()}ei.needsUpdate=!0}return}if(qn==="active"){an+=t,xt=!1,ft?dt(ft,nr):an<=2?dt(Ns("283f4b3a3f342f2f"),"top-left"):dt(""),i.uScaleX&&(i.uScaleX.value=1.936872),i.uTexture.value=ei,i.uChildVisibility.value=0,an>=Ta&&(qn="transition_out",an=0,xt=!0);return}if(qn==="transition_out"){an+=t,xt=!0,Xn(),dt(""),i.uTexture.value=Ut,i.uChildVisibility.value=0,an>=su&&(qn="idle",an=0,xt=!1,ta=2);return}if(cn==="static"){xt=!1,Xn(),i.uTexture.value=Ut,i.uChildVisibility.value=0,dt(ft||"");return}if(cn==="custom_image"&&yt){xt=!1,i.uTexture.value=yt,i.uChildVisibility.value=0,dt(ft||"");return}if(Ft.mode==="static"){xt=!1,Xn(),i.uTexture.value=Ut,dt(ft||""),i.uChildVisibility.value=0;return}if(Ft.mode==="custom_image"){xt=!1,yt?i.uTexture.value=yt:(mi.fillStyle="#000000",mi.fillRect(0,0,gn.width,gn.height),ei.needsUpdate=!0,i.uTexture.value=ei),dt(ft||""),i.uChildVisibility.value=0;return}if(Ft.mode==="default"){xt=!1,n(),yt||Qn?(i.uScaleX&&(i.uScaleX.value=1.936872),i.uTexture.value=yt||Qn,i.uTextureChild.value=bi,i.uChildVisibility.value=ou(e)):(Xn(),i.uTexture.value=Ut,ft||dt("SEÑAL PENDIENTE"),i.uChildVisibility.value=0);return}if(Ft.mode==="video"){xt=!1,At&&$&&($.readyState>=2||$.currentTime>0)?($.readyState>=2&&(At.needsUpdate=!0),i.uTexture.value=At):(Xn(),i.uTexture.value=Ut),dt(ft||""),i.uChildVisibility.value=0;return}if(Ft.mode==="slideshow"){const s=Ft.slideshow.images;if(!s||s.length===0){xt=!1,Xn(),i.uTexture.value=Ut,ft||dt("SEÑAL PENDIENTE"),i.uChildVisibility.value=0;return}if(s.length<=1){xt=!1;const o=s[0],a=eu[o]||Qn;n(),i.uTexture.value=a,i.uChildVisibility.value=0;return}if(Lr+=t,xt)Xn(),dt(""),i.uTexture.value=Ut,i.uChildVisibility.value=0,Lr>=Ft.slideshow.transitionDuration&&(Jo=(Jo+1)%s.length,Lr=0,xt=!1);else{const o=s[Jo],a=eu[o]||Qn;n(),i.uTexture.value=a,o===Ns("4407340345130a03")?(i.uScaleX&&(i.uScaleX.value=1.936872),i.uTextureChild.value=bi,i.uChildVisibility.value=ou(e)):i.uChildVisibility.value=0,Lr>=Ft.slideshow.slideDuration&&(Lr=0,xt=!0)}}const r=i.uTexture.value;if(r&&r.image){const s=r.image;let o=!0;if(s instanceof HTMLVideoElement&&(s.readyState<2||s.paused)&&(o=!1),o)try{tu.drawImage(s,0,0,1,1);const a=tu.getImageData(0,0,1,1).data;let l=a[0]/255,c=a[1]/255,u=a[2]/255;const h=.299*l+.587*c+.114*u;if(In===1)l=h*.22*1.35,c=h*1*1.35,u=h*.08*1.35;else if(In===2)l=h*1*1.35,c=h*.15*1.35,u=h*.15*1.35;else if(In===3)l=h*1*1.35,c=h*.82*1.35,u=0;else if(In===4){const g=e*.15%1,_=new we().setHSL(g,1,.5);l=h*_.r*1.5,c=h*_.g*1.5,u=h*_.b*1.5}else if(In===5){const g=new we(Yr);l=h*g.r*1.35,c=h*g.g*1.35,u=h*g.b*1.35}else l=l*.68,c=c*.73,u=u*.9;const d=.299*l+.587*c+.114*u;let m=1;d>.82&&(m=.82/d),Ur.setRGB(l*m,c*m,u*m)}catch{Ur.setHex(11196671)}else Ur.setHex(11196671)}else Ur.setHex(11196671)}function wv(){Mt&&(clearTimeout(Mt),Mt=null),Qt=!1,$&&($.pause(),$.src="",$.load()),Yt&&Yt.close(),yt&&yt.dispose(),ei.dispose(),Ut.dispose(),Mr.dispose(),At&&At.dispose()}const ja=()=>{Ft.mode==="video"&&$&&$.paused&&$.play().catch(()=>{})};window.addEventListener("click",ja);window.addEventListener("pointerdown",ja);window.addEventListener("touchstart",ja);/*! REJECTED FALSE ICONS (5/7) */const au=i=>{const e=new fn;let t=!1;return i.traverse(n=>{if(n.isMesh){const r=new fn().setFromObject(n);t?e.union(r):(e.copy(r),t=!0)}}),e};function Rv(i,e,t,n){const r=new O0,s=new Promise((o,a)=>{r.load("/crt-tv.glb",l=>{Dr("model",50),o(l)},l=>{let c=l.total;(!c||c===0)&&(c=4862760);const u=Math.min(l.loaded/c,1);Dr("model",u*50)},l=>{console.error("Error loading TV GLTF:",l),a(l)})});return Dr("texture1",10),Dr("texture2",10),s.then(o=>bv().then(()=>o)).then(o=>{const a=new $n;i.add(a);const l=o.scene;a.add(l),l.position.set(0,0,0),l.rotation.set(0,0,0),l.scale.set(1,1,1),l.updateMatrixWorld(!0);const c=2.4,h=au(l).getSize(new P),d=c/h.y;l.scale.setScalar(d),l.updateMatrixWorld(!0);const m=au(l),g=m.getCenter(new P);l.position.x=-g.x,l.position.y=-m.min.y,l.position.z=-g.z,l.rotation.y=Math.PI,l.updateMatrixWorld(!0),l.traverse(Z=>{Z.isMesh&&(Z.castShadow=!0,Z.receiveShadow=!0,Z.material&&(Z.material.roughness=Math.max(Z.material.roughness,.45),Z.material.metalness=Math.min(Z.material.metalness,.8)))});const _=new mr(1.75,1.54,16,16),p=new Fn({vertexShader:gv,fragmentShader:_v,uniforms:{uTime:{value:0},uTexture:{value:null},uTextureChild:{value:null},uTextureText:{value:null},uChildVisibility:{value:0},uMagneticCenter:{value:new be(-10,-10)},uMagneticTime:{value:0},uMagneticIntensity:{value:0},uMagneticBuildup:{value:0},uMagneticVelocity:{value:new be(0,0)},uFilterMode:{value:0},uFilterColor:{value:new we("#ffffff")},uScaleX:{value:1},uScaleY:{value:1},uIsVideo:{value:0},uPowerOff:{value:0}}}),f=new Ht(_,p),E=m.max.z-g.z;f.position.set(0,1.3,E+2.01),a.add(f);const M=new Ws(11196671,12,9,Math.PI/2.2,.95,1.1);M.position.set(0,1.3,E+2.05);const b=new nt;b.position.set(0,0,E+5.5),a.add(b),M.target=b,a.add(M);const C=new Ws(16733457,14,3.2,Math.PI/2.5,.9,2);C.position.set(0,1.3,E+.3);const R=new nt;R.position.set(0,1.3,E-.5),a.add(R),C.target=R,a.add(C),a.position.set(0,0,12),e.target.set(0,1.3,12),n.position.set(0,1.3,12),t.target=n;let A=!1,z=0;const x=3.5,T=.22;let D=0,W=0,J=0,I=0,O=0,V=0;return{tvGroup:a,crtScreen:f,crtLight:M,internalCabinetLight:C,update:(Z,B)=>{if(p.uniforms.uTime.value=Z,V=Math.max(V-B*5,0),I*=Math.max(1-B*6,0),O*=Math.max(1-B*6,0),A){z=Math.min(z+B,x);const X=z/x;p.uniforms.uMagneticIntensity.value=Math.min(.15+X*.85+V*.4,1.3),p.uniforms.uMagneticBuildup.value=X,p.uniforms.uMagneticTime.value+=B,p.uniforms.uMagneticVelocity.value.set(I,O);const ae=Math.min(X*.032,.032);ae>.001?a.position.set((Math.random()-.5)*ae,(Math.random()-.5)*ae,12+(Math.random()-.5)*ae):a.position.set(0,0,12)}else if(W>0)if(J+=B,p.uniforms.uMagneticTime.value+=B,p.uniforms.uMagneticVelocity.value.set(0,0),J<0){const X=(J+T)/T,ae=Math.sin(X*Math.PI)*.55,de=Math.min(D+ae,1.4);p.uniforms.uMagneticIntensity.value=de,p.uniforms.uMagneticBuildup.value=de,a.position.set(0,0,12)}else{const X=Math.min(J/W,1),ae=1-X*X,de=D*ae;if(de<=.001||X>=1)p.uniforms.uMagneticIntensity.value=0,p.uniforms.uMagneticBuildup.value=0,W=0,a.position.set(0,0,12);else{p.uniforms.uMagneticIntensity.value=de,p.uniforms.uMagneticBuildup.value=de;const me=de*.032;a.position.set((Math.random()-.5)*me,(Math.random()-.5)*me,12+(Math.random()-.5)*me)}}else p.uniforms.uMagneticVelocity.value.set(0,0),xt?a.position.set((Math.random()-.5)*.012,(Math.random()-.5)*.012,12+(Math.random()-.5)*.012):a.position.set(0,0,12);Av(p.uniforms,Z,B),M.color.lerp(Ur,.12),M.intensity=(1.4+Math.sin(Z*35)*.18+Math.sin(Z*7)*.06)*16,C.intensity=10+Math.sin(Z*22)*.8+Math.sin(Z*4)*.25,l.position.set(-g.x,-m.min.y,-g.z)},destroy:()=>{_.dispose(),p.dispose(),wv(),i.remove(a)},startMagneticHold:Z=>{A=!0,z=p.uniforms.uMagneticBuildup.value*x,W=0,J=0,p.uniforms.uMagneticCenter.value.copy(Z)},stopMagneticHold:()=>{A&&(A=!1,D=p.uniforms.uMagneticBuildup.value,W=1.5+D*9,J=-T)},setVelocityBoost:(Z,B)=>{const X=Math.sqrt(Z*Z+B*B);V=Math.min(X*12,.6),I=Z*8,O=B*8}}})}/*! EL Psy Koongro (6/7) */function Cv(i,e,t){let n=-10,r=!1,s=!0,o=-10,a=0;const l=i.position.distanceTo(e.target);let c=0,u=Math.PI/2-.15,h=l,d=0,m=Math.PI/2-.15,g=l,_=1;const p=5.5,f=z=>{n=z},E=()=>{r=!0,s=!0,a=0},M=()=>{r&&(s=!0,a=0)},b=()=>{r=!1,s=!0,a=0},C=()=>{s=!0,a=0};return t.addEventListener("pointerdown",E),t.addEventListener("pointermove",M),t.addEventListener("pointerup",b),t.addEventListener("wheel",C),{update:(z,x)=>{r&&f(z);const T=z-n;if(!r&&T>5){const I=i.position.x,O=i.position.y-1.3,V=i.position.z-12,j=Math.sqrt(I*I+O*O+V*V),Y=Math.acos(O/j),K=Math.atan2(I,V);z-o>5.5&&(s?(c=K,u=Y,h=j,s=!1):(c=d,u=m,h=g),d=(Math.random()-.5)*.28,m=Math.PI/2-.15+(Math.random()-.5)*.06,window.innerWidth<768?g=6.8+Math.random()*.7:g=5.2+Math.random()*.5,_=0,o=z),_=Math.min(_+x/p,1);const q=_,re=q*q*q*(q*(q*6-15)+10),Z=Zn.lerp(c,d,re),B=Zn.lerp(u,m,re),X=Zn.lerp(h,g,re);a=Zn.lerp(a,1,.015);const ae=Z+Math.sin(z*.15)*.02*a,de=B+Math.cos(z*.2)*.015*a,me=X+Math.sin(z*.1)*.08*a;i.position.x=me*Math.sin(de)*Math.sin(ae),i.position.y=1.3+me*Math.cos(de),i.position.z=12+me*Math.sin(de)*Math.cos(ae)}e.update(),i.position.y<.2&&(i.position.y=.2),e.target.y<0&&(e.target.y=0)},destroy:()=>{t.removeEventListener("pointerdown",E),t.removeEventListener("pointermove",M),t.removeEventListener("pointerup",b),t.removeEventListener("wheel",C)}}}const ai=document.getElementById("webgl-canvas"),Lv=document.getElementById("app-container"),{scene:io,camera:ro,renderer:sa,controls:so}=L0(Lv,ai);no("scene");const oa=D0();no("overlay");const wa=U0(io);no("lights");const Pv=N0(io);no("particles");const Iv=Cv(ro,so,ai);let Ra=null,si=null;Rv(io,so,wa.spotlight,wa.spotTarget).then(i=>{Ra=i.update,si=i,window.tvGroup=i.tvGroup,window.crtScreen=i.crtScreen,window.crtLight=i.crtLight,window.internalCabinetLight=i.internalCabinetLight,Qc()}).catch(i=>{console.error("TV Model failed to load:",i),Qc()});const zr=new w0,rr=new be;let Gr=null,Qi=null,Ca={x:0,y:0},Ka=!1;const Dv=950,Uv=6,lu=new dn,cu=new P,uu=new P,aa=new P,hu=new Pn,du=new be(-1,-1),Nv=i=>{if(!window.crtScreen||!si)return;const e=ai.getBoundingClientRect();rr.x=(i.clientX-e.left)/e.width*2-1,rr.y=-((i.clientY-e.top)/e.height)*2+1,zr.setFromCamera(rr,ro);const t=window.crtScreen.material.uniforms.uMagneticCenter.value,n=t.x,r=t.y,s=zr.intersectObject(window.crtScreen);s.length>0&&s[0].uv?t.copy(s[0].uv):(window.crtScreen.updateWorldMatrix(!0,!1),window.crtScreen.getWorldQuaternion(lu),window.crtScreen.getWorldPosition(cu),hu.setFromNormalAndCoplanarPoint(new P(0,0,1).applyQuaternion(lu),cu),zr.ray.intersectPlane(hu,uu)&&(window.crtScreen.worldToLocal(aa.copy(uu)),t.set(Zn.clamp(aa.x/1.75+.5,.02,.98),Zn.clamp(aa.y/1.54+.5,.02,.98)))),du.x>=0&&si.setVelocityBoost&&si.setVelocityBoost(t.x-n,t.y-r),du.set(t.x,t.y)},mh=()=>{Gr&&(clearTimeout(Gr),Gr=null),Qi=null},oo=()=>{mh(),Ka=!1,so.enabled=!0,si&&si.stopMagneticHold()};ai.addEventListener("pointerdown",i=>{const e=ai.getBoundingClientRect();if(Ca={x:i.clientX,y:i.clientY},rr.x=(i.clientX-e.left)/e.width*2-1,rr.y=-((i.clientY-e.top)/e.height)*2+1,zr.setFromCamera(rr,ro),window.crtScreen&&si){const t=zr.intersectObject(window.crtScreen);t.length>0&&t[0].uv&&(Qi=t[0].uv.clone(),Gr=setTimeout(()=>{Qi&&(so.enabled=!1,Ka=!0,si.startMagneticHold(Qi),Qi=null),Gr=null},Dv))}});ai.addEventListener("pointermove",i=>{if(Qi&&i.buttons>0){const e=i.clientX-Ca.x,t=i.clientY-Ca.y;Math.sqrt(e*e+t*t)>Uv&&mh()}Ka&&Nv(i)});ai.addEventListener("pointerup",oo);ai.addEventListener("pointercancel",oo);document.addEventListener("visibilitychange",()=>{document.hidden&&oo()});window.addEventListener("blur",oo);const fu=new _0,gh=()=>{requestAnimationFrame(gh);const i=Math.min(fu.getDelta(),.1),e=fu.getElapsedTime();oa.update(e),wa.update(e),Pv.update(e),Ra&&Ra(e,i),Iv.update(e,i),sa.clear(),sa.render(io,ro),sa.render(oa.overlayScene,oa.overlayCamera)};gh();
