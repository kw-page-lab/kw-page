...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ei,depthTest:!1,depthWrite:!1})}function ic(){return new On({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Oo(),fragmentShader:`
		...
		`,blending:ei,depthTest:!1,depthWrite:!1})}function rc(){return new On({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Oo(),fragmentShader:`
...
`].filter($i).join(`
`)),a=go(a),a=fc(a,t),a=pc(a,t),o=go(o),o=fc(o,t),o=pc(o,t),a=mc(a),o=mc(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(M=`#version 300 es
