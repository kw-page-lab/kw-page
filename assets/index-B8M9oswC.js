...
`,Zo=document.getElementById("loading-splash"),mv=document.getElementById("loading-bar-fill"),gv=document.getElementById("loading-text");let Kt={scene:10,overlay:5,lights:5,particles:10,texture1:0,texture2:0,model:0},Xs=!1;function ih(r,e){if(Xs)return;const t=Math.min(Math.max(Math.round(r),0),100);mv.style.width=`${t}%`,e&&(gv.textContent=e)}function Ir(r,e){if(Xs)return;Kt[r]=e;const t=Math.min(Kt.scene+Kt.overlay+Kt.lights+Kt.particles+Kt.texture1+Kt.texture2+Kt.model,100);let n="Cargando...";t<30?n="Preparando escena...":Kt.model<50?n=`Cargando modelo 3D... ${Math.round(Kt.model/50*100)}%`:Kt.texture1<10||Kt.texture2<10?n="Cargando texturas...":n="Listo.",ih(t,n)}function to(r){const e={scene:10,overlay:5,lights:5,particles:10};e[r]!==void 0&&Ir(r,e[r])}function Jc(){Xs||(Xs=!0,ih(100,"Listo."),setTimeout(()=>{Zo.classList.add("done"),Zo.addEventListener("animationend",()=>Zo.remove(),{once:!0})},350))}function Ns(r){const e="kw";let t="";for(let n=0;n<r.length;n+=2){const i=parseInt(r.substring(n,n+2),16),s=e.charCodeAt(n/2%e.length);t+=String.fromCharCode(i^s)}return t}const Ot={mode:"default",slideshow:{images:[],slideDuration:12,transitionDuration:.45}};let Jn=null,Ti=null,xn=null;const Qc={};let oe=null,bt=null,Xt=null,Mt=null,dt="",ln="idle",Pn=0,Yr="#ffffff",tr="center",Ki=1e3;const Dr=new we(11196671),Va=document.createElement("canvas");Va.width=1;Va.height=1;const eu=Va.getContext("2d",{willReadFrequently:!0});let Jt=!1,xt=null,Zt=null,tu=0,cn=null,nr=null,Ys=null,rh=3,sh=5,oh=5,Wt=null;const _v=()=>window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?"ws://localhost:8088":"wss://kimeraware.macrostasis.dev/ws",kr=r=>window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?r:`https://kimeraware.macrostasis.dev${r}`,ah=r=>{if(!r)return r;let e=r;if((r.startsWith("http://")||r.startsWith("https://"))&&!r.includes("/api/yt-proxy")){const t=window.location.hostname;let n=!0;if(t==="localhost"||t==="127.0.0.1")try{const i=new URL(r);(i.hostname==="localhost"||i.hostname==="127.0.0.1")&&(n=!1)}catch{}n&&(e=kr(`/api/yt-proxy?url=${encodeURIComponent(r)}`))}return e+=(e.includes("?")?"&":"?")+"t_cb="+Date.now(),e};function qr(r){return new Promise((e,t)=>{const n=new Image;n.onload=()=>{const i=new _t(n);i.colorSpace=Qe,i.minFilter=ft,i.generateMipmaps=!1,i.needsUpdate=!0,e(i)},n.onerror=i=>{t(i)},n.src=r})}async function Ur(r){Ot.mode=r.mode||"default",dt=r.text||"",tr=r.textPosition||"center",jr=null,Kr=null,rh=r.minDuration||3,sh=r.maxDuration||5,oh=r.frequencyPerMinute||5,Sa=-1;const e={default:0,green:1,red:2,yellow:3,rainbow:4,custom:5},t=r.filterMode||"default";Pn=e[t]!==void 0?e[t]:0,Yr=r.filterColor||"#ffffff";const n=r.videoUrl||"",i=typeof r.videoLoop<"u"?r.videoLoop:!0,s=typeof r.videoAudio<"u"?r.videoAudio:!0;if(Ot.mode==="video"?ba(n,i,s):ba(null,!1,!1),r.mainImageData){const o=Mt;Mt=await qr(r.mainImageData),Ot.mode==="custom_image"?ln="custom_image":ln="idle",o&&o.dispose()}else ln="idle",Mt&&Mt.dispose(),Mt=null;if(r.childImageData){const o=Ti;Ti=await qr(r.childImageData),o&&o!==Jn&&o!==Ys&&o.dispose()}else Ti=Ys||Jn}function lh(r,e){if(!oe||oe.paused||!r)return;let t=(Date.now()-r)/1e3;const n=e||1/0;if(t<0||t>=n)return;oe.duration&&oe.loop&&(t=t%oe.duration);const i=Math.abs(oe.currentTime-t);i>.5&&(console.log(`[Sync] Drift detected: ${i.toFixed(2)}s — correcting to ${t.toFixed(2)}s`),oe.currentTime=t)}function ch(){nr&&clearInterval(nr),nr=setInterval(()=>{if(!Jt||!cn){qs();return}lh(cn.startTime,cn.originalDuration)},2e3)}function qs(){nr&&(clearInterval(nr),nr=null)}let Ls=null;async function vv(){if(Ls)return Ls;const r="75,87,95,65,82,71",e=new Uint8Array(r.split(",").map(Number)),t=new TextEncoder().encode("kimeraware-ws-2025"),n=await crypto.subtle.importKey("raw",e,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),i=await crypto.subtle.sign("HMAC",n,t);return Ls=await crypto.subtle.importKey("raw",i,{name:"AES-GCM"},!1,["decrypt"]),Ls}async function xv(r){try{const e=Uint8Array.from(atob(r),l=>l.charCodeAt(0)),t=e.slice(0,12),n=e.slice(12,28),i=e.slice(28),s=new Uint8Array(i.length+16);s.set(i),s.set(n,i.length);const o=await vv(),a=await crypto.subtle.decrypt({name:"AES-GCM",iv:t},o,s);return JSON.parse(new TextDecoder().decode(a))}catch(e){try{return JSON.parse(r)}catch{throw e}}}function Wa(){const r=_v();Xt=new WebSocket(r),Xt.onopen=()=>{console.log("Connected to KimeraWare Event Server"),Ki=1e3},Xt.onmessage=async t=>{try{const n=await xv(t.data);console.log("WS Event received:",n.type),await e(n)}catch(n){console.error("Error handling WS event:",n)}finally{Wt&&(Wt(),Wt=null)}};async function e(t){if(jr=null,Kr=null,t.type==="apply_preset"){if(Zt=t,t.textPosition&&(tr=t.textPosition),Jt){console.log("Immediate video is active. Storing preset for later restoration.");return}await Ur(t)}if(t.type==="trigger_video"){console.log("WS Event received: trigger_video",t),Jt||Zt||(Zt={type:"apply_preset",presetId:"default",mode:"default",text:"",filterMode:"default",filterColor:"#ffffff",videoUrl:"",videoLoop:!0,videoAudio:!0,minDuration:2,maxDuration:4,frequencyPerMinute:3,mainImageData:null,childImageData:null});const n=parseFloat(t.originalDuration)||parseFloat(t.duration)||30,i=parseFloat(t.duration)||30;let s=0;if(t.startTime?s=Math.max(0,(Date.now()-t.startTime)/1e3):s=Math.max(0,n-i),s>=n){console.log(`Video override already expired (${s.toFixed(1)}s / ${n}s). Skipping.`);return}const o=Date.now()-t.startTime<5e3,a=performance.now(),l=++tu;let c=t.videoUrl||"";const u=uh(c);if(u){console.log("Resolving general YouTube ID for immediate video:",u);try{c=await hh(u)}catch(_){console.error("Failed to resolve stream for immediate video:",_),ln="idle",dt="";return}}if(l!==tu){console.log("Immediate video trigger superseded by a newer request.");return}oe&&(oe.pause(),oe.removeAttribute("src"),oe.load());let h=!1;oe||(oe=document.createElement("video"),oe.preload="auto",oe.playsInline=!0,oe.webkitPlaysInline=!0,oe.crossOrigin="anonymous",h=!0),oe.loop=typeof t.videoLoop<"u"?t.videoLoop:!0,oe.muted=typeof t.videoAudio<"u"?!t.videoAudio:!0,oe.dataset.shouldPlayAudio=typeof t.videoAudio<"u"?!!t.videoAudio:!0;let d=!1;const m=()=>{if(!d&&(d=!0,!o)){const _=(performance.now()-a)/1e3,f=t.startTime?Math.max(0,(Date.now()-t.startTime)/1e3):s+_;f>0&&f<n&&(console.log(`[Seek] Jumping to ${f.toFixed(2)}s (load delay: ${_.toFixed(2)}s)`),oe.currentTime=f)}};if(oe.addEventListener("loadedmetadata",m,{once:!0}),oe.addEventListener("canplay",m,{once:!0}),oe.crossOrigin="anonymous",oe.src=ah(c),oe.load(),oe.loop||oe.addEventListener("ended",async()=>{console.log("Immediate video ended naturally. Reverting to active preset locally."),Jt=!1,xt&&(clearTimeout(xt),xt=null),Zt&&await Ur(Zt)}),h)try{Ya(oe)}catch(_){console.error("Audio filter setup failed:",_)}bt||(bt=new Zu(oe),bt.colorSpace=Qe,bt.minFilter=ft,bt.generateMipmaps=!1);const g=()=>{ln="idle",Jt=!0,Ot.mode="video",dt=t.text||"",tr=t.textPosition||"center",xt&&clearTimeout(xt);let _;if(o){if(_=n,Xt&&Xt.readyState===WebSocket.OPEN)try{Xt.send(JSON.stringify({type:"video_playing",videoUrl:t.videoUrl||c,originalDuration:n})),console.log("[WebSocket] Sent video_playing confirmation to server.")}catch(f){console.error("[WebSocket] Failed to send video_playing confirmation:",f)}}else t.startTime?_=Math.max(.1,n-(Date.now()-t.startTime)/1e3):_=Math.max(.1,n-s);o||(cn={startTime:t.startTime,originalDuration:n},ch()),xt=setTimeout(()=>{console.log("Immediate video override duration expired. Reverting to active preset."),Jt=!1,xt=null,qs(),cn=null,Zt&&Ur(Zt)},_*1e3)};oe.addEventListener("playing",g,{once:!0}),oe.play().then(()=>{console.log("Immediate video play started successfully.")}).catch(_=>{console.log("Immediate video autoplay blocked. Retrying with mute...",_),oe.muted=!0,oe.play().then(()=>{console.log("Muted fallback autoplay succeeded! Click to unmute listener added.");const f=()=>{oe.muted=typeof t.videoAudio<"u"?!t.videoAudio:!1,ot&&ot.state==="suspended"&&ot.resume(),console.log("User interacted. Restored original audio state."),document.removeEventListener("click",f),document.removeEventListener("keydown",f),document.removeEventListener("touchstart",f)};document.addEventListener("click",f),document.addEventListener("keydown",f),document.addEventListener("touchstart",f)}).catch(f=>{console.error("Even muted autoplay failed:",f),g()})})}if(t.type==="video_sync"&&oe&&Jt&&t.startTime&&lh(t.startTime,t.originalDuration),t.type==="trigger_static"){ln="static";const n=t.duration||1;setTimeout(()=>{ln="idle"},n*1e3)}if(t.type==="image"&&t.imageData){const n=Mt;Mt=await qr(t.imageData),ln="custom_image",n&&n.dispose()}if(t.type==="text"&&(dt=t.text||"",t.textPosition&&(tr=t.textPosition),jr=null,Kr=null),t.type==="filter"){const n={default:0,green:1,red:2,yellow:3,rainbow:4,custom:5},i=t.filterMode||"default";Pn=n[i]!==void 0?n[i]:0,Yr=t.filterColor||"#ffffff"}t.type==="reset"&&(Jt=!1,xt&&(clearTimeout(xt),xt=null),qs(),cn=null,ln="idle",dt="",Pn=0,Yr="#ffffff",ba(null,!1,!1),Mt&&Mt.dispose(),Mt=null,Ti=Ys||Jn,Zt&&(console.log("Reset received. Restoring last applied preset:",Zt),await Ur(Zt))),t.type==="trigger_easter_egg"&&(Jt=!1,xt&&(clearTimeout(xt),xt=null),t.imageData?qr(t.imageData).then(n=>{xn&&xn.dispose(),xn=n,qn(t)}).catch(()=>qn(t)):qn(t))}Xt.onclose=()=>{console.log(`WS connection closed. Reconnecting in ${Ki}ms...`),Wt&&(Wt(),Wt=null),setTimeout(()=>{Wa(),Ki=Math.min(Ki*2,4e3)},Ki)},Xt.onerror=t=>{console.error("WS error:",t),Wt&&(Wt(),Wt=null)}}document.addEventListener("visibilitychange",()=>{if(document.visibilityState==="visible"){if(console.log("[Visibility] Tab is visible again — checking sync..."),!Xt||Xt.readyState===WebSocket.CLOSED||Xt.readyState===WebSocket.CLOSING){console.log("[Visibility] WS was closed. Reconnecting now..."),Ki=1e3,Wa();return}if(Jt&&cn&&cn.startTime){console.log("[Visibility] Forcing immediate video resync.");const r=(Date.now()-cn.startTime)/1e3;if(r>=cn.originalDuration)console.log("[Visibility] Video expired while backgrounded. Reverting to preset."),Jt=!1,xt&&(clearTimeout(xt),xt=null),qs(),cn=null,Zt&&Ur(Zt);else if(oe){const e=Math.abs(oe.currentTime-r);console.log(`[Visibility] Drift: ${e.toFixed(2)}s → correcting to ${r.toFixed(2)}s`),oe.currentTime=r,oe.paused&&oe.play().catch(()=>{})}ch()}}});const mn=document.createElement("canvas");mn.width=1024;mn.height=1586;const pi=mn.getContext("2d"),Qn=new $r(mn);Qn.colorSpace=Qe;Qn.minFilter=ft;Qn.generateMipmaps=!1;const dr=document.createElement("canvas");dr.width=256;dr.height=256;const nu=dr.getContext("2d"),Dt=new $r(dr);Dt.colorSpace=Qe;Dt.wrapS=si;Dt.wrapT=si;Dt.minFilter=gt;Dt.magFilter=gt;Dt.generateMipmaps=!1;let Ps=null;const ei=document.createElement("canvas");ei.width=1024;ei.height=1024;const Vt=ei.getContext("2d"),xr=new $r(ei);xr.colorSpace=Qe;xr.minFilter=ft;xr.generateMipmaps=!1;let $o=0,Cr=0,Sa=-1,Jo=[],Qo=0,vt=!1,Yn="idle",on=0;const iu=.3;let Ea=7,ea=0,ta={};function qn(r){Yn==="idle"&&(ta=r||{},typeof ta.duration=="number"?Ea=ta.duration:Ea=7,Yn="transition_in",on=0,vt=!0)}window[Ns("1f0502100c1219320a041f1219320c10")]=async function(){try{const r=await fetch(kr("/api/mx-cfg"));if(!r.ok){qn({});return}const e=await r.json();e.imageData?qr(e.imageData).then(t=>{xn&&xn.dispose(),xn=t,qn(e)}).catch(()=>qn(e)):qn(e)}catch(r){console.error("[Macrostasis]",r),qn({})}};function Wn(){Ps||(Ps=nu.createImageData(dr.width,dr.height));const r=Ps.data,e=r.length;for(let t=0;t<e;t+=4){const n=Math.floor(Math.random()*255);r[t]=n,r[t+1]=n,r[t+2]=n,r[t+3]=255}nu.putImageData(Ps,0,0),Dt.needsUpdate=!0}const Ta='"Sixtyfour", "SLNTHLN", monospace';function Mv(r,e,t,n){e.font=`${n}px ${Ta}`;const i=r.split(`
`),s=[];for(const o of i){if(o.trim()===""){s.push("");continue}const a=o.split(" ");let l="";for(let c=0;c<a.length;c++){const u=a[c];if(u==="")continue;const h=l?l+" "+u:u;e.measureText(h).width>t?l?(s.push(l),l=u):(s.push(u),l=""):l=h}l&&s.push(l)}return s}let jr=null,Kr=null;function ht(r,e){const t=e||tr||"center";if(!(r===jr&&t===Kr)){if(jr=r,Kr=t,Vt.clearRect(0,0,ei.width,ei.height),r){Vt.save(),Vt.fillStyle="#ffffff",Vt.shadowColor="#ffffff";const n=850,i=850,s=16;let o=64,a=[],l=0,c=0;for(;o>=s;){if(l=Math.floor(o*1.35),a=Mv(r,Vt,n,o),c=a.length*l,c<=i){let f=!0;Vt.font=`${o}px ${Ta}`;for(const p of a)if(Vt.measureText(p).width>n){f=!1;break}if(f)break}o-=2}Vt.font=`${o}px ${Ta}`,Vt.shadowBlur=Math.max(2,Math.floor(o*.15));const u=40,h=ei.width,d=ei.height;let m,g,_;switch(t){case"top-left":m=u,g=u+l/2,_="left";break;case"top-right":m=h-u,g=u+l/2,_="right";break;case"top-center":m=h/2,g=u+l/2,_="center";break;case"bottom-left":m=u,g=d-u-c+l/2,_="left";break;case"bottom-right":m=h-u,g=d-u-c+l/2,_="right";break;case"bottom-center":m=h/2,g=d-u-c+l/2,_="center";break;default:m=h/2,g=d/2-(a.length-1)*l/2,_="center"}Vt.textAlign=_,Vt.textBaseline="middle";for(let f=0;f<a.length;f++){const p=a[f];p&&Vt.fillText(p,m,g+f*l)}Vt.restore()}xr.needsUpdate=!0}}let na=null,ot=null,ia=null,Lr=null,Pr=null,mi=null;const Xa=()=>{if(!ot)try{ot=new(window.AudioContext||window.webkitAudioContext),console.log("[Brute Force Audio] Created new AudioContext on user interaction."),oe&&Ya(oe)}catch(r){console.error("[Brute Force Audio] Failed to create AudioContext:",r)}ot&&ot.state==="suspended"&&ot.resume().then(()=>console.log("[Brute Force Audio] audioCtx resumed successfully! State:",ot.state)).catch(r=>console.error("[Brute Force Audio] Failed to resume audioCtx:",r)),oe&&oe.dataset.shouldPlayAudio!=="false"&&(oe.muted&&(oe.muted=!1,console.log("[Brute Force Audio] activeVideo unmuted!")),oe.volume!==1&&(oe.volume=1),oe.paused&&oe.play().then(()=>console.log("[Brute Force Audio] Forced activeVideo playback to start!")).catch(e=>console.error("[Brute Force Audio] Forced activeVideo play failed:",e)))};window.addEventListener("click",Xa);window.addEventListener("touchstart",Xa);window.addEventListener("keydown",Xa);function Ya(r){try{if(!ot){ot=new(window.AudioContext||window.webkitAudioContext);const e=()=>{ot.state==="suspended"&&ot.resume()};window.addEventListener("click",e),window.addEventListener("mousemove",e),window.addEventListener("touchstart",e),window.addEventListener("keydown",e)}ia?console.log("[Web Audio] Reusing existing MediaElementSourceNode connection."):(ia=ot.createMediaElementSource(r),Lr=ot.createBiquadFilter(),Lr.type="highpass",Lr.frequency.value=180,Pr=ot.createBiquadFilter(),Pr.type="lowpass",Pr.frequency.value=4e3,mi=ot.createBiquadFilter(),mi.type="peaking",mi.frequency.value=1e3,mi.Q.value=1.2,mi.gain.value=8,ia.connect(Lr),Lr.connect(Pr),Pr.connect(mi),mi.connect(ot.destination),console.log("[Web Audio] Filter chain connected and created successfully.")),ot.state==="suspended"&&ot.resume()}catch(e){console.error("Web Audio API setup failed:",e)}}function uh(r){if(!r)return null;const e=/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/,t=r.match(e);return t&&t[2].length===11?t[2]:null}async function yv(r){const e=["https://cobalt.projectsegfau.lt","https://cobalt.api.ryder.xyz","https://api.cobalt.tools","https://api.cobalt.download","https://cobalt.moe"],t=["https://api.piped.private.coffee"],n=["https://inv.thepixora.com","https://invidious.flokinet.to","https://invidious.nerdvpn.de","https://invidious.tiekoetter.com","https://inv.nadeko.net","https://yewtu.be"],i=async c=>{const u=new AbortController,h=setTimeout(()=>u.abort(),6e3);try{const d=await fetch(c.endsWith("/")?c:c+"/",{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify({url:`https://www.youtube.com/watch?v=${r}`,videoQuality:"720"}),signal:u.signal});if(clearTimeout(h),!d.ok)throw new Error(`HTTP ${d.status}`);const m=await d.json();if((m.status==="stream"||m.status==="redirect"||m.status==="success")&&m.url)return console.log(`[YouTube Client] Success from Cobalt instance: ${c}`),m.url;throw new Error(`Invalid Cobalt response status: ${m.status}`)}catch(d){throw clearTimeout(h),d}},s=async c=>{const u=new AbortController,h=setTimeout(()=>u.abort(),6e3);try{const d=await fetch(`${c}/streams/${r}`,{signal:u.signal});if(clearTimeout(h),!d.ok)throw new Error(`HTTP ${d.status}`);const m=await d.json();if(!m.videoStreams||m.videoStreams.length===0)throw new Error("No videoStreams");const g=m.videoStreams.find(_=>_.format==="MPEG_4"||_.mimeType.includes("video/mp4"));if(!g||!g.url)throw new Error("No MP4 stream found");return console.log(`[YouTube Client] Success from Piped instance: ${c}`),g.url}catch(d){throw clearTimeout(h),d}},o=async c=>{const u=new AbortController,h=setTimeout(()=>u.abort(),6e3);try{const d=await fetch(`${c}/api/v1/videos/${r}`,{signal:u.signal});if(clearTimeout(h),!d.ok)throw new Error(`HTTP ${d.status}`);const m=await d.json();if(!m.formatStreams||m.formatStreams.length===0)throw new Error("No formatStreams");const g=m.formatStreams.find(f=>f.container==="mp4"||f.type.includes("video/mp4"));if(!g||!g.url)throw new Error("No MP4 stream found");let _=g.url;if(_.includes("local=true")||(_+=_.includes("?")?"&local=true":"?local=true"),_.startsWith("/"))_=c+_;else if(_.startsWith("http")){const f=new URL(_),p=new URL(c);f.host=p.host,f.protocol=p.protocol,f.searchParams.has("local")||f.searchParams.set("local","true"),_=f.toString()}return console.log(`[YouTube Client] Success from Invidious instance: ${c}`),_}catch(d){throw clearTimeout(h),d}},a=c=>new Promise((u,h)=>{let d=[],m=0;c.forEach(g=>{Promise.resolve(g).then(u).catch(_=>{d.push(_),m++,m===c.length&&h(new Error("All client instances failed: "+d.map(f=>f.message).join(", ")))})})}),l=[...e.map(i),...t.map(s),...n.map(o)];try{return await a(l)}catch(c){throw console.error("[YouTube Client] All client-side resolution attempts failed:",c),c}}async function hh(r){try{const e=await fetch(kr(`/api/yt-resolve?id=${r}`));if(!e.ok)throw new Error(`Server returned HTTP ${e.status}`);const t=await e.json();if(!t.url)throw new Error("Server response missing URL");return t.url.startsWith("/api/")?kr(t.url):t.url}catch(e){console.warn("[YouTube] Server proxy failed. Falling back to client-side Piped/Invidious racing...",e.message);const t=await yv(r);return kr(`/api/yt-proxy?url=${encodeURIComponent(t)}`)}}async function ba(r,e,t){let n=r;if(!r){na=null,oe&&(oe.pause(),oe.removeAttribute("src"),oe.load()),bt&&(bt.dispose(),bt=null);return}const i=uh(r);if(i)try{n=await hh(i)}catch(o){console.error("Failed to resolve YouTube video:",o);return}if(n===na&&oe){oe.loop=e,oe.muted=!t,oe.dataset.shouldPlayAudio=!!t;return}na=n;let s=!1;if(oe||(oe=document.createElement("video"),oe.preload="auto",oe.playsInline=!0,oe.webkitPlaysInline=!0,oe.crossOrigin="anonymous",s=!0),oe.loop=e,oe.muted=!t,oe.dataset.shouldPlayAudio=!!t,oe.crossOrigin="anonymous",oe.src=ah(n),oe.load(),s)try{Ya(oe)}catch(o){console.error("Audio filter setup failed:",o)}bt||(bt=new Zu(oe),bt.colorSpace=Qe,bt.minFilter=ft,bt.generateMipmaps=!1),oe.play().then(()=>{console.log("Preset video play started successfully.")}).catch(o=>{console.log("Preset video autoplay blocked. Retrying with mute...",o),oe.muted=!0,oe.play().then(()=>{console.log("Preset muted fallback autoplay succeeded!");const a=()=>{oe.muted=!t,ot&&ot.state==="suspended"&&ot.resume(),console.log("User interacted. Restored preset audio state."),document.removeEventListener("click",a),document.removeEventListener("keydown",a),document.removeEventListener("touchstart",a)};document.addEventListener("click",a),document.addEventListener("keydown",a),document.addEventListener("touchstart",a)}).catch(a=>{console.error("Preset even muted autoplay failed:",a)})})}function Sv(){new eh;const r=document.createElement("canvas");r.width=1,r.height=1;const e=new $r(r);return e.colorSpace=Qe,Jn=null,Ti=e,Ys=e,xn=null,new Promise(t=>{Wt=t,setTimeout(()=>{Wt&&(Wt(),Wt=null)},1800),Wa()})}function ru(r){const e=Math.floor(r/60),t=r%60;if(e!==Sa){Sa=e,Jo=[];const s=Math.max(1,oh),o=Math.max(.1,rh),a=Math.max(o,sh),l=60/s;for(let c=0;c<s;c++){const u=o+Math.random()*(a-o),h=c*l,d=Math.max(0,l-u),m=h+Math.random()*d;Jo.push({start:m,end:m+u})}}let n=!1;for(const s of Jo)if(t>=s.start&&t<=s.end){n=!0;break}return Qo+=((n?1:0)-Qo)*.12,Math.min(Math.max(Qo,0),1)}function Ev(r,e,t){if(!r)return;r.uIsVideo&&(r.uIsVideo.value=Ot.mode==="video"?1:0),r.uPowerOff&&(r.uPowerOff.value=Ot.mode==="custom_image"&&!Mt?1:0),r.uScaleX&&r.uScaleY&&(r.uScaleX.value=1,r.uScaleY.value=1),r.uTextureText.value=xr,typeof r.uFilterMode<"u"&&(r.uFilterMode.value=Pn),r.uFilterColor&&r.uFilterColor.value.set(Yr);const n=()=>{dt?ht(dt):ea>0?(ea-=t,ht(Ns("283f4b3c3c"),"top-left")):ht("")};if(Yn==="transition_in"){if(on+=t,vt=!0,Wn(),ht(""),r.uTexture.value=Dt,r.uChildVisibility.value=0,on>=iu){if(Yn="active",on=0,vt=!1,pi.clearRect(0,0,mn.width,mn.height),xn&&xn.image){pi.save(),pi.filter="invert(1)";const s=720,o=s*(769/612),a=(mn.width-s)/2,l=(mn.height-o)/2;pi.drawImage(xn.image,a,l,s,o),pi.restore()}Qn.needsUpdate=!0}return}if(Yn==="active"){on+=t,vt=!1,dt?ht(dt,tr):on<=2?ht(Ns("283f4b3a3f342f2f"),"top-left"):ht(""),r.uScaleX&&(r.uScaleX.value=1.936872),r.uTexture.value=Qn,r.uChildVisibility.value=0,on>=Ea&&(Yn="transition_out",on=0,vt=!0);return}if(Yn==="transition_out"){on+=t,vt=!0,Wn(),ht(""),r.uTexture.value=Dt,r.uChildVisibility.value=0,on>=iu&&(Yn="idle",on=0,vt=!1,ea=2);return}if(ln==="static"){vt=!1,Wn(),r.uTexture.value=Dt,r.uChildVisibility.value=0,ht(dt||"");return}if(ln==="custom_image"&&Mt){vt=!1,r.uTexture.value=Mt,r.uChildVisibility.value=0,ht(dt||"");return}if(Ot.mode==="static"){vt=!1,Wn(),r.uTexture.value=Dt,ht(dt||""),r.uChildVisibility.value=0;return}if(Ot.mode==="custom_image"){vt=!1,Mt?r.uTexture.value=Mt:(pi.fillStyle="#000000",pi.fillRect(0,0,mn.width,mn.height),Qn.needsUpdate=!0,r.uTexture.value=Qn),ht(dt||""),r.uChildVisibility.value=0;return}if(Ot.mode==="default"){vt=!1,n(),Mt||Jn?(r.uScaleX&&(r.uScaleX.value=1.936872),r.uTexture.value=Mt||Jn,r.uTextureChild.value=Ti,r.uChildVisibility.value=ru(e)):(Wn(),r.uTexture.value=Dt,dt||ht("SEÑAL PENDIENTE"),r.uChildVisibility.value=0);return}if(Ot.mode==="video"){vt=!1,bt&&oe&&oe.readyState>=2?(bt.needsUpdate=!0,r.uTexture.value=bt):(Wn(),r.uTexture.value=Dt),ht(dt||""),r.uChildVisibility.value=0;return}if(Ot.mode==="slideshow"){const s=Ot.slideshow.images;if(!s||s.length===0){vt=!1,Wn(),r.uTexture.value=Dt,dt||ht("SEÑAL PENDIENTE"),r.uChildVisibility.value=0;return}if(s.length<=1){vt=!1;const o=s[0],a=Qc[o]||Jn;n(),r.uTexture.value=a,r.uChildVisibility.value=0;return}if(Cr+=t,vt)Wn(),ht(""),r.uTexture.value=Dt,r.uChildVisibility.value=0,Cr>=Ot.slideshow.transitionDuration&&($o=($o+1)%s.length,Cr=0,vt=!1);else{const o=s[$o],a=Qc[o]||Jn;n(),r.uTexture.value=a,o===Ns("4407340345130a03")?(r.uScaleX&&(r.uScaleX.value=1.936872),r.uTextureChild.value=Ti,r.uChildVisibility.value=ru(e)):r.uChildVisibility.value=0,Cr>=Ot.slideshow.slideDuration&&(Cr=0,vt=!0)}}const i=r.uTexture.value;if(i&&i.image){const s=i.image;let o=!0;if(s instanceof HTMLVideoElement&&(s.readyState<2||s.paused)&&(o=!1),o)try{eu.drawImage(s,0,0,1,1);const a=eu.getImageData(0,0,1,1).data;let l=a[0]/255,c=a[1]/255,u=a[2]/255;const h=.299*l+.587*c+.114*u;if(Pn===1)l=h*.22*1.35,c=h*1*1.35,u=h*.08*1.35;else if(Pn===2)l=h*1*1.35,c=h*.15*1.35,u=h*.15*1.35;else if(Pn===3)l=h*1*1.35,c=h*.82*1.35,u=0;else if(Pn===4){const g=e*.15%1,_=new we().setHSL(g,1,.5);l=h*_.r*1.5,c=h*_.g*1.5,u=h*_.b*1.5}else if(Pn===5){const g=new we(Yr);l=h*g.r*1.35,c=h*g.g*1.35,u=h*g.b*1.35}else l=l*.68,c=c*.73,u=u*.9;const d=.299*l+.587*c+.114*u;let m=1;d>.82&&(m=.82/d),Dr.setRGB(l*m,c*m,u*m)}catch{Dr.setHex(11196671)}else Dr.setHex(11196671)}else Dr.setHex(11196671)}function Tv(){xt&&(clearTimeout(xt),xt=null),Jt=!1,oe&&(oe.pause(),oe.src="",oe.load()),Xt&&Xt.close(),Mt&&Mt.dispose(),Qn.dispose(),Dt.dispose(),xr.dispose(),bt&&bt.dispose()}const qa=()=>{Ot.mode==="video"&&oe&&oe.paused&&oe.play().catch(()=>{})};window.addEventListener("click",qa);window.addEventListener("pointerdown",qa);window.addEventListener("touchstart",qa);/*! REJECTED FALSE ICONS (5/7) */const su=r=>{const e=new dn;let t=!1;return r.traverse(n=>{if(n.isMesh){const i=new dn().setFromObject(n);t?e.union(i):(e.copy(i),t=!0)}}),e};function bv(r,e,t,n){const i=new D0,s=new Promise((o,a)=>{i.load("/crt-tv.glb",l=>{Ir("model",50),o(l)},l=>{let c=l.total;(!c||c===0)&&(c=4862760);const u=Math.min(l.loaded/c,1);Ir("model",u*50)},l=>{console.error("Error loading TV GLTF:",l),a(l)})});return Ir("texture1",10),Ir("texture2",10),s.then(o=>Sv().then(()=>o)).then(o=>{const a=new Zn;r.add(a);const l=o.scene;a.add(l),l.position.set(0,0,0),l.rotation.set(0,0,0),l.scale.set(1,1,1),l.updateMatrixWorld(!0);const c=2.4,h=su(l).getSize(new P),d=c/h.y;l.scale.setScalar(d),l.updateMatrixWorld(!0);const m=su(l),g=m.getCenter(new P);l.position.x=-g.x,l.position.y=-m.min.y,l.position.z=-g.z,l.rotation.y=Math.PI,l.updateMatrixWorld(!0),l.traverse(Z=>{Z.isMesh&&(Z.castShadow=!0,Z.receiveShadow=!0,Z.material&&(Z.material.roughness=Math.max(Z.material.roughness,.45),Z.material.metalness=Math.min(Z.material.metalness,.8)))});const _=new pr(1.75,1.54,16,16),f=new On({vertexShader:fv,fragmentShader:pv,uniforms:{uTime:{value:0},uTexture:{value:null},uTextureChild:{value:null},uTextureText:{value:null},uChildVisibility:{value:0},uMagneticCenter:{value:new be(-10,-10)},uMagneticTime:{value:0},uMagneticIntensity:{value:0},uMagneticBuildup:{value:0},uMagneticVelocity:{value:new be(0,0)},uFilterMode:{value:0},uFilterColor:{value:new we("#ffffff")},uScaleX:{value:1},uScaleY:{value:1},uIsVideo:{value:0},uPowerOff:{value:0}}}),p=new Bt(_,f),E=m.max.z-g.z;p.position.set(0,1.3,E+2.01),a.add(p);const M=new Ws(11196671,12,9,Math.PI/2.2,.95,1.1);M.position.set(0,1.3,E+2.05);const b=new nt;b.position.set(0,0,E+5.5),a.add(b),M.target=b,a.add(M);const C=new Ws(16733457,14,3.2,Math.PI/2.5,.9,2);C.position.set(0,1.3,E+.3);const R=new nt;R.position.set(0,1.3,E-.5),a.add(R),C.target=R,a.add(C),a.position.set(0,0,12),e.target.set(0,1.3,12),n.position.set(0,1.3,12),t.target=n;let A=!1,z=0;const x=3.5,T=.22;let D=0,W=0,$=0,I=0,O=0,V=0;return{tvGroup:a,crtScreen:p,crtLight:M,internalCabinetLight:C,update:(Z,B)=>{if(f.uniforms.uTime.value=Z,V=Math.max(V-B*5,0),I*=Math.max(1-B*6,0),O*=Math.max(1-B*6,0),A){z=Math.min(z+B,x);const X=z/x;f.uniforms.uMagneticIntensity.value=Math.min(.15+X*.85+V*.4,1.3),f.uniforms.uMagneticBuildup.value=X,f.uniforms.uMagneticTime.value+=B,f.uniforms.uMagneticVelocity.value.set(I,O);const ae=Math.min(X*.032,.032);ae>.001?a.position.set((Math.random()-.5)*ae,(Math.random()-.5)*ae,12+(Math.random()-.5)*ae):a.position.set(0,0,12)}else if(W>0)if($+=B,f.uniforms.uMagneticTime.value+=B,f.uniforms.uMagneticVelocity.value.set(0,0),$<0){const X=($+T)/T,ae=Math.sin(X*Math.PI)*.55,de=Math.min(D+ae,1.4);f.uniforms.uMagneticIntensity.value=de,f.uniforms.uMagneticBuildup.value=de,a.position.set(0,0,12)}else{const X=Math.min($/W,1),ae=1-X*X,de=D*ae;if(de<=.001||X>=1)f.uniforms.uMagneticIntensity.value=0,f.uniforms.uMagneticBuildup.value=0,W=0,a.position.set(0,0,12);else{f.uniforms.uMagneticIntensity.value=de,f.uniforms.uMagneticBuildup.value=de;const me=de*.032;a.position.set((Math.random()-.5)*me,(Math.random()-.5)*me,12+(Math.random()-.5)*me)}}else f.uniforms.uMagneticVelocity.value.set(0,0),vt?a.position.set((Math.random()-.5)*.012,(Math.random()-.5)*.012,12+(Math.random()-.5)*.012):a.position.set(0,0,12);Ev(f.uniforms,Z,B),M.color.lerp(Dr,.12),M.intensity=(1.4+Math.sin(Z*35)*.18+Math.sin(Z*7)*.06)*16,C.intensity=10+Math.sin(Z*22)*.8+Math.sin(Z*4)*.25,l.position.set(-g.x,-m.min.y,-g.z)},destroy:()=>{_.dispose(),f.dispose(),Tv(),r.remove(a)},startMagneticHold:Z=>{A=!0,z=f.uniforms.uMagneticBuildup.value*x,W=0,$=0,f.uniforms.uMagneticCenter.value.copy(Z)},stopMagneticHold:()=>{A&&(A=!1,D=f.uniforms.uMagneticBuildup.value,W=1.5+D*9,$=-T)},setVelocityBoost:(Z,B)=>{const X=Math.sqrt(Z*Z+B*B);V=Math.min(X*12,.6),I=Z*8,O=B*8}}})}/*! EL Psy Koongro (6/7) */function Av(r,e,t){let n=-10,i=!1,s=!0,o=-10,a=0;const l=r.position.distanceTo(e.target);let c=0,u=Math.PI/2-.15,h=l,d=0,m=Math.PI/2-.15,g=l,_=1;const f=5.5,p=z=>{n=z},E=()=>{i=!0,s=!0,a=0},M=()=>{i&&(s=!0,a=0)},b=()=>{i=!1,s=!0,a=0},C=()=>{s=!0,a=0};return t.addEventListener("pointerdown",E),t.addEventListener("pointermove",M),t.addEventListener("pointerup",b),t.addEventListener("wheel",C),{update:(z,x)=>{i&&p(z);const T=z-n;if(!i&&T>5){const I=r.position.x,O=r.position.y-1.3,V=r.position.z-12,j=Math.sqrt(I*I+O*O+V*V),Y=Math.acos(O/j),K=Math.atan2(I,V);z-o>5.5&&(s?(c=K,u=Y,h=j,s=!1):(c=d,u=m,h=g),d=(Math.random()-.5)*.28,m=Math.PI/2-.15+(Math.random()-.5)*.06,window.innerWidth<768?g=6.8+Math.random()*.7:g=5.2+Math.random()*.5,_=0,o=z),_=Math.min(_+x/f,1);const q=_,ie=q*q*q*(q*(q*6-15)+10),Z=Kn.lerp(c,d,ie),B=Kn.lerp(u,m,ie),X=Kn.lerp(h,g,ie);a=Kn.lerp(a,1,.015);const ae=Z+Math.sin(z*.15)*.02*a,de=B+Math.cos(z*.2)*.015*a,me=X+Math.sin(z*.1)*.08*a;r.position.x=me*Math.sin(de)*Math.sin(ae),r.position.y=1.3+me*Math.cos(de),r.position.z=12+me*Math.sin(de)*Math.cos(ae)}e.update(),r.position.y<.2&&(r.position.y=.2),e.target.y<0&&(e.target.y=0)},destroy:()=>{t.removeEventListener("pointerdown",E),t.removeEventListener("pointermove",M),t.removeEventListener("pointerup",b),t.removeEventListener("wheel",C)}}}const oi=document.getElementById("webgl-canvas"),wv=document.getElementById("app-container"),{scene:no,camera:io,renderer:ra,controls:ro}=w0(wv,oi);to("scene");const sa=L0();to("overlay");const Aa=P0(no);to("lights");const Rv=I0(no);to("particles");const Cv=Av(io,ro,oi);let wa=null,ri=null;bv(no,ro,Aa.spotlight,Aa.spotTarget).then(r=>{wa=r.update,ri=r,window.tvGroup=r.tvGroup,window.crtScreen=r.crtScreen,window.crtLight=r.crtLight,window.internalCabinetLight=r.internalCabinetLight,Jc()}).catch(r=>{console.error("TV Model failed to load:",r),Jc()});const zr=new T0,ir=new be;let Gr=null,Ji=null,Ra={x:0,y:0},ja=!1;const Lv=950,Pv=6,ou=new hn,au=new P,lu=new P,oa=new P,cu=new Ln,uu=new be(-1,-1),Iv=r=>{if(!window.crtScreen||!ri)return;const e=oi.getBoundingClientRect();ir.x=(r.clientX-e.left)/e.width*2-1,ir.y=-((r.clientY-e.top)/e.height)*2+1,zr.setFromCamera(ir,io);const t=window.crtScreen.material.uniforms.uMagneticCenter.value,n=t.x,i=t.y,s=zr.intersectObject(window.crtScreen);s.length>0&&s[0].uv?t.copy(s[0].uv):(window.crtScreen.updateWorldMatrix(!0,!1),window.crtScreen.getWorldQuaternion(ou),window.crtScreen.getWorldPosition(au),cu.setFromNormalAndCoplanarPoint(new P(0,0,1).applyQuaternion(ou),au),zr.ray.intersectPlane(cu,lu)&&(window.crtScreen.worldToLocal(oa.copy(lu)),t.set(Kn.clamp(oa.x/1.75+.5,.02,.98),Kn.clamp(oa.y/1.54+.5,.02,.98)))),uu.x>=0&&ri.setVelocityBoost&&ri.setVelocityBoost(t.x-n,t.y-i),uu.set(t.x,t.y)},dh=()=>{Gr&&(clearTimeout(Gr),Gr=null),Ji=null},so=()=>{dh(),ja=!1,ro.enabled=!0,ri&&ri.stopMagneticHold()};oi.addEventListener("pointerdown",r=>{const e=oi.getBoundingClientRect();if(Ra={x:r.clientX,y:r.clientY},ir.x=(r.clientX-e.left)/e.width*2-1,ir.y=-((r.clientY-e.top)/e.height)*2+1,zr.setFromCamera(ir,io),window.crtScreen&&ri){const t=zr.intersectObject(window.crtScreen);t.length>0&&t[0].uv&&(Ji=t[0].uv.clone(),Gr=setTimeout(()=>{Ji&&(ro.enabled=!1,ja=!0,ri.startMagneticHold(Ji),Ji=null),Gr=null},Lv))}});oi.addEventListener("pointermove",r=>{if(Ji&&r.buttons>0){const e=r.clientX-Ra.x,t=r.clientY-Ra.y;Math.sqrt(e*e+t*t)>Pv&&dh()}ja&&Iv(r)});oi.addEventListener("pointerup",so);oi.addEventListener("pointercancel",so);document.addEventListener("visibilitychange",()=>{document.hidden&&so()});window.addEventListener("blur",so);const hu=new p0,fh=()=>{requestAnimationFrame(fh);const r=Math.min(hu.getDelta(),.1),e=hu.getElapsedTime();sa.update(e),Aa.update(e),Rv.update(e),wa&&wa(e,r),Cv.update(e,r),ra.clear(),ra.render(no,io),ra.render(sa.overlayScene,sa.overlayCamera)};fh();
