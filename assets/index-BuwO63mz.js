...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ni,depthTest:!1,depthWrite:!1})}function oc(){return new Fn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Oa(),fragmentShader:`
		...
		`,blending:ni,depthTest:!1,depthWrite:!1})}function ac(){return new Fn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Oa(),fragmentShader:`
	...
	`}function jm(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===ua||l===ha,u=l===sr||l===or;if(c||u)if(a.isRenderTargetTexture&&a.needsPMREMUpdate===!0){a.needsPMREMUpdate=!1;let h=e.get(a);return t===null&&(t=new rc(i)),h=c?t.fromEquirectangular(a,h):t.fromCubemap(a,h),e.set(a,h),h.texture}else{if(e.has(a))return e.get(a).texture;{const h=a.image;if(c&&h&&h.height>0||u&&h&&r(h)){t===null&&(t=new rc(i));const d=c?t.fromEquirectangular(a):t.fromCubemap(a);return e.set(a,d),a.addEventListener("dispose",s),d.texture}else return null}}}return a}function r(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function Km(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){const r=t(n);return r===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function Zm(i,e,t,n){const r={},s=new WeakMap;function o(h){const d=h.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const _=d.morphAttributes[g];for(let p=0,f=_.length;p<f;p++)e.remove(_[p])}d.removeEventListener("dispose",o),delete r[d.id];const m=s.get(d);m&&(e.remove(m),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(h,d){return r[d.id]===!0||(d.addEventListener("dispose",o),r[d.id]=!0,t.memory.geometries++),d}function l(h){const d=h.attributes;for(const g in d)e.update(d[g],i.ARRAY_BUFFER);const m=h.morphAttributes;for(const g in m){const _=m[g];for(let p=0,f=_.length;p<f;p++)e.update(_[p],i.ARRAY_BUFFER)}}function c(h){const d=[],m=h.index,g=h.attributes.position;let _=0;if(m!==null){const E=m.array;_=m.version;for(let M=0,b=E.length;M<b;M+=3){const C=E[M+0],R=E[M+1],A=E[M+2];d.push(C,R,R,A,A,C)}}else if(g!==void 0){const E=g.array;_=g.version;for(let M=0,b=E.length/3-1;M<b;M+=3){const C=M+0,R=M+1,A=M+2;d.push(C,R,R,A,A,C)}}else return;const p=new(Lu(d)?Ou:Nu)(d,1);p.version=_;const f=s.get(h);f&&e.remove(f),s.set(h,p)}function u(h){const d=s.get(h);if(d){const m=h.index;m!==null&&d.version<m.version&&c(h)}else c(h);return s.get(h)}return{get:a,update:l,getWireframeAttribute:u}}function $m(i,e,t,n){const r=n.isWebGL2;let s;function o(m){s=m}let a,l;function c(m){a=m.type,l=m.bytesPerElement}function u(m,g){i.drawElements(s,g,a,m*l),t.update(g,s,1)}function h(m,g,_){if(_===0)return;let p,f;if(r)p=i,f="drawElementsInstanced";else if(p=e.get("ANGLE_instanced_arrays"),f="drawElementsInstancedANGLE",p===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}p[f](s,g,a,m*l,_),t.update(g,s,_)}function d(m,g,_){if(_===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let f=0;f<_;f++)this.render(m[f]/l,g[f]);else{p.multiDrawElementsWEBGL(s,g,0,a,m,0,_);let f=0;for(let E=0;E<_;E++)f+=g[E];t.update(f,s,1)}}this.setMode=o,this.setIndex=c,this.render=u,this.renderInstances=h,this.renderMultiDraw=d}function Jm(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(s/3);break;case i.LINES:t.lines+=a*(s/2);break;case i.LINE_STRIP:t.lines+=a*(s-1);break;case i.LINE_LOOP:t.lines+=a*s;break;case i.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function Qm(i,e){return i[0]-e[0]}function eg(i,e){return Math.abs(e[1])-Math.abs(i[1])}function tg(i,e,t){const n={},r=new Float32Array(8),s=new WeakMap,o=new tt,a=[];for(let c=0;c<8;c++)a[c]=[c,0];function l(c,u,h){const d=c.morphTargetInfluences;if(e.isWebGL2===!0){const g=u.morphAttributes.position||u.morphAttributes.normal||u.morphAttributes.color,_=g!==void 0?g.length:0;let p=s.get(u);if(p===void 0||p.count!==_){let O=function(){$.dispose(),s.delete(u),u.removeEventListener("dispose",O)};var m=O;p!==void 0&&p.texture.dispose();const M=u.morphAttributes.position!==void 0,b=u.morphAttributes.normal!==void 0,C=u.morphAttributes.color!==void 0,R=u.morphAttributes.position||[],A=u.morphAttributes.normal||[],z=u.morphAttributes.color||[];let x=0;M===!0&&(x=1),b===!0&&(x=2),C===!0&&(x=3);let T=u.attributes.position.count*x,D=1;T>e.maxTextureSize&&(D=Math.ceil(T/e.maxTextureSize),T=e.maxTextureSize);const W=new Float32Array(T*D*4*_),$=new Du(W,T,D,_);$.type=Dn,$.needsUpdate=!0;const I=x*4;for(let V=0;V<_;V++){const j=R[V],Y=A[V],K=z[V],q=T*D*4*V;for(let re=0;re<j.count;re++){const Z=re*I;M===!0&&(o.fromBufferAttribute(j,re),W[q+Z+0]=o.x,W[q+Z+1]=o.y,W[q+Z+2]=o.z,W[q+Z+3]=0),b===!0&&(o.fromBufferAttribute(Y,re),W[q+Z+4]=o.x,W[q+Z+5]=o.y,W[q+Z+6]=o.z,W[q+Z+7]=0),C===!0&&(o.fromBufferAttribute(K,re),W[q+Z+8]=o.x,W[q+Z+9]=o.y,W[q+Z+10]=o.z,W[q+Z+11]=K.itemSize===4?o.w:1)}}p={count:_,texture:$,size:new be(T,D)},s.set(u,p),u.addEventListener("dispose",O)}let f=0;for(let M=0;M<d.length;M++)f+=d[M];const E=u.morphTargetsRelative?1:1-f;h.getUniforms().setValue(i,"morphTargetBaseInfluence",E),h.getUniforms().setValue(i,"morphTargetInfluences",d),h.getUniforms().setValue(i,"morphTargetsTexture",p.texture,t),h.getUniforms().setValue(i,"morphTargetsTextureSize",p.size)}else{const g=d===void 0?0:d.length;let _=n[u.id];if(_===void 0||_.length!==g){_=[];for(let b=0;b<g;b++)_[b]=[b,0];n[u.id]=_}for(let b=0;b<g;b++){const C=_[b];C[0]=b,C[1]=d[b]}_.sort(eg);for(let b=0;b<8;b++)b<g&&_[b][1]?(a[b][0]=_[b][0],a[b][1]=_[b][1]):(a[b][0]=Number.MAX_SAFE_INTEGER,a[b][1]=0);a.sort(Qm);const p=u.morphAttributes.position,f=u.morphAttributes.normal;let E=0;for(let b=0;b<8;b++){const C=a[b],R=C[0],A=C[1];R!==Number.MAX_SAFE_INTEGER&&A?(p&&u.getAttribute("morphTarget"+b)!==p[R]&&u.setAttribute("morphTarget"+b,p[R]),f&&u.getAttribute("morphNormal"+b)!==f[R]&&u.setAttribute("morphNormal"+b,f[R]),r[b]=A,E+=A):(p&&u.hasAttribute("morphTarget"+b)===!0&&u.deleteAttribute("morphTarget"+b),f&&u.hasAttribute("morphNormal"+b)===!0&&u.deleteAttribute("morphNormal"+b),r[b]=0)}const M=u.morphTargetsRelative?1:1-E;h.getUniforms().setValue(i,"morphTargetBaseInfluence",M),h.getUniforms().setValue(i,"morphTargetInfluences",r)}}return{update:l}}function ng(i,e,t,n){let r=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,h=e.get(l,u);if(r.get(h)!==c&&(e.update(h),r.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),r.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;r.get(d)!==c&&(d.update(),r.set(d,c))}return h}function o(){r=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:o}}class zu extends vt{constructor(e,t,n,r,s,o,a,l,c,u){if(u=u!==void 0?u:Ei,u!==Ei&&u!==ar)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===Ei&&(n=Kn),n===void 0&&u===ar&&(n=Si),super(null,r,s,o,a,l,u,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:_t,this.minFilter=l!==void 0?l:_t,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Gu=new vt,Vu=new zu(1,1);Vu.compareFunction=Cu;const Wu=new Du,Xu=new Hd,Yu=new Hu,lc=[],cc=[],uc=new Float32Array(16),hc=new Float32Array(9),dc=new Float32Array(4);function gr(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=lc[r];if(s===void 0&&(s=new Float32Array(r),lc[r]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(s,a)}return s}function St(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Et(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Qs(i,e){let t=cc[e];t===void 0&&(t=new Int32Array(e),cc[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function ig(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function rg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;i.uniform2fv(this.addr,e),Et(t,e)}}function sg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(St(t,e))return;i.uniform3fv(this.addr,e),Et(t,e)}}function og(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;i.uniform4fv(this.addr,e),Et(t,e)}}function ag(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Et(t,e)}else{if(St(t,n))return;dc.set(n),i.uniformMatrix2fv(this.addr,!1,dc),Et(t,n)}}function lg(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Et(t,e)}else{if(St(t,n))return;hc.set(n),i.uniformMatrix3fv(this.addr,!1,hc),Et(t,n)}}function cg(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Et(t,e)}else{if(St(t,n))return;uc.set(n),i.uniformMatrix4fv(this.addr,!1,uc),Et(t,n)}}function ug(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function hg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;i.uniform2iv(this.addr,e),Et(t,e)}}function dg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(St(t,e))return;i.uniform3iv(this.addr,e),Et(t,e)}}function fg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;i.uniform4iv(this.addr,e),Et(t,e)}}function pg(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function mg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;i.uniform2uiv(this.addr,e),Et(t,e)}}function gg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(St(t,e))return;i.uniform3uiv(this.addr,e),Et(t,e)}}function _g(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;i.uniform4uiv(this.addr,e),Et(t,e)}}function vg(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);const s=this.type===i.SAMPLER_2D_SHADOW?Vu:Gu;t.setTexture2D(e||s,r)}function xg(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Xu,r)}function Mg(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Yu,r)}function yg(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||Wu,r)}function Sg(i){switch(i){case 5126:return ig;case 35664:return rg;case 35665:return sg;case 35666:return og;case 35674:return ag;case 35675:return lg;case 35676:return cg;case 5124:case 35670:return ug;case 35667:case 35671:return hg;case 35668:case 35672:return dg;case 35669:case 35673:return fg;case 5125:return pg;case 36294:return mg;case 36295:return gg;case 36296:return _g;case 35678:case 36198:case 36298:case 36306:case 35682:return vg;case 35679:case 36299:case 36307:return xg;case 35680:case 36300:case 36308:case 36293:return Mg;case 36289:case 36303:case 36311:case 36292:return yg}}function Eg(i,e){i.uniform1fv(this.addr,e)}function Tg(i,e){const t=gr(e,this.size,2);i.uniform2fv(this.addr,t)}function bg(i,e){const t=gr(e,this.size,3);i.uniform3fv(this.addr,t)}function Ag(i,e){const t=gr(e,this.size,4);i.uniform4fv(this.addr,t)}function wg(i,e){const t=gr(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Rg(i,e){const t=gr(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Cg(i,e){const t=gr(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Lg(i,e){i.uniform1iv(this.addr,e)}function Pg(i,e){i.uniform2iv(this.addr,e)}function Ig(i,e){i.uniform3iv(this.addr,e)}function Dg(i,e){i.uniform4iv(this.addr,e)}function Ug(i,e){i.uniform1uiv(this.addr,e)}function Ng(i,e){i.uniform2uiv(this.addr,e)}function Og(i,e){i.uniform3uiv(this.addr,e)}function Fg(i,e){i.uniform4uiv(this.addr,e)}function Bg(i,e,t){const n=this.cache,r=e.length,s=Qs(t,r);St(n,s)||(i.uniform1iv(this.addr,s),Et(n,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||Gu,s[o])}function Hg(i,e,t){const n=this.cache,r=e.length,s=Qs(t,r);St(n,s)||(i.uniform1iv(this.addr,s),Et(n,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||Xu,s[o])}function kg(i,e,t){const n=this.cache,r=e.length,s=Qs(t,r);St(n,s)||(i.uniform1iv(this.addr,s),Et(n,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||Yu,s[o])}function zg(i,e,t){const n=this.cache,r=e.length,s=Qs(t,r);St(n,s)||(i.uniform1iv(this.addr,s),Et(n,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||Wu,s[o])}function Gg(i){switch(i){case 5126:return Eg;case 35664:return Tg;case 35665:return bg;case 35666:return Ag;case 35674:return wg;case 35675:return Rg;case 35676:return Cg;case 5124:case 35670:return Lg;case 35667:case 35671:return Pg;case 35668:case 35672:return Ig;case 35669:case 35673:return Dg;case 5125:return Ug;case 36294:return Ng;case 36295:return Og;case 36296:return Fg;case 35678:case 36198:case 36298:case 36306:case 35682:return Bg;case 35679:case 36299:case 36307:return Hg;case 35680:case 36300:case 36308:case 36293:return kg;case 36289:case 36303:case 36311:case 36292:return zg}}class Vg{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Sg(t.type)}}class Wg{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Gg(t.type)}}class Xg{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],n)}}}const Ho=/(\w+)(\])?(\[|\.)?/g;function fc(i,e){i.seq.push(e),i.map[e.id]=e}function Yg(i,e,t){const n=i.name,r=n.length;for(Ho.lastIndex=0;;){const s=Ho.exec(n),o=Ho.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===r){fc(t,c===void 0?new Vg(a,i,e):new Wg(a,i,e));break}else{let h=t.map[a];h===void 0&&(h=new Xg(a),fc(t,h)),t=h}}}class Ds{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);Yg(s,o,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&n.push(o)}return n}}function pc(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const qg=37297;let jg=0;function Kg(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function Zg(i){const e=$e.getPrimaries($e.workingColorSpace),t=$e.getPrimaries(i);let n;switch(e===t?n="":e===zs&&t===ks?n="LinearDisplayP3ToLinearSRGB":e===ks&&t===zs&&(n="LinearSRGBToLinearDisplayP3"),i){case Rt:case Zs:return[n,"LinearTransferOETF"];case Qe:case Ia:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function mc(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+Kg(i.getShaderSource(e),o)}else return r}function $g(i,e){const t=Zg(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function Jg(i,e){let t;switch(e){case jh:t="Linear";break;case Kh:t="Reinhard";break;case Zh:t="OptimizedCineon";break;case gu:t="ACESFilmic";break;case Jh:t="AgX";break;case $h:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function Qg(i){return[i.extensionDerivatives||i.envMapCubeUVHeight||i.bumpMap||i.normalMapTangentSpace||i.clearcoatNormalMap||i.flatShading||i.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(i.extensionFragDepth||i.logarithmicDepthBuffer)&&i.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",i.extensionDrawBuffers&&i.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(i.extensionShaderTextureLOD||i.envMap||i.transmission)&&i.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(Ji).join(`
`)}function e_(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(Ji).join(`
`)}function t_(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function n_(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function Ji(i){return i!==""}function gc(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function _c(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const i_=/^[ \t]*#include +<([\w\d./]+)>/gm;function _a(i){return i.replace(i_,s_)}const r_=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function s_(i,e){let t=He[e];if(t===void 0){const n=r_.get(e);if(n!==void 0)t=He[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return _a(t)}const o_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function vc(i){return i.replace(o_,a_)}function a_(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function xc(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function l_(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===fu?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===pu?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Ln&&(e="SHADOWMAP_TYPE_VSM"),e}function c_(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case sr:case or:e="ENVMAP_TYPE_CUBE";break;case Ks:e="ENVMAP_TYPE_CUBE_UV";break}return e}function u_(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case or:e="ENVMAP_MODE_REFRACTION";break}return e}function h_(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case mu:e="ENVMAP_BLENDING_MULTIPLY";break;case Yh:e="ENVMAP_BLENDING_MIX";break;case qh:e="ENVMAP_BLENDING_ADD";break}return e}function d_(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function f_(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=l_(t),c=c_(t),u=u_(t),h=h_(t),d=d_(t),m=t.isWebGL2?"":Qg(t),g=e_(t),_=t_(s),p=r.createProgram();let f,E,M=t.glslVersion?"#version "+t.glslVersion+`
...
`;function I0(){const i=new ju,e=new Js(-1,1,1,-1,0,1),t=new Fn({vertexShader:L0,fragmentShader:P0,uniforms:{uTime:{value:0},uDarkness:{value:.8},uOffset:{value:.25}},transparent:!0,depthWrite:!1,depthTest:!1}),n=new mr(2,2),r=new Ht(n,t);return i.add(r),{overlayScene:i,overlayCamera:e,update:a=>{t.uniforms.uTime.value=a},destroy:()=>{n.dispose(),t.dispose()}}}function D0(i){const e=new p0(16777215,.008);i.add(e);const t=new Ws(Ki.spotlightColor,15,30,Math.PI/4.8,.6,1.2);t.position.set(0,8,0),t.castShadow=!0,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,t.shadow.camera.near=.5,t.shadow.camera.far=15,t.shadow.bias=-1e-4,i.add(t);const n=new nt;return n.position.set(0,0,0),i.add(n),t.target=n,{ambientLight:e,spotlight:t,spotTarget:n,update:s=>{const o=Math.sin(s*.85)*.75,a=Math.cos(s*.85)*.75;t.position.x=o,t.position.z=12+a,n.position.x=o*4.2,n.position.z=12+a*4.2}}}const qo=(i,e=64)=>{const t=document.createElement("canvas");t.width=e,t.height=e;const n=t.getContext("2d"),r=n.createRadialGradient(e/2,e/2,0,e/2,e/2,e/2);return r.addColorStop(0,i),r.addColorStop(1,"rgba(0,0,0,0)"),n.fillStyle=r,n.fillRect(0,0,e,e),new $r(t)};function U0(i){const t=new qt,n=new Float32Array(150*3),r=[];for(let C=0;C<150;C++){const R=Math.random()*Math.PI*2,A=Math.random()*3.8,z=Math.cos(R)*A,x=Math.sin(R)*A,T=Math.random()*8;n[C*3]=z,n[C*3+1]=T,n[C*3+2]=x,r.push({baseX:z,baseY:T,baseZ:x,speedX:(Math.random()-.5)*.002,speedY:Math.random()*.012+.004,speedZ:(Math.random()-.5)*.002,swaySpeed:Math.random()*1.5+.4,swayAmp:Math.random()*.12+.03})}t.setAttribute("position",new wt(n,3));const s=new Hr({size:.065,map:qo("rgba(195, 235, 255, 0.75)"),transparent:!0,blending:Os,depthWrite:!1,depthTest:!0}),o=new Us(t,s);i.add(o);const a=110,l=new qt,c=new Float32Array(a*3),u=[];for(let C=0;C<a;C++){const R=Math.random()*Math.PI*2,A=Math.random()*3.8,z=Math.cos(R)*A,x=Math.sin(R)*A,T=Math.random()*8;c[C*3]=z,c[C*3+1]=T,c[C*3+2]=x,u.push({baseX:z,baseY:T,baseZ:x,speedX:(Math.random()-.5)*.002,speedY:Math.random()*.01+.004,speedZ:(Math.random()-.5)*.002,swaySpeed:Math.random()*1.4+.5,swayAmp:Math.random()*.1+.02})}l.setAttribute("position",new wt(c,3));const h=new Hr({size:.055,map:qo("rgba(255, 222, 175, 0.75)"),transparent:!0,blending:Os,depthWrite:!1,depthTest:!0}),d=new Us(l,h);i.add(d);const m=140,g=new qt,_=new Float32Array(m*3),p=[];for(let C=0;C<m;C++){const R=Math.random()*Math.PI*2,A=Math.random()*10+1.5,z=Math.cos(R)*A,x=Math.sin(R)*A,T=Math.random()*9;_[C*3]=z,_[C*3+1]=T,_[C*3+2]=x,p.push({baseX:z,baseY:T,baseZ:x,speedX:(Math.random()-.5)*.003,speedY:-(Math.random()*.008+.004),speedZ:(Math.random()-.5)*.003,swaySpeed:Math.random()*.8+.2,swayAmp:Math.random()*.2+.05})}g.setAttribute("position",new wt(_,3));const f=new Hr({size:.18,map:qo("rgba(28, 28, 28, 0.72)"),transparent:!0,blending:yi,depthWrite:!1,depthTest:!0}),E=new Us(g,f);return i.add(E),{coldParticles:o,warmParticles:d,sootParticles:E,update:C=>{const R=t.attributes.position.array;for(let x=0;x<150;x++){const T=x*3,D=r[x];if(D.baseY+=D.speedY,D.baseX+=D.speedX,D.baseZ+=D.speedZ,D.baseY>8){D.baseY=0;const W=Math.random()*Math.PI*2,$=Math.random()*3.8;D.baseX=Math.cos(W)*$,D.baseZ=Math.sin(W)*$}R[T]=D.baseX+Math.sin(C*D.swaySpeed)*D.swayAmp,R[T+1]=D.baseY,R[T+2]=D.baseZ+Math.cos(C*D.swaySpeed)*D.swayAmp}t.attributes.position.needsUpdate=!0;const A=l.attributes.position.array;for(let x=0;x<a;x++){const T=x*3,D=u[x];if(D.baseY+=D.speedY,D.baseX+=D.speedX,D.baseZ+=D.speedZ,D.baseY>8){D.baseY=0;const W=Math.random()*Math.PI*2,$=Math.random()*3.8;D.baseX=Math.cos(W)*$,D.baseZ=Math.sin(W)*$}A[T]=D.baseX+Math.sin(C*D.swaySpeed)*D.swayAmp,A[T+1]=D.baseY,A[T+2]=D.baseZ+Math.cos(C*D.swaySpeed)*D.swayAmp}l.attributes.position.needsUpdate=!0;const z=g.attributes.position.array;for(let x=0;x<m;x++){const T=x*3,D=p[x];if(D.baseY+=D.speedY,D.baseX+=D.speedX,D.baseZ+=D.speedZ,D.baseY<0){D.baseY=9;const W=Math.random()*Math.PI*2,$=Math.random()*10+1.5;D.baseX=Math.cos(W)*$,D.baseZ=Math.sin(W)*$}z[T]=D.baseX+Math.sin(C*D.swaySpeed)*D.swayAmp,z[T+1]=D.baseY,z[T+2]=D.baseZ+Math.cos(C*D.swaySpeed)*D.swayAmp}g.attributes.position.needsUpdate=!0},destroy:()=>{t.dispose(),s.dispose(),l.dispose(),h.dispose(),g.dispose(),f.dispose()}}}function jc(i,e){if(e===cd)return console.warn("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles."),i;if(e===fa||e===Au){let t=i.getIndex();if(t===null){const o=[],a=i.getAttribute("position");if(a!==void 0){for(let l=0;l<a.count;l++)o.push(l);i.setIndex(o),t=i.getIndex()}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible."),i}const n=t.count-2,r=[];if(e===fa)for(let o=1;o<=n;o++)r.push(t.getX(0)),r.push(t.getX(o)),r.push(t.getX(o+1));else for(let o=0;o<n;o++)o%2===0?(r.push(t.getX(o)),r.push(t.getX(o+1)),r.push(t.getX(o+2))):(r.push(t.getX(o+2)),r.push(t.getX(o+1)),r.push(t.getX(o)));r.length/3!==n&&console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.");const s=i.clone();return s.setIndex(r),s.clearGroups(),s}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:",e),i}class N0 extends xr{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(t){return new k0(t)}),this.register(function(t){return new K0(t)}),this.register(function(t){return new Z0(t)}),this.register(function(t){return new $0(t)}),this.register(function(t){return new G0(t)}),this.register(function(t){return new V0(t)}),this.register(function(t){return new W0(t)}),this.register(function(t){return new X0(t)}),this.register(function(t){return new H0(t)}),this.register(function(t){return new Y0(t)}),this.register(function(t){return new z0(t)}),this.register(function(t){return new j0(t)}),this.register(function(t){return new q0(t)}),this.register(function(t){return new F0(t)}),this.register(function(t){return new J0(t)}),this.register(function(t){return new Q0(t)})}load(e,t,n,r){const s=this;let o;if(this.resourcePath!=="")o=this.resourcePath;else if(this.path!==""){const c=kr.extractUrlBase(e);o=kr.resolveURL(c,this.path)}else o=kr.extractUrlBase(e);this.manager.itemStart(e);const a=function(c){r?r(c):console.error(c),s.manager.itemError(e),s.manager.itemEnd(e)},l=new eh(this.manager);l.setPath(this.path),l.setResponseType("arraybuffer"),l.setRequestHeader(this.requestHeader),l.setWithCredentials(this.withCredentials),l.load(e,function(c){try{s.parse(c,o,function(u){t(u),s.manager.itemEnd(e)},a)}catch(u){a(u)}},n,a)}setDRACOLoader(e){return this.dracoLoader=e,this}setDDSLoader(){throw new Error('THREE.GLTFLoader: "MSFT_texture_dds" no longer supported. Please update to "KHR_texture_basisu".')}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,r){let s;const o={},a={},l=new TextDecoder;if(typeof e=="string")s=JSON.parse(e);else if(e instanceof ArrayBuffer)if(l.decode(new Uint8Array(e,0,4))===nh){try{o[je.KHR_BINARY_GLTF]=new ev(e)}catch(h){r&&r(h);return}s=JSON.parse(o[je.KHR_BINARY_GLTF].content)}else s=JSON.parse(l.decode(e));else s=e;if(s.asset===void 0||s.asset.version[0]<2){r&&r(new Error("THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported."));return}const c=new fv(s,{path:t||this.resourcePath||"",crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let u=0;u<this.pluginCallbacks.length;u++){const h=this.pluginCallbacks[u](c);h.name||console.error("THREE.GLTFLoader: Invalid plugin found: missing name"),a[h.name]=h,o[h.name]=!0}if(s.extensionsUsed)for(let u=0;u<s.extensionsUsed.length;++u){const h=s.extensionsUsed[u],d=s.extensionsRequired||[];switch(h){case je.KHR_MATERIALS_UNLIT:o[h]=new B0;break;case je.KHR_DRACO_MESH_COMPRESSION:o[h]=new tv(s,this.dracoLoader);break;case je.KHR_TEXTURE_TRANSFORM:o[h]=new nv;break;case je.KHR_MESH_QUANTIZATION:o[h]=new iv;break;default:d.indexOf(h)>=0&&a[h]===void 0&&console.warn('THREE.GLTFLoader: Unknown extension "'+h+'".')}}c.setExtensions(o),c.setPlugins(a),c.parse(n,r)}parseAsync(e,t){const n=this;return new Promise(function(r,s){n.parse(e,t,r,s)})}}function O0(){let i={};return{get:function(e){return i[e]},add:function(e,t){i[e]=t},remove:function(e){delete i[e]},removeAll:function(){i={}}}}const je={KHR_BINARY_GLTF:"KHR_binary_glTF",KHR_DRACO_MESH_COMPRESSION:"KHR_draco_mesh_compression",KHR_LIGHTS_PUNCTUAL:"KHR_lights_punctual",KHR_MATERIALS_CLEARCOAT:"KHR_materials_clearcoat",KHR_MATERIALS_IOR:"KHR_materials_ior",KHR_MATERIALS_SHEEN:"KHR_materials_sheen",KHR_MATERIALS_SPECULAR:"KHR_materials_specular",KHR_MATERIALS_TRANSMISSION:"KHR_materials_transmission",KHR_MATERIALS_IRIDESCENCE:"KHR_materials_iridescence",KHR_MATERIALS_ANISOTROPY:"KHR_materials_anisotropy",KHR_MATERIALS_UNLIT:"KHR_materials_unlit",KHR_MATERIALS_VOLUME:"KHR_materials_volume",KHR_TEXTURE_BASISU:"KHR_texture_basisu",KHR_TEXTURE_TRANSFORM:"KHR_texture_transform",KHR_MESH_QUANTIZATION:"KHR_mesh_quantization",KHR_MATERIALS_EMISSIVE_STRENGTH:"KHR_materials_emissive_strength",EXT_MATERIALS_BUMP:"EXT_materials_bump",EXT_TEXTURE_WEBP:"EXT_texture_webp",EXT_TEXTURE_AVIF:"EXT_texture_avif",EXT_MESHOPT_COMPRESSION:"EXT_meshopt_compression",EXT_MESH_GPU_INSTANCING:"EXT_mesh_gpu_instancing"};class F0{constructor(e){this.parser=e,this.name=je.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){const e=this.parser,t=this.parser.json.nodes||[];for(let n=0,r=t.length;n<r;n++){const s=t[n];s.extensions&&s.extensions[this.name]&&s.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,s.extensions[this.name].light)}}_loadLight(e){const t=this.parser,n="light:"+e;let r=t.cache.get(n);if(r)return r;const s=t.json,l=((s.extensions&&s.extensions[this.name]||{}).lights||[])[e];let c;const u=new we(16777215);l.color!==void 0&&u.setRGB(l.color[0],l.color[1],l.color[2],Rt);const h=l.range!==void 0?l.range:0;switch(l.type){case"directional":c=new f0(u),c.target.position.set(0,0,-1),c.add(c.target);break;case"point":c=new h0(u),c.distance=h;break;case"spot":c=new Ws(u),c.distance=h,l.spot=l.spot||{},l.spot.innerConeAngle=l.spot.innerConeAngle!==void 0?l.spot.innerConeAngle:0,l.spot.outerConeAngle=l.spot.outerConeAngle!==void 0?l.spot.outerConeAngle:Math.PI/4,c.angle=l.spot.outerConeAngle,c.penumbra=1-l.spot.innerConeAngle/l.spot.outerConeAngle,c.target.position.set(0,0,-1),c.add(c.target);break;default:throw new Error("THREE.GLTFLoader: Unexpected light type: "+l.type)}return c.position.set(0,0,0),c.decay=2,Yn(c,l),l.intensity!==void 0&&(c.intensity=l.intensity),c.name=t.createUniqueName(l.name||"light_"+e),r=Promise.resolve(c),t.cache.add(n,r),r}getDependency(e,t){if(e==="light")return this._loadLight(t)}createNodeAttachment(e){const t=this,n=this.parser,s=n.json.nodes[e],a=(s.extensions&&s.extensions[this.name]||{}).light;return a===void 0?null:this._loadLight(a).then(function(l){return n._getNodeRef(t.cache,a,l)})}}class B0{constructor(){this.name=je.KHR_MATERIALS_UNLIT}getMaterialType(){return Mi}extendParams(e,t,n){const r=[];e.color=new we(1,1,1),e.opacity=1;const s=t.pbrMetallicRoughness;if(s){if(Array.isArray(s.baseColorFactor)){const o=s.baseColorFactor;e.color.setRGB(o[0],o[1],o[2],Rt),e.opacity=o[3]}s.baseColorTexture!==void 0&&r.push(n.assignTexture(e,"map",s.baseColorTexture,Qe))}return Promise.all(r)}}class H0{constructor(e){this.parser=e,this.name=je.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){const r=this.parser.json.materials[e];if(!r.extensions||!r.extensions[this.name])return Promise.resolve();const s=r.extensions[this.name].emissiveStrength;return s!==void 0&&(t.emissiveIntensity=s),Promise.resolve()}}class k0{constructor(e){this.parser=e,this.name=je.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Bn}extendMaterialParams(e,t){const n=this.parser,r=n.json.materials[e];if(!r.extensions||!r.extensions[this.name])return Promise.resolve();const s=[],o=r.extensions[this.name];if(o.clearcoatFactor!==void 0&&(t.clearcoat=o.clearcoatFactor),o.clearcoatTexture!==void 0&&s.push(n.assignTexture(t,"clearcoatMap",o.clearcoatTexture)),o.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=o.clearcoatRoughnessFactor),o.clearcoatRoughnessTexture!==void 0&&s.push(n.assignTexture(t,"clearcoatRoughnessMap",o.clearcoatRoughnessTexture)),o.clearcoatNormalTexture!==void 0&&(s.push(n.assignTexture(t,"clearcoatNormalMap",o.clearcoatNormalTexture)),o.clearcoatNormalTexture.scale!==void 0)){const a=o.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new be(a,a)}return Promise.all(s)}}class z0{constructor(e){this.parser=e,this.name=je.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Bn}extendMaterialParams(e,t){const n=this.parser,r=n.json.materials[e];if(!r.extensions||!r.extensions[this.name])return Promise.resolve();const s=[],o=r.extensions[this.name];return o.iridescenceFactor!==void 0&&(t.iridescence=o.iridescenceFactor),o.iridescenceTexture!==void 0&&s.push(n.assignTexture(t,"iridescenceMap",o.iridescenceTexture)),o.iridescenceIor!==void 0&&(t.iridescenceIOR=o.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),o.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=o.iridescenceThicknessMinimum),o.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=o.iridescenceThicknessMaximum),o.iridescenceThicknessTexture!==void 0&&s.push(n.assignTexture(t,"iridescenceThicknessMap",o.iridescenceThicknessTexture)),Promise.all(s)}}class G0{constructor(e){this.parser=e,this.name=je.KHR_MATERIALS_SHEEN}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Bn}extendMaterialParams(e,t){const n=this.parser,r=n.json.materials[e];if(!r.extensions||!r.extensions[this.name])return Promise.resolve();const s=[];t.sheenColor=new we(0,0,0),t.sheenRoughness=0,t.sheen=1;const o=r.extensions[this.name];if(o.sheenColorFactor!==void 0){const a=o.sheenColorFactor;t.sheenColor.setRGB(a[0],a[1],a[2],Rt)}return o.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=o.sheenRoughnessFactor),o.sheenColorTexture!==void 0&&s.push(n.assignTexture(t,"sheenColorMap",o.sheenColorTexture,Qe)),o.sheenRoughnessTexture!==void 0&&s.push(n.assignTexture(t,"sheenRoughnessMap",o.sheenRoughnessTexture)),Promise.all(s)}}class V0{constructor(e){this.parser=e,this.name=je.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Bn}extendMaterialParams(e,t){const n=this.parser,r=n.json.materials[e];if(!r.extensions||!r.extensions[this.name])return Promise.resolve();const s=[],o=r.extensions[this.name];return o.transmissionFactor!==void 0&&(t.transmission=o.transmissionFactor),o.transmissionTexture!==void 0&&s.push(n.assignTexture(t,"transmissionMap",o.transmissionTexture)),Promise.all(s)}}class W0{constructor(e){this.parser=e,this.name=je.KHR_MATERIALS_VOLUME}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Bn}extendMaterialParams(e,t){const n=this.parser,r=n.json.materials[e];if(!r.extensions||!r.extensions[this.name])return Promise.resolve();const s=[],o=r.extensions[this.name];t.thickness=o.thicknessFactor!==void 0?o.thicknessFactor:0,o.thicknessTexture!==void 0&&s.push(n.assignTexture(t,"thicknessMap",o.thicknessTexture)),t.attenuationDistance=o.attenuationDistance||1/0;const a=o.attenuationColor||[1,1,1];return t.attenuationColor=new we().setRGB(a[0],a[1],a[2],Rt),Promise.all(s)}}class X0{constructor(e){this.parser=e,this.name=je.KHR_MATERIALS_IOR}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Bn}extendMaterialParams(e,t){const r=this.parser.json.materials[e];if(!r.extensions||!r.extensions[this.name])return Promise.resolve();const s=r.extensions[this.name];return t.ior=s.ior!==void 0?s.ior:1.5,Promise.resolve()}}class Y0{constructor(e){this.parser=e,this.name=je.KHR_MATERIALS_SPECULAR}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Bn}extendMaterialParams(e,t){const n=this.parser,r=n.json.materials[e];if(!r.extensions||!r.extensions[this.name])return Promise.resolve();const s=[],o=r.extensions[this.name];t.specularIntensity=o.specularFactor!==void 0?o.specularFactor:1,o.specularTexture!==void 0&&s.push(n.assignTexture(t,"specularIntensityMap",o.specularTexture));const a=o.specularColorFactor||[1,1,1];return t.specularColor=new we().setRGB(a[0],a[1],a[2],Rt),o.specularColorTexture!==void 0&&s.push(n.assignTexture(t,"specularColorMap",o.specularColorTexture,Qe)),Promise.all(s)}}class q0{constructor(e){this.parser=e,this.name=je.EXT_MATERIALS_BUMP}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Bn}extendMaterialParams(e,t){const n=this.parser,r=n.json.materials[e];if(!r.extensions||!r.extensions[this.name])return Promise.resolve();const s=[],o=r.extensions[this.name];return t.bumpScale=o.bumpFactor!==void 0?o.bumpFactor:1,o.bumpTexture!==void 0&&s.push(n.assignTexture(t,"bumpMap",o.bumpTexture)),Promise.all(s)}}class j0{constructor(e){this.parser=e,this.name=je.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Bn}extendMaterialParams(e,t){const n=this.parser,r=n.json.materials[e];if(!r.extensions||!r.extensions[this.name])return Promise.resolve();const s=[],o=r.extensions[this.name];return o.anisotropyStrength!==void 0&&(t.anisotropy=o.anisotropyStrength),o.anisotropyRotation!==void 0&&(t.anisotropyRotation=o.anisotropyRotation),o.anisotropyTexture!==void 0&&s.push(n.assignTexture(t,"anisotropyMap",o.anisotropyTexture)),Promise.all(s)}}class K0{constructor(e){this.parser=e,this.name=je.KHR_TEXTURE_BASISU}loadTexture(e){const t=this.parser,n=t.json,r=n.textures[e];if(!r.extensions||!r.extensions[this.name])return null;const s=r.extensions[this.name],o=t.options.ktx2Loader;if(!o){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures");return null}return t.loadTextureImage(e,s.source,o)}}class Z0{constructor(e){this.parser=e,this.name=je.EXT_TEXTURE_WEBP,this.isSupported=null}loadTexture(e){const t=this.name,n=this.parser,r=n.json,s=r.textures[e];if(!s.extensions||!s.extensions[t])return null;const o=s.extensions[t],a=r.images[o.source];let l=n.textureLoader;if(a.uri){const c=n.options.manager.getHandler(a.uri);c!==null&&(l=c)}return this.detectSupport().then(function(c){if(c)return n.loadTextureImage(e,o.source,l);if(r.extensionsRequired&&r.extensionsRequired.indexOf(t)>=0)throw new Error("THREE.GLTFLoader: WebP required by asset but unsupported.");return n.loadTexture(e)})}detectSupport(){return this.isSupported||(this.isSupported=new Promise(function(e){const t=new Image;t.src="data:image/webp;base64,UklGRiIAAABXRUJQVlA4IBYAAAAwAQCdASoBAAEADsD+JaQAA3AAAAAA",t.onload=t.onerror=function(){e(t.height===1)}})),this.isSupported}}class $0{constructor(e){this.parser=e,this.name=je.EXT_TEXTURE_AVIF,this.isSupported=null}loadTexture(e){const t=this.name,n=this.parser,r=n.json,s=r.textures[e];if(!s.extensions||!s.extensions[t])return null;const o=s.extensions[t],a=r.images[o.source];let l=n.textureLoader;if(a.uri){const c=n.options.manager.getHandler(a.uri);c!==null&&(l=c)}return this.detectSupport().then(function(c){if(c)return n.loadTextureImage(e,o.source,l);if(r.extensionsRequired&&r.extensionsRequired.indexOf(t)>=0)throw new Error("THREE.GLTFLoader: AVIF required by asset but unsupported.");return n.loadTexture(e)})}detectSupport(){return this.isSupported||(this.isSupported=new Promise(function(e){const t=new Image;t.src="data:image/avif;base64,",t.onload=t.onerror=function(){e(t.height===1)}})),this.isSupported}}class J0{constructor(e){this.name=je.EXT_MESHOPT_COMPRESSION,this.parser=e}loadBufferView(e){const t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){const r=n.extensions[this.name],s=this.parser.getDependency("buffer",r.buffer),o=this.parser.options.meshoptDecoder;if(!o||!o.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files");return null}return s.then(function(a){const l=r.byteOffset||0,c=r.byteLength||0,u=r.count,h=r.byteStride,d=new Uint8Array(a,l,c);return o.decodeGltfBufferAsync?o.decodeGltfBufferAsync(u,h,d,r.mode,r.filter).then(function(m){return m.buffer}):o.ready.then(function(){const m=new ArrayBuffer(u*h);return o.decodeGltfBuffer(new Uint8Array(m),u,h,d,r.mode,r.filter),m})})}else return null}}class Q0{constructor(e){this.name=je.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){const t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;const r=t.meshes[n.mesh];for(const c of r.primitives)if(c.mode!==Jt.TRIANGLES&&c.mode!==Jt.TRIANGLE_STRIP&&c.mode!==Jt.TRIANGLE_FAN&&c.mode!==void 0)return null;const o=n.extensions[this.name].attributes,a=[],l={};for(const c in o)a.push(this.parser.getDependency("accessor",o[c]).then(u=>(l[c]=u,l[c])));return a.length<1?null:(a.push(this.parser.createNodeMesh(e)),Promise.all(a).then(c=>{const u=c.pop(),h=u.isGroup?u.children:[u],d=c[0].count,m=[];for(const g of h){const _=new We,p=new P,f=new dn,E=new P(1,1,1),M=new q_(g.geometry,g.material,d);for(let b=0;b<d;b++)l.TRANSLATION&&p.fromBufferAttribute(l.TRANSLATION,b),l.ROTATION&&f.fromBufferAttribute(l.ROTATION,b),l.SCALE&&E.fromBufferAttribute(l.SCALE,b),M.setMatrixAt(b,_.compose(p,f,E));for(const b in l)if(b==="_COLOR_0"){const C=l[b];M.instanceColor=new va(C.array,C.itemSize,C.normalized)}else b!=="TRANSLATION"&&b!=="ROTATION"&&b!=="SCALE"&&g.geometry.setAttribute(b,l[b]);nt.prototype.copy.call(M,g),this.parser.assignFinalMaterial(M),m.push(M)}return u.isGroup?(u.clear(),u.add(...m),u):m[0]}))}}const nh="glTF",Cr=12,Kc={JSON:1313821514,BIN:5130562};class ev{constructor(e){this.name=je.KHR_BINARY_GLTF,this.content=null,this.body=null;const t=new DataView(e,0,Cr),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==nh)throw new Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");if(this.header.version<2)throw new Error("THREE.GLTFLoader: Legacy binary file detected.");const r=this.header.length-Cr,s=new DataView(e,Cr);let o=0;for(;o<r;){const a=s.getUint32(o,!0);o+=4;const l=s.getUint32(o,!0);if(o+=4,l===Kc.JSON){const c=new Uint8Array(e,Cr+o,a);this.content=n.decode(c)}else if(l===Kc.BIN){const c=Cr+o;this.body=e.slice(c,c+a)}o+=a}if(this.content===null)throw new Error("THREE.GLTFLoader: JSON content not found.")}}class tv{constructor(e,t){if(!t)throw new Error("THREE.GLTFLoader: No DRACOLoader instance provided.");this.name=je.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){const n=this.json,r=this.dracoLoader,s=e.extensions[this.name].bufferView,o=e.extensions[this.name].attributes,a={},l={},c={};for(const u in o){const h=ya[u]||u.toLowerCase();a[h]=o[u]}for(const u in e.attributes){const h=ya[u]||u.toLowerCase();if(o[u]!==void 0){const d=n.accessors[e.attributes[u]],m=tr[d.componentType];c[h]=m.name,l[h]=d.normalized===!0}}return t.getDependency("bufferView",s).then(function(u){return new Promise(function(h,d){r.decodeDracoFile(u,function(m){for(const g in m.attributes){const _=m.attributes[g],p=l[g];p!==void 0&&(_.normalized=p)}h(m)},a,c,Rt,d)})})}}class nv{constructor(){this.name=je.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0||(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0),e}}class iv{constructor(){this.name=je.KHR_MESH_QUANTIZATION}}class ih extends Jr{constructor(e,t,n,r){super(e,t,n,r)}copySampleValue_(e){const t=this.resultBuffer,n=this.sampleValues,r=this.valueSize,s=e*r*3+r;for(let o=0;o!==r;o++)t[o]=n[s+o];return t}interpolate_(e,t,n,r){const s=this.resultBuffer,o=this.sampleValues,a=this.valueSize,l=a*2,c=a*3,u=r-t,h=(n-t)/u,d=h*h,m=d*h,g=e*c,_=g-c,p=-2*m+3*d,f=m-d,E=1-p,M=f-d+h;for(let b=0;b!==a;b++){const C=o[_+b+a],R=o[_+b+l]*u,A=o[g+b+a],z=o[g+b]*u;s[b]=E*C+M*R+p*A+f*z}return s}}const rv=new dn;class sv extends ih{interpolate_(e,t,n,r){const s=super.interpolate_(e,t,n,r);return rv.fromArray(s).normalize().toArray(s),s}}const Jt={POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6},tr={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},Zc={9728:_t,9729:pt,9984:da,9985:vu,9986:Is,9987:Ai},$c={33071:en,33648:Bs,10497:oi},jo={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},ya={POSITION:"position",NORMAL:"normal",TANGENT:"tangent",TEXCOORD_0:"uv",TEXCOORD_1:"uv1",TEXCOORD_2:"uv2",TEXCOORD_3:"uv3",COLOR_0:"color",WEIGHTS_0:"skinWeight",JOINTS_0:"skinIndex"},Wn={scale:"scale",translation:"position",rotation:"quaternion",weights:"morphTargetInfluences"},ov={CUBICSPLINE:void 0,LINEAR:lr,STEP:Wr},Ko={OPAQUE:"OPAQUE",MASK:"MASK",BLEND:"BLEND"};function av(i){return i.DefaultMaterial===void 0&&(i.DefaultMaterial=new eo({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:On})),i.DefaultMaterial}function pi(i,e,t){for(const n in t.extensions)i[n]===void 0&&(e.userData.gltfExtensions=e.userData.gltfExtensions||{},e.userData.gltfExtensions[n]=t.extensions[n])}function Yn(i,e){e.extras!==void 0&&(typeof e.extras=="object"?Object.assign(i.userData,e.extras):console.warn("THREE.GLTFLoader: Ignoring primitive type .extras, "+e.extras))}function lv(i,e,t){let n=!1,r=!1,s=!1;for(let c=0,u=e.length;c<u;c++){const h=e[c];if(h.POSITION!==void 0&&(n=!0),h.NORMAL!==void 0&&(r=!0),h.COLOR_0!==void 0&&(s=!0),n&&r&&s)break}if(!n&&!r&&!s)return Promise.resolve(i);const o=[],a=[],l=[];for(let c=0,u=e.length;c<u;c++){const h=e[c];if(n){const d=h.POSITION!==void 0?t.getDependency("accessor",h.POSITION):i.attributes.position;o.push(d)}if(r){const d=h.NORMAL!==void 0?t.getDependency("accessor",h.NORMAL):i.attributes.normal;a.push(d)}if(s){const d=h.COLOR_0!==void 0?t.getDependency("accessor",h.COLOR_0):i.attributes.color;l.push(d)}}return Promise.all([Promise.all(o),Promise.all(a),Promise.all(l)]).then(function(c){const u=c[0],h=c[1],d=c[2];return n&&(i.morphAttributes.position=u),r&&(i.morphAttributes.normal=h),s&&(i.morphAttributes.color=d),i.morphTargetsRelative=!0,i})}function cv(i,e){if(i.updateMorphTargets(),e.weights!==void 0)for(let t=0,n=e.weights.length;t<n;t++)i.morphTargetInfluences[t]=e.weights[t];if(e.extras&&Array.isArray(e.extras.targetNames)){const t=e.extras.targetNames;if(i.morphTargetInfluences.length===t.length){i.morphTargetDictionary={};for(let n=0,r=t.length;n<r;n++)i.morphTargetDictionary[t[n]]=n}else console.warn("THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.")}}function uv(i){let e;const t=i.extensions&&i.extensions[je.KHR_DRACO_MESH_COMPRESSION];if(t?e="draco:"+t.bufferView+":"+t.indices+":"+Zo(t.attributes):e=i.indices+":"+Zo(i.attributes)+":"+i.mode,i.targets!==void 0)for(let n=0,r=i.targets.length;n<r;n++)e+=":"+Zo(i.targets[n]);return e}function Zo(i){let e="";const t=Object.keys(i).sort();for(let n=0,r=t.length;n<r;n++)e+=t[n]+":"+i[t[n]]+";";return e}function Sa(i){switch(i){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw new Error("THREE.GLTFLoader: Unsupported normalized accessor component type.")}}function hv(i){return i.search(/\.jpe?g($|\?)/i)>0||i.search(/^data\:image\/jpeg/)===0?"image/jpeg":i.search(/\.webp($|\?)/i)>0||i.search(/^data\:image\/webp/)===0?"image/webp":"image/png"}const dv=new We;class fv{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new O0,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,r=!1,s=-1;typeof navigator<"u"&&(n=/^((?!chrome|android).)*safari/i.test(navigator.userAgent)===!0,r=navigator.userAgent.indexOf("Firefox")>-1,s=r?navigator.userAgent.match(/Firefox\/([0-9]+)\./)[1]:-1),typeof createImageBitmap>"u"||n||r&&s<98?this.textureLoader=new th(this.options.manager):this.textureLoader=new m0(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new eh(this.options.manager),this.fileLoader.setResponseType("arraybuffer"),this.options.crossOrigin==="use-credentials"&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){const n=this,r=this.json,s=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(o){return o._markDefs&&o._markDefs()}),Promise.all(this._invokeAll(function(o){return o.beforeRoot&&o.beforeRoot()})).then(function(){return Promise.all([n.getDependencies("scene"),n.getDependencies("animation"),n.getDependencies("camera")])}).then(function(o){const a={scene:o[0][r.scene||0],scenes:o[0],animations:o[1],cameras:o[2],asset:r.asset,parser:n,userData:{}};return pi(s,a,r),Yn(a,r),Promise.all(n._invokeAll(function(l){return l.afterRoot&&l.afterRoot(a)})).then(function(){e(a)})}).catch(t)}_markDefs(){const e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let r=0,s=t.length;r<s;r++){const o=t[r].joints;for(let a=0,l=o.length;a<l;a++)e[o[a]].isBone=!0}for(let r=0,s=e.length;r<s;r++){const o=e[r];o.mesh!==void 0&&(this._addNodeRef(this.meshCache,o.mesh),o.skin!==void 0&&(n[o.mesh].isSkinnedMesh=!0)),o.camera!==void 0&&this._addNodeRef(this.cameraCache,o.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;const r=n.clone(),s=(o,a)=>{const l=this.associations.get(o);l!=null&&this.associations.set(a,l);for(const[c,u]of o.children.entries())s(u,a.children[c])};return s(n,r),r.name+="_instance_"+e.uses[t]++,r}_invokeOne(e){const t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){const r=e(t[n]);if(r)return r}return null}_invokeAll(e){const t=Object.values(this.plugins);t.unshift(this);const n=[];for(let r=0;r<t.length;r++){const s=e(t[r]);s&&n.push(s)}return n}getDependency(e,t){const n=e+":"+t;let r=this.cache.get(n);if(!r){switch(e){case"scene":r=this.loadScene(t);break;case"node":r=this._invokeOne(function(s){return s.loadNode&&s.loadNode(t)});break;case"mesh":r=this._invokeOne(function(s){return s.loadMesh&&s.loadMesh(t)});break;case"accessor":r=this.loadAccessor(t);break;case"bufferView":r=this._invokeOne(function(s){return s.loadBufferView&&s.loadBufferView(t)});break;case"buffer":r=this.loadBuffer(t);break;case"material":r=this._invokeOne(function(s){return s.loadMaterial&&s.loadMaterial(t)});break;case"texture":r=this._invokeOne(function(s){return s.loadTexture&&s.loadTexture(t)});break;case"skin":r=this.loadSkin(t);break;case"animation":r=this._invokeOne(function(s){return s.loadAnimation&&s.loadAnimation(t)});break;case"camera":r=this.loadCamera(t);break;default:if(r=this._invokeOne(function(s){return s!=this&&s.getDependency&&s.getDependency(e,t)}),!r)throw new Error("Unknown type: "+e);break}this.cache.add(n,r)}return r}getDependencies(e){let t=this.cache.get(e);if(!t){const n=this,r=this.json[e+(e==="mesh"?"es":"s")]||[];t=Promise.all(r.map(function(s,o){return n.getDependency(e,o)})),this.cache.add(e,t)}return t}loadBuffer(e){const t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!=="arraybuffer")throw new Error("THREE.GLTFLoader: "+t.type+" buffer type is not supported.");if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[je.KHR_BINARY_GLTF].body);const r=this.options;return new Promise(function(s,o){n.load(kr.resolveURL(t.uri,r.path),s,void 0,function(){o(new Error('THREE.GLTFLoader: Failed to load buffer "'+t.uri+'".'))})})}loadBufferView(e){const t=this.json.bufferViews[e];return this.getDependency("buffer",t.buffer).then(function(n){const r=t.byteLength||0,s=t.byteOffset||0;return n.slice(s,s+r)})}loadAccessor(e){const t=this,n=this.json,r=this.json.accessors[e];if(r.bufferView===void 0&&r.sparse===void 0){const o=jo[r.type],a=tr[r.componentType],l=r.normalized===!0,c=new a(r.count*o);return Promise.resolve(new wt(c,o,l))}const s=[];return r.bufferView!==void 0?s.push(this.getDependency("bufferView",r.bufferView)):s.push(null),r.sparse!==void 0&&(s.push(this.getDependency("bufferView",r.sparse.indices.bufferView)),s.push(this.getDependency("bufferView",r.sparse.values.bufferView))),Promise.all(s).then(function(o){const a=o[0],l=jo[r.type],c=tr[r.componentType],u=c.BYTES_PER_ELEMENT,h=u*l,d=r.byteOffset||0,m=r.bufferView!==void 0?n.bufferViews[r.bufferView].byteStride:void 0,g=r.normalized===!0;let _,p;if(m&&m!==h){const f=Math.floor(d/m),E="InterleavedBuffer:"+r.bufferView+":"+r.componentType+":"+f+":"+r.count;let M=t.cache.get(E);M||(_=new c(a,f*m,r.count*m/u),M=new z_(_,m/u),t.cache.add(E,M)),p=new Ba(M,l,d%m/u,g)}else a===null?_=new c(r.count*l):_=new c(a,d,r.count*l),p=new wt(_,l,g);if(r.sparse!==void 0){const f=jo.SCALAR,E=tr[r.sparse.indices.componentType],M=r.sparse.indices.byteOffset||0,b=r.sparse.values.byteOffset||0,C=new E(o[1],M,r.sparse.count*f),R=new c(o[2],b,r.sparse.count*l);a!==null&&(p=new wt(p.array.slice(),p.itemSize,p.normalized));for(let A=0,z=C.length;A<z;A++){const x=C[A];if(p.setX(x,R[A*l]),l>=2&&p.setY(x,R[A*l+1]),l>=3&&p.setZ(x,R[A*l+2]),l>=4&&p.setW(x,R[A*l+3]),l>=5)throw new Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.")}}return p})}loadTexture(e){const t=this.json,n=this.options,s=t.textures[e].source,o=t.images[s];let a=this.textureLoader;if(o.uri){const l=n.manager.getHandler(o.uri);l!==null&&(a=l)}return this.loadTextureImage(e,s,a)}loadTextureImage(e,t,n){const r=this,s=this.json,o=s.textures[e],a=s.images[t],l=(a.uri||a.bufferView)+":"+o.sampler;if(this.textureCache[l])return this.textureCache[l];const c=this.loadImageSource(t,n).then(function(u){u.flipY=!1,u.name=o.name||a.name||"",u.name===""&&typeof a.uri=="string"&&a.uri.startsWith("data:image/")===!1&&(u.name=a.uri);const d=(s.samplers||{})[o.sampler]||{};return u.magFilter=Zc[d.magFilter]||pt,u.minFilter=Zc[d.minFilter]||Ai,u.wrapS=$c[d.wrapS]||oi,u.wrapT=$c[d.wrapT]||oi,r.associations.set(u,{textures:e}),u}).catch(function(){return null});return this.textureCache[l]=c,c}loadImageSource(e,t){const n=this,r=this.json,s=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(h=>h.clone());const o=r.images[e],a=self.URL||self.webkitURL;let l=o.uri||"",c=!1;if(o.bufferView!==void 0)l=n.getDependency("bufferView",o.bufferView).then(function(h){c=!0;const d=new Blob([h],{type:o.mimeType});return l=a.createObjectURL(d),l});else if(o.uri===void 0)throw new Error("THREE.GLTFLoader: Image "+e+" is missing URI and bufferView");const u=Promise.resolve(l).then(function(h){return new Promise(function(d,m){let g=d;t.isImageBitmapLoader===!0&&(g=function(_){const p=new vt(_);p.needsUpdate=!0,d(p)}),t.load(kr.resolveURL(h,s.path),g,void 0,m)})}).then(function(h){return c===!0&&a.revokeObjectURL(l),h.userData.mimeType=o.mimeType||hv(o.uri),h}).catch(function(h){throw console.error("THREE.GLTFLoader: Couldn't load texture",l),h});return this.sourceCache[e]=u,u}assignTexture(e,t,n,r){const s=this;return this.getDependency("texture",n.index).then(function(o){if(!o)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(o=o.clone(),o.channel=n.texCoord),s.extensions[je.KHR_TEXTURE_TRANSFORM]){const a=n.extensions!==void 0?n.extensions[je.KHR_TEXTURE_TRANSFORM]:void 0;if(a){const l=s.associations.get(o);o=s.extensions[je.KHR_TEXTURE_TRANSFORM].extendTexture(o,a),s.associations.set(o,l)}}return r!==void 0&&(o.colorSpace=r),e[t]=o,o})}assignFinalMaterial(e){const t=e.geometry;let n=e.material;const r=t.attributes.tangent===void 0,s=t.attributes.color!==void 0,o=t.attributes.normal===void 0;if(e.isPoints){const a="PointsMaterial:"+n.uuid;let l=this.cache.get(a);l||(l=new Hr,xn.prototype.copy.call(l,n),l.color.copy(n.color),l.map=n.map,l.sizeAttenuation=!1,this.cache.add(a,l)),n=l}else if(e.isLine){const a="LineBasicMaterial:"+n.uuid;let l=this.cache.get(a);l||(l=new Zu,xn.prototype.copy.call(l,n),l.color.copy(n.color),l.map=n.map,this.cache.add(a,l)),n=l}if(r||s||o){let a="ClonedMaterial:"+n.uuid+":";r&&(a+="derivative-tangents:"),s&&(a+="vertex-colors:"),o&&(a+="flat-shading:");let l=this.cache.get(a);l||(l=n.clone(),s&&(l.vertexColors=!0),o&&(l.flatShading=!0),r&&(l.normalScale&&(l.normalScale.y*=-1),l.clearcoatNormalScale&&(l.clearcoatNormalScale.y*=-1)),this.cache.add(a,l),this.associations.set(l,this.associations.get(n))),n=l}e.material=n}getMaterialType(){return eo}loadMaterial(e){const t=this,n=this.json,r=this.extensions,s=n.materials[e];let o;const a={},l=s.extensions||{},c=[];if(l[je.KHR_MATERIALS_UNLIT]){const h=r[je.KHR_MATERIALS_UNLIT];o=h.getMaterialType(),c.push(h.extendParams(a,s,t))}else{const h=s.pbrMetallicRoughness||{};if(a.color=new we(1,1,1),a.opacity=1,Array.isArray(h.baseColorFactor)){const d=h.baseColorFactor;a.color.setRGB(d[0],d[1],d[2],Rt),a.opacity=d[3]}h.baseColorTexture!==void 0&&c.push(t.assignTexture(a,"map",h.baseColorTexture,Qe)),a.metalness=h.metallicFactor!==void 0?h.metallicFactor:1,a.roughness=h.roughnessFactor!==void 0?h.roughnessFactor:1,h.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(a,"metalnessMap",h.metallicRoughnessTexture)),c.push(t.assignTexture(a,"roughnessMap",h.metallicRoughnessTexture))),o=this._invokeOne(function(d){return d.getMaterialType&&d.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(d){return d.extendMaterialParams&&d.extendMaterialParams(e,a)})))}s.doubleSided===!0&&(a.side=_n);const u=s.alphaMode||Ko.OPAQUE;if(u===Ko.BLEND?(a.transparent=!0,a.depthWrite=!1):(a.transparent=!1,u===Ko.MASK&&(a.alphaTest=s.alphaCutoff!==void 0?s.alphaCutoff:.5)),s.normalTexture!==void 0&&o!==Mi&&(c.push(t.assignTexture(a,"normalMap",s.normalTexture)),a.normalScale=new be(1,1),s.normalTexture.scale!==void 0)){const h=s.normalTexture.scale;a.normalScale.set(h,h)}if(s.occlusionTexture!==void 0&&o!==Mi&&(c.push(t.assignTexture(a,"aoMap",s.occlusionTexture)),s.occlusionTexture.strength!==void 0&&(a.aoMapIntensity=s.occlusionTexture.strength)),s.emissiveFactor!==void 0&&o!==Mi){const h=s.emissiveFactor;a.emissive=new we().setRGB(h[0],h[1],h[2],Rt)}return s.emissiveTexture!==void 0&&o!==Mi&&c.push(t.assignTexture(a,"emissiveMap",s.emissiveTexture,Qe)),Promise.all(c).then(function(){const h=new o(a);return s.name&&(h.name=s.name),Yn(h,s),t.associations.set(h,{materials:e}),s.extensions&&pi(r,h,s),h})}createUniqueName(e){const t=Je.sanitizeNodeName(e||"");return t in this.nodeNamesUsed?t+"_"+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){const t=this,n=this.extensions,r=this.primitiveCache;function s(a){return n[je.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(a,t).then(function(l){return Jc(l,a,t)})}const o=[];for(let a=0,l=e.length;a<l;a++){const c=e[a],u=uv(c),h=r[u];if(h)o.push(h.promise);else{let d;c.extensions&&c.extensions[je.KHR_DRACO_MESH_COMPRESSION]?d=s(c):d=Jc(new qt,c,t),r[u]={primitive:c,promise:d},o.push(d)}}return Promise.all(o)}loadMesh(e){const t=this,n=this.json,r=this.extensions,s=n.meshes[e],o=s.primitives,a=[];for(let l=0,c=o.length;l<c;l++){const u=o[l].material===void 0?av(this.cache):this.getDependency("material",o[l].material);a.push(u)}return a.push(t.loadGeometries(o)),Promise.all(a).then(function(l){const c=l.slice(0,l.length-1),u=l[l.length-1],h=[];for(let m=0,g=u.length;m<g;m++){const _=u[m],p=o[m];let f;const E=c[m];if(p.mode===Jt.TRIANGLES||p.mode===Jt.TRIANGLE_STRIP||p.mode===Jt.TRIANGLE_FAN||p.mode===void 0)f=s.isSkinnedMesh===!0?new V_(_,E):new Ht(_,E),f.isSkinnedMesh===!0&&f.normalizeSkinWeights(),p.mode===Jt.TRIANGLE_STRIP?f.geometry=jc(f.geometry,Au):p.mode===Jt.TRIANGLE_FAN&&(f.geometry=jc(f.geometry,fa));else if(p.mode===Jt.LINES)f=new j_(_,E);else if(p.mode===Jt.LINE_STRIP)f=new ka(_,E);else if(p.mode===Jt.LINE_LOOP)f=new K_(_,E);else if(p.mode===Jt.POINTS)f=new Us(_,E);else throw new Error("THREE.GLTFLoader: Primitive mode unsupported: "+p.mode);Object.keys(f.geometry.morphAttributes).length>0&&cv(f,s),f.name=t.createUniqueName(s.name||"mesh_"+e),Yn(f,s),p.extensions&&pi(r,f,p),t.assignFinalMaterial(f),h.push(f)}for(let m=0,g=h.length;m<g;m++)t.associations.set(h[m],{meshes:e,primitives:m});if(h.length===1)return s.extensions&&pi(r,h[0],s),h[0];const d=new $n;s.extensions&&pi(r,d,s),t.associations.set(d,{meshes:e});for(let m=0,g=h.length;m<g;m++)d.add(h[m]);return d})}loadCamera(e){let t;const n=this.json.cameras[e],r=n[n.type];if(!r){console.warn("THREE.GLTFLoader: Missing camera parameters.");return}return n.type==="perspective"?t=new Bt(Zn.radToDeg(r.yfov),r.aspectRatio||1,r.znear||1,r.zfar||2e6):n.type==="orthographic"&&(t=new Js(-r.xmag,r.xmag,r.ymag,-r.ymag,r.znear,r.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),Yn(t,n),Promise.resolve(t)}loadSkin(e){const t=this.json.skins[e],n=[];for(let r=0,s=t.joints.length;r<s;r++)n.push(this._loadNodeShallow(t.joints[r]));return t.inverseBindMatrices!==void 0?n.push(this.getDependency("accessor",t.inverseBindMatrices)):n.push(null),Promise.all(n).then(function(r){const s=r.pop(),o=r,a=[],l=[];for(let c=0,u=o.length;c<u;c++){const h=o[c];if(h){a.push(h);const d=new We;s!==null&&d.fromArray(s.array,c*16),l.push(d)}else console.warn('THREE.GLTFLoader: Joint "%s" could not be found.',t.joints[c])}return new Ha(a,l)})}loadAnimation(e){const t=this.json,n=this,r=t.animations[e],s=r.name?r.name:"animation_"+e,o=[],a=[],l=[],c=[],u=[];for(let h=0,d=r.channels.length;h<d;h++){const m=r.channels[h],g=r.samplers[m.sampler],_=m.target,p=_.node,f=r.parameters!==void 0?r.parameters[g.input]:g.input,E=r.parameters!==void 0?r.parameters[g.output]:g.output;_.node!==void 0&&(o.push(this.getDependency("node",p)),a.push(this.getDependency("accessor",f)),l.push(this.getDependency("accessor",E)),c.push(g),u.push(_))}return Promise.all([Promise.all(o),Promise.all(a),Promise.all(l),Promise.all(c),Promise.all(u)]).then(function(h){const d=h[0],m=h[1],g=h[2],_=h[3],p=h[4],f=[];for(let E=0,M=d.length;E<M;E++){const b=d[E],C=m[E],R=g[E],A=_[E],z=p[E];if(b===void 0)continue;b.updateMatrix&&b.updateMatrix();const x=n._createAnimationTracks(b,C,R,A,z);if(x)for(let T=0;T<x.length;T++)f.push(x[T])}return new n0(s,void 0,f)})}createNodeMesh(e){const t=this.json,n=this,r=t.nodes[e];return r.mesh===void 0?null:n.getDependency("mesh",r.mesh).then(function(s){const o=n._getNodeRef(n.meshCache,r.mesh,s);return r.weights!==void 0&&o.traverse(function(a){if(a.isMesh)for(let l=0,c=r.weights.length;l<c;l++)a.morphTargetInfluences[l]=r.weights[l]}),o})}loadNode(e){const t=this.json,n=this,r=t.nodes[e],s=n._loadNodeShallow(e),o=[],a=r.children||[];for(let c=0,u=a.length;c<u;c++)o.push(n.getDependency("node",a[c]));const l=r.skin===void 0?Promise.resolve(null):n.getDependency("skin",r.skin);return Promise.all([s,Promise.all(o),l]).then(function(c){const u=c[0],h=c[1],d=c[2];d!==null&&u.traverse(function(m){m.isSkinnedMesh&&m.bind(d,dv)});for(let m=0,g=h.length;m<g;m++)u.add(h[m]);return u})}_loadNodeShallow(e){const t=this.json,n=this.extensions,r=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];const s=t.nodes[e],o=s.name?r.createUniqueName(s.name):"",a=[],l=r._invokeOne(function(c){return c.createNodeMesh&&c.createNodeMesh(e)});return l&&a.push(l),s.camera!==void 0&&a.push(r.getDependency("camera",s.camera).then(function(c){return r._getNodeRef(r.cameraCache,s.camera,c)})),r._invokeAll(function(c){return c.createNodeAttachment&&c.createNodeAttachment(e)}).forEach(function(c){a.push(c)}),this.nodeCache[e]=Promise.all(a).then(function(c){let u;if(s.isBone===!0?u=new Ku:c.length>1?u=new $n:c.length===1?u=c[0]:u=new nt,u!==c[0])for(let h=0,d=c.length;h<d;h++)u.add(c[h]);if(s.name&&(u.userData.name=s.name,u.name=o),Yn(u,s),s.extensions&&pi(n,u,s),s.matrix!==void 0){const h=new We;h.fromArray(s.matrix),u.applyMatrix4(h)}else s.translation!==void 0&&u.position.fromArray(s.translation),s.rotation!==void 0&&u.quaternion.fromArray(s.rotation),s.scale!==void 0&&u.scale.fromArray(s.scale);return r.associations.has(u)||r.associations.set(u,{}),r.associations.get(u).nodes=e,u}),this.nodeCache[e]}loadScene(e){const t=this.extensions,n=this.json.scenes[e],r=this,s=new $n;n.name&&(s.name=r.createUniqueName(n.name)),Yn(s,n),n.extensions&&pi(t,s,n);const o=n.nodes||[],a=[];for(let l=0,c=o.length;l<c;l++)a.push(r.getDependency("node",o[l]));return Promise.all(a).then(function(l){for(let u=0,h=l.length;u<h;u++)s.add(l[u]);const c=u=>{const h=new Map;for(const[d,m]of r.associations)(d instanceof xn||d instanceof vt)&&h.set(d,m);return u.traverse(d=>{const m=r.associations.get(d);m!=null&&h.set(d,m)}),h};return r.associations=c(s),s})}_createAnimationTracks(e,t,n,r,s){const o=[],a=e.name?e.name:e.uuid,l=[];Wn[s.path]===Wn.weights?e.traverse(function(d){d.morphTargetInfluences&&l.push(d.name?d.name:d.uuid)}):l.push(a);let c;switch(Wn[s.path]){case Wn.weights:c=hr;break;case Wn.rotation:c=Ri;break;case Wn.position:case Wn.scale:c=dr;break;default:switch(n.itemSize){case 1:c=hr;break;case 2:case 3:default:c=dr;break}break}const u=r.interpolation!==void 0?ov[r.interpolation]:lr,h=this._getArrayFromAccessor(n);for(let d=0,m=l.length;d<m;d++){const g=new c(l[d]+"."+Wn[s.path],t.array,h,u);r.interpolation==="CUBICSPLINE"&&this._createCubicSplineTrackInterpolant(g),o.push(g)}return o}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){const n=Sa(t.constructor),r=new Float32Array(t.length);for(let s=0,o=t.length;s<o;s++)r[s]=t[s]*n;t=r}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(n){const r=this instanceof Ri?sv:ih;return new r(this.times,this.values,this.getValueSize()/3,n)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}}function pv(i,e,t){const n=e.attributes,r=new fn;if(n.POSITION!==void 0){const a=t.json.accessors[n.POSITION],l=a.min,c=a.max;if(l!==void 0&&c!==void 0){if(r.set(new P(l[0],l[1],l[2]),new P(c[0],c[1],c[2])),a.normalized){const u=Sa(tr[a.componentType]);r.min.multiplyScalar(u),r.max.multiplyScalar(u)}}else{console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.");return}}else return;const s=e.targets;if(s!==void 0){const a=new P,l=new P;for(let c=0,u=s.length;c<u;c++){const h=s[c];if(h.POSITION!==void 0){const d=t.json.accessors[h.POSITION],m=d.min,g=d.max;if(m!==void 0&&g!==void 0){if(l.setX(Math.max(Math.abs(m[0]),Math.abs(g[0]))),l.setY(Math.max(Math.abs(m[1]),Math.abs(g[1]))),l.setZ(Math.max(Math.abs(m[2]),Math.abs(g[2]))),d.normalized){const _=Sa(tr[d.componentType]);l.multiplyScalar(_)}a.max(l)}else console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.")}}r.expandByVector(a)}i.boundingBox=r;const o=new yn;r.getCenter(o.center),o.radius=r.min.distanceTo(r.max)/2,i.boundingSphere=o}function Jc(i,e,t){const n=e.attributes,r=[];function s(o,a){return t.getDependency("accessor",o).then(function(l){i.setAttribute(a,l)})}for(const o in n){const a=ya[o]||o.toLowerCase();a in i.attributes||r.push(s(n[o],a))}if(e.indices!==void 0&&!i.index){const o=t.getDependency("accessor",e.indices).then(function(a){i.setIndex(a)});r.push(o)}return $e.workingColorSpace!==Rt&&"COLOR_0"in n&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${$e.workingColorSpace}" not supported.`),Yn(i,e),pv(i,e,t),Promise.all(r).then(function(){return e.targets!==void 0?lv(i,e.targets,t):i})}const mv=`varying vec2 vUv;
void main() {
  vUv = uv;
  vec3 pos = position;
...
`,$o=document.getElementById("loading-splash"),_v=document.getElementById("loading-bar-fill"),vv=document.getElementById("loading-text");let Zt={scene:10,overlay:5,lights:5,particles:10,texture1:0,texture2:0,model:0},Xs=!1;function rh(i,e){if(Xs)return;const t=Math.min(Math.max(Math.round(i),0),100);_v.style.width=`${t}%`,e&&(vv.textContent=e)}function Dr(i,e){if(Xs)return;Zt[i]=e;const t=Math.min(Zt.scene+Zt.overlay+Zt.lights+Zt.particles+Zt.texture1+Zt.texture2+Zt.model,100);let n="Cargando...";t<30?n="Preparando escena...":Zt.model<50?n=`Cargando modelo 3D... ${Math.round(Zt.model/50*100)}%`:Zt.texture1<10||Zt.texture2<10?n="Cargando texturas...":n="Listo.",rh(t,n)}function no(i){const e={scene:10,overlay:5,lights:5,particles:10};e[i]!==void 0&&Dr(i,e[i])}function Qc(){Xs||(Xs=!0,rh(100,"Listo."),setTimeout(()=>{$o.classList.add("done"),$o.addEventListener("animationend",()=>$o.remove(),{once:!0})},350))}function Ns(i){const e="kw";let t="";for(let n=0;n<i.length;n+=2){const r=parseInt(i.substring(n,n+2),16),s=e.charCodeAt(n/2%e.length);t+=String.fromCharCode(r^s)}return t}const Ft={mode:"default",slideshow:{images:[],slideDuration:12,transitionDuration:.45}};let Qn=null,bi=null,Mn=null;const eu={};let Q=null,At=null,ot=null,Yt=null,yt=null,ft="",cn="idle",In=0,Yr="#ffffff",nr="center",Zi=1e3;const Ur=new we(11196671),Wa=document.createElement("canvas");Wa.width=1;Wa.height=1;const tu=Wa.getContext("2d",{willReadFrequently:!0});let Qt=!1,Mt=null,$t=null,nu=0,un=null,ir=null,Ys=null,sh=3,oh=5,ah=5,Xt=null;const xv=()=>window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?"ws://localhost:8088":"wss://kimeraware.macrostasis.dev/ws",qs=i=>window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?i:`https://kimeraware.macrostasis.dev${i}`,lh=i=>{const e=window.location.hostname;return e==="localhost"||e==="127.0.0.1"||e.includes("macrostasis.dev")?i:`https://kimeraware.macrostasis.dev${i}`},ch=i=>{if(!i)return i;let e=i;if(i.includes("/assets/")){const t=i.substring(i.indexOf("/assets/"));e=lh(t)}if((e.startsWith("http://")||e.startsWith("https://"))&&!e.includes("/api/yt-proxy")){const t=window.location.hostname;let n=!0;if(t==="localhost"||t==="127.0.0.1")try{const r=new URL(i);(r.hostname==="localhost"||r.hostname==="127.0.0.1")&&(n=!1)}catch{}(e.includes("local=true")||e.includes("/assets/")||e.includes("assets/")||e.includes("piped")||e.includes("cobalt")||e.includes("invidious")||e.includes("yewtu.be")||e.includes("nadeko.net"))&&(n=!1),n&&(e=qs(`/api/yt-proxy?url=${encodeURIComponent(e)}`))}return e+=(e.includes("?")?"&":"?")+"t_cb="+Date.now(),e};function qr(i){return new Promise((e,t)=>{const n=new Image;n.onload=()=>{const s=new vt(n);s.colorSpace=Qe,s.minFilter=pt,s.generateMipmaps=!1,s.needsUpdate=!0,e(s)},n.onerror=s=>{t(s)};let r=i;if(i&&i.includes("/assets/")){const s=i.substring(i.indexOf("/assets/"));r=lh(s)}r&&(r.startsWith("http://")||r.startsWith("https://"))&&(n.crossOrigin="anonymous"),n.src=r})}async function Nr(i){Ft.mode=i.mode||"default",ft=i.text||"",nr=i.textPosition||"center",jr=null,Kr=null,sh=i.minDuration||3,oh=i.maxDuration||5,ah=i.frequencyPerMinute||5,Ea=-1;const e={default:0,green:1,red:2,yellow:3,rainbow:4,custom:5},t=i.filterMode||"default";In=e[t]!==void 0?e[t]:0,Yr=i.filterColor||"#ffffff";const n=i.videoUrl||"",r=typeof i.videoLoop<"u"?i.videoLoop:!0,s=typeof i.videoAudio<"u"?i.videoAudio:!0;if(Ft.mode==="video"?Aa(n,r,s):Aa(null,!1,!1),i.mainImageData){const o=yt;yt=await qr(i.mainImageData),Ft.mode==="custom_image"?cn="custom_image":cn="idle",o&&o.dispose()}else cn="idle",yt&&yt.dispose(),yt=null;if(i.childImageData){const o=bi;bi=await qr(i.childImageData),o&&o!==Qn&&o!==Ys&&o.dispose()}else bi=Ys||Qn}function uh(i,e){if(!Q||Q.paused||!i)return;let t=(Date.now()-i)/1e3;const n=e||1/0;if(t<0||t>=n)return;Q.duration&&Q.loop&&(t=t%Q.duration);const r=Math.abs(Q.currentTime-t);r>.5&&(console.log(`[Sync] Drift detected: ${r.toFixed(2)}s — correcting to ${t.toFixed(2)}s`),Q.currentTime=t)}function hh(){ir&&clearInterval(ir),ir=setInterval(()=>{if(!Qt||!un){js();return}uh(un.startTime,un.originalDuration)},2e3)}function js(){ir&&(clearInterval(ir),ir=null)}let Ls=null;async function Mv(){if(Ls)return Ls;const i="75,87,95,65,82,71",e=new Uint8Array(i.split(",").map(Number)),t=new TextEncoder().encode("kimeraware-ws-2025"),n=await crypto.subtle.importKey("raw",e,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),r=await crypto.subtle.sign("HMAC",n,t);return Ls=await crypto.subtle.importKey("raw",r,{name:"AES-GCM"},!1,["decrypt"]),Ls}async function yv(i){try{const e=Uint8Array.from(atob(i),l=>l.charCodeAt(0)),t=e.slice(0,12),n=e.slice(12,28),r=e.slice(28),s=new Uint8Array(r.length+16);s.set(r),s.set(n,r.length);const o=await Mv(),a=await crypto.subtle.decrypt({name:"AES-GCM",iv:t},o,s);return JSON.parse(new TextDecoder().decode(a))}catch(e){try{return JSON.parse(i)}catch{throw e}}}function Xa(){const i=xv();Yt=new WebSocket(i),Yt.onopen=()=>{console.log("Connected to KimeraWare Event Server"),Zi=1e3},Yt.onmessage=async t=>{try{const n=await yv(t.data);console.log("WS Event received:",n.type),await e(n)}catch(n){console.error("Error handling WS event:",n)}finally{Xt&&(Xt(),Xt=null)}};async function e(t){if(jr=null,Kr=null,t.type==="apply_preset"){if($t=t,t.textPosition&&(nr=t.textPosition),Qt){console.log("Immediate video is active. Storing preset for later restoration.");return}await Nr(t)}if(t.type==="trigger_video"){console.log("WS Event received: trigger_video",t),Qt||$t||($t={type:"apply_preset",presetId:"default",mode:"default",text:"",filterMode:"default",filterColor:"#ffffff",videoUrl:"",videoLoop:!0,videoAudio:!0,minDuration:2,maxDuration:4,frequencyPerMinute:3,mainImageData:null,childImageData:null});const n=parseFloat(t.originalDuration)||parseFloat(t.duration)||30,r=parseFloat(t.duration)||30;let s=0;if(t.startTime?s=Math.max(0,(Date.now()-t.startTime)/1e3):s=Math.max(0,n-r),s>=n){console.log(`Video override already expired (${s.toFixed(1)}s / ${n}s). Skipping.`);return}const o=Date.now()-t.startTime<5e3,a=performance.now(),l=++nu;let c=t.videoUrl||"";const u=dh(c);if(u){console.log("Resolving general YouTube ID for immediate video:",u);try{c=await fh(u)}catch(p){console.error("Failed to resolve stream for immediate video:",p),cn="idle",ft="";return}}if(l!==nu){console.log("Immediate video trigger superseded by a newer request.");return}ot&&(ot.destroy(),ot=null),Q&&(Q.pause(),Q.removeAttribute("src"),Q.load());let h=!1;Q||(Q=document.createElement("video"),Q.preload="auto",Q.playsInline=!0,Q.webkitPlaysInline=!0,Q.crossOrigin="anonymous",h=!0),Q.loop=typeof t.videoLoop<"u"?t.videoLoop:!0,Q.muted=typeof t.videoAudio<"u"?!t.videoAudio:!0,Q.dataset.shouldPlayAudio=typeof t.videoAudio<"u"?!!t.videoAudio:!0;let d=!1;const m=()=>{if(!d&&(d=!0,!o)){const p=(performance.now()-a)/1e3,f=t.startTime?Math.max(0,(Date.now()-t.startTime)/1e3):s+p;f>0&&f<n&&(console.log(`[Seek] Jumping to ${f.toFixed(2)}s (load delay: ${p.toFixed(2)}s)`),Q.currentTime=f)}};Q.addEventListener("loadedmetadata",m,{once:!0}),Q.addEventListener("canplay",m,{once:!0}),Q.crossOrigin="anonymous";const g=ch(c);if(g.includes(".m3u8")&&typeof Hls<"u"?Hls.isSupported()?(ot=new Hls({maxBufferLength:8,maxMaxBufferLength:12,enableWorker:!0,lowLatencyMode:!0}),ot.loadSource(g),ot.attachMediaElement(Q),ot.on(Hls.Events.MANIFEST_PARSED,()=>{console.log("[HLS.js WS] Manifest loaded, playing...")}),ot.on(Hls.Events.ERROR,(p,f)=>{if(f.fatal)switch(f.type){case Hls.ErrorTypes.NETWORK_ERROR:console.warn("[HLS.js WS] Network error, attempting recovery...",f),ot.startLoad();break;case Hls.ErrorTypes.MEDIA_ERROR:console.warn("[HLS.js WS] Media error, attempting recovery...",f),ot.recoverMediaError();break;default:console.error("[HLS.js WS] Unrecoverable error",f);break}})):Q.canPlayType("application/vnd.apple.mpegurl")&&(Q.src=g,Q.load()):(Q.src=g,Q.load()),Q.loop||Q.addEventListener("ended",async()=>{console.log("Immediate video ended naturally. Reverting to active preset locally."),Qt=!1,Mt&&(clearTimeout(Mt),Mt=null),$t&&await Nr($t)}),h)try{qa(Q)}catch(p){console.error("Audio filter setup failed:",p)}At||(At=new $u(Q),At.colorSpace=Qe,At.minFilter=pt,At.generateMipmaps=!1);const _=()=>{cn="idle",Qt=!0,Ft.mode="video",ft=t.text||"",nr=t.textPosition||"center",Mt&&clearTimeout(Mt);let p;if(o){if(p=n,Yt&&Yt.readyState===WebSocket.OPEN)try{Yt.send(JSON.stringify({type:"video_playing",videoUrl:t.videoUrl||c,originalDuration:n})),console.log("[WebSocket] Sent video_playing confirmation to server.")}catch(f){console.error("[WebSocket] Failed to send video_playing confirmation:",f)}}else t.startTime?p=Math.max(.1,n-(Date.now()-t.startTime)/1e3):p=Math.max(.1,n-s);o||(un={startTime:t.startTime,originalDuration:n},hh()),Mt=setTimeout(()=>{console.log("Immediate video override duration expired. Reverting to active preset."),Qt=!1,Mt=null,js(),un=null,$t&&Nr($t)},p*1e3)};Q.addEventListener("playing",_,{once:!0}),Q.play().then(()=>{console.log("Immediate video play started successfully.")}).catch(p=>{console.log("Immediate video autoplay blocked. Retrying with mute...",p),Q.muted=!0,Q.play().then(()=>{console.log("Muted fallback autoplay succeeded! Click to unmute listener added.");const f=()=>{Q.muted=typeof t.videoAudio<"u"?!t.videoAudio:!1,at&&at.state==="suspended"&&at.resume(),console.log("User interacted. Restored original audio state."),document.removeEventListener("click",f),document.removeEventListener("keydown",f),document.removeEventListener("touchstart",f)};document.addEventListener("click",f),document.addEventListener("keydown",f),document.addEventListener("touchstart",f)}).catch(f=>{console.error("Even muted autoplay failed:",f),_()})})}if(t.type==="video_sync"&&Q&&Qt&&t.startTime&&uh(t.startTime,t.originalDuration),t.type==="trigger_static"){cn="static";const n=t.duration||1;setTimeout(()=>{cn="idle"},n*1e3)}if(t.type==="image"&&t.imageData){const n=yt;yt=await qr(t.imageData),cn="custom_image",n&&n.dispose()}if(t.type==="text"&&(ft=t.text||"",t.textPosition&&(nr=t.textPosition),jr=null,Kr=null),t.type==="filter"){const n={default:0,green:1,red:2,yellow:3,rainbow:4,custom:5},r=t.filterMode||"default";In=n[r]!==void 0?n[r]:0,Yr=t.filterColor||"#ffffff"}t.type==="reset"&&(Qt=!1,Mt&&(clearTimeout(Mt),Mt=null),js(),un=null,cn="idle",ft="",In=0,Yr="#ffffff",Aa(null,!1,!1),yt&&yt.dispose(),yt=null,bi=Ys||Qn,$t&&(console.log("Reset received. Restoring last applied preset:",$t),await Nr($t))),t.type==="trigger_easter_egg"&&(Qt=!1,Mt&&(clearTimeout(Mt),Mt=null),t.imageData?qr(t.imageData).then(n=>{Mn&&Mn.dispose(),Mn=n,jn(t)}).catch(()=>jn(t)):jn(t))}Yt.onclose=()=>{console.log(`WS connection closed. Reconnecting in ${Zi}ms...`),Xt&&(Xt(),Xt=null),setTimeout(()=>{Xa(),Zi=Math.min(Zi*2,4e3)},Zi)},Yt.onerror=t=>{console.error("WS error:",t),Xt&&(Xt(),Xt=null)}}document.addEventListener("visibilitychange",()=>{if(document.visibilityState==="visible"){if(console.log("[Visibility] Tab is visible again — checking sync..."),!Yt||Yt.readyState===WebSocket.CLOSED||Yt.readyState===WebSocket.CLOSING){console.log("[Visibility] WS was closed. Reconnecting now..."),Zi=1e3,Xa();return}if(Qt&&un&&un.startTime){console.log("[Visibility] Forcing immediate video resync.");const i=(Date.now()-un.startTime)/1e3;if(i>=un.originalDuration)console.log("[Visibility] Video expired while backgrounded. Reverting to preset."),Qt=!1,Mt&&(clearTimeout(Mt),Mt=null),js(),un=null,$t&&Nr($t);else if(Q){const e=Math.abs(Q.currentTime-i);console.log(`[Visibility] Drift: ${e.toFixed(2)}s → correcting to ${i.toFixed(2)}s`),Q.currentTime=i,Q.paused&&Q.play().catch(()=>{})}hh()}}});const gn=document.createElement("canvas");gn.width=1024;gn.height=1586;const mi=gn.getContext("2d"),ei=new $r(gn);ei.colorSpace=Qe;ei.minFilter=pt;ei.generateMipmaps=!1;const fr=document.createElement("canvas");fr.width=256;fr.height=256;const iu=fr.getContext("2d"),Ut=new $r(fr);Ut.colorSpace=Qe;Ut.wrapS=oi;Ut.wrapT=oi;Ut.minFilter=_t;Ut.magFilter=_t;Ut.generateMipmaps=!1;let Ps=null;const ti=document.createElement("canvas");ti.width=1024;ti.height=1024;const Wt=ti.getContext("2d"),Mr=new $r(ti);Mr.colorSpace=Qe;Mr.minFilter=pt;Mr.generateMipmaps=!1;let Jo=0,Lr=0,Ea=-1,Qo=[],ea=0,xt=!1,qn="idle",an=0;const ru=.3;let Ta=7,ta=0,na={};function jn(i){qn==="idle"&&(na=i||{},typeof na.duration=="number"?Ta=na.duration:Ta=7,qn="transition_in",an=0,xt=!0)}window[Ns("1f0502100c1219320a041f1219320c10")]=async function(){try{const i=await fetch(qs("/api/mx-cfg"));if(!i.ok){jn({});return}const e=await i.json();e.imageData?qr(e.imageData).then(t=>{Mn&&Mn.dispose(),Mn=t,jn(e)}).catch(()=>jn(e)):jn(e)}catch(i){console.error("[Macrostasis]",i),jn({})}};function Xn(){Ps||(Ps=iu.createImageData(fr.width,fr.height));const i=Ps.data,e=i.length;for(let t=0;t<e;t+=4){const n=Math.floor(Math.random()*255);i[t]=n,i[t+1]=n,i[t+2]=n,i[t+3]=255}iu.putImageData(Ps,0,0),Ut.needsUpdate=!0}const ba='"Sixtyfour", "SLNTHLN", monospace';function Sv(i,e,t,n){e.font=`${n}px ${ba}`;const r=i.split(`
`),s=[];for(const o of r){if(o.trim()===""){s.push("");continue}const a=o.split(" ");let l="";for(let c=0;c<a.length;c++){const u=a[c];if(u==="")continue;const h=l?l+" "+u:u;e.measureText(h).width>t?l?(s.push(l),l=u):(s.push(u),l=""):l=h}l&&s.push(l)}return s}let jr=null,Kr=null;function dt(i,e){const t=e||nr||"center";if(!(i===jr&&t===Kr)){if(jr=i,Kr=t,Wt.clearRect(0,0,ti.width,ti.height),i){Wt.save(),Wt.fillStyle="#ffffff",Wt.shadowColor="#ffffff";const n=850,r=850,s=16;let o=64,a=[],l=0,c=0;for(;o>=s;){if(l=Math.floor(o*1.35),a=Sv(i,Wt,n,o),c=a.length*l,c<=r){let p=!0;Wt.font=`${o}px ${ba}`;for(const f of a)if(Wt.measureText(f).width>n){p=!1;break}if(p)break}o-=2}Wt.font=`${o}px ${ba}`,Wt.shadowBlur=Math.max(2,Math.floor(o*.15));const u=40,h=ti.width,d=ti.height;let m,g,_;switch(t){case"top-left":m=u,g=u+l/2,_="left";break;case"top-right":m=h-u,g=u+l/2,_="right";break;case"top-center":m=h/2,g=u+l/2,_="center";break;case"bottom-left":m=u,g=d-u-c+l/2,_="left";break;case"bottom-right":m=h-u,g=d-u-c+l/2,_="right";break;case"bottom-center":m=h/2,g=d-u-c+l/2,_="center";break;default:m=h/2,g=d/2-(a.length-1)*l/2,_="center"}Wt.textAlign=_,Wt.textBaseline="middle";for(let p=0;p<a.length;p++){const f=a[p];f&&Wt.fillText(f,m,g+p*l)}Wt.restore()}Mr.needsUpdate=!0}}let ia=null,at=null,ra=null,Pr=null,Ir=null,gi=null;const Ya=()=>{if(!at)try{at=new(window.AudioContext||window.webkitAudioContext),console.log("[Brute Force Audio] Created new AudioContext on user interaction."),Q&&qa(Q)}catch(i){console.error("[Brute Force Audio] Failed to create AudioContext:",i)}at&&at.state==="suspended"&&at.resume().then(()=>console.log("[Brute Force Audio] audioCtx resumed successfully! State:",at.state)).catch(i=>console.error("[Brute Force Audio] Failed to resume audioCtx:",i)),Q&&Q.dataset.shouldPlayAudio!=="false"&&(Q.muted&&(Q.muted=!1,console.log("[Brute Force Audio] activeVideo unmuted!")),Q.volume!==1&&(Q.volume=1),Q.paused&&Q.play().then(()=>console.log("[Brute Force Audio] Forced activeVideo playback to start!")).catch(e=>console.error("[Brute Force Audio] Forced activeVideo play failed:",e)))};window.addEventListener("click",Ya);window.addEventListener("touchstart",Ya);window.addEventListener("keydown",Ya);function qa(i){try{if(!at){at=new(window.AudioContext||window.webkitAudioContext);const e=()=>{at.state==="suspended"&&at.resume()};window.addEventListener("click",e),window.addEventListener("mousemove",e),window.addEventListener("touchstart",e),window.addEventListener("keydown",e)}ra?console.log("[Web Audio] Reusing existing MediaElementSourceNode connection."):(ra=at.createMediaElementSource(i),Pr=at.createBiquadFilter(),Pr.type="highpass",Pr.frequency.value=180,Ir=at.createBiquadFilter(),Ir.type="lowpass",Ir.frequency.value=4e3,gi=at.createBiquadFilter(),gi.type="peaking",gi.frequency.value=1e3,gi.Q.value=1.2,gi.gain.value=8,ra.connect(Pr),Pr.connect(Ir),Ir.connect(gi),gi.connect(at.destination),console.log("[Web Audio] Filter chain connected and created successfully.")),at.state==="suspended"&&at.resume()}catch(e){console.error("Web Audio API setup failed:",e)}}function dh(i){if(!i)return null;const e=/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/,t=i.match(e);return t&&t[2].length===11?t[2]:null}async function Ev(i){const e=["https://cobalt.projectsegfau.lt","https://cobalt.api.ryder.xyz","https://api.cobalt.tools","https://api.cobalt.download","https://cobalt.moe"],t=["https://api.piped.private.coffee"],n=["https://inv.thepixora.com","https://invidious.flokinet.to","https://invidious.nerdvpn.de","https://invidious.tiekoetter.com","https://inv.nadeko.net","https://yewtu.be"],r=async c=>{const u=new AbortController,h=setTimeout(()=>u.abort(),6e3);try{const d=await fetch(c.endsWith("/")?c:c+"/",{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify({url:`https://www.youtube.com/watch?v=${i}`,videoQuality:"720"}),signal:u.signal});if(clearTimeout(h),!d.ok)throw new Error(`HTTP ${d.status}`);const m=await d.json();if((m.status==="stream"||m.status==="redirect"||m.status==="success")&&m.url)return console.log(`[YouTube Client] Success from Cobalt instance: ${c}`),m.url;throw new Error(`Invalid Cobalt response status: ${m.status}`)}catch(d){throw clearTimeout(h),d}},s=async c=>{const u=new AbortController,h=setTimeout(()=>u.abort(),6e3);try{const d=await fetch(`${c}/streams/${i}`,{signal:u.signal});if(clearTimeout(h),!d.ok)throw new Error(`HTTP ${d.status}`);const m=await d.json();if(!m.videoStreams||m.videoStreams.length===0)throw new Error("No videoStreams");const g=m.videoStreams.find(_=>_.format==="MPEG_4"||_.mimeType.includes("video/mp4"));if(!g||!g.url)throw new Error("No MP4 stream found");return console.log(`[YouTube Client] Success from Piped instance: ${c}`),g.url}catch(d){throw clearTimeout(h),d}},o=async c=>{const u=new AbortController,h=setTimeout(()=>u.abort(),6e3);try{const d=await fetch(`${c}/api/v1/videos/${i}`,{signal:u.signal});if(clearTimeout(h),!d.ok)throw new Error(`HTTP ${d.status}`);const m=await d.json();if(!m.formatStreams||m.formatStreams.length===0)throw new Error("No formatStreams");const g=m.formatStreams.find(p=>p.container==="mp4"||p.type.includes("video/mp4"));if(!g||!g.url)throw new Error("No MP4 stream found");let _=g.url;if(_.includes("local=true")||(_+=_.includes("?")?"&local=true":"?local=true"),_.startsWith("/"))_=c+_;else if(_.startsWith("http")){const p=new URL(_),f=new URL(c);p.host=f.host,p.protocol=f.protocol,p.searchParams.has("local")||p.searchParams.set("local","true"),_=p.toString()}return console.log(`[YouTube Client] Success from Invidious instance: ${c}`),_}catch(d){throw clearTimeout(h),d}},a=c=>new Promise((u,h)=>{let d=[],m=0;c.forEach(g=>{Promise.resolve(g).then(u).catch(_=>{d.push(_),m++,m===c.length&&h(new Error("All client instances failed: "+d.map(p=>p.message).join(", ")))})})}),l=[...e.map(r),...t.map(s),...n.map(o)];try{return await a(l)}catch(c){throw console.error("[YouTube Client] All client-side resolution attempts failed:",c),c}}async function fh(i){try{const e=await fetch(qs(`/api/yt-resolve?id=${i}`));if(!e.ok)throw new Error(`Server returned HTTP ${e.status}`);const t=await e.json();if(!t.url)throw new Error("Server response missing URL");return t.url.startsWith("/api/")?qs(t.url):t.url}catch(e){return console.warn("[YouTube] Server proxy failed. Falling back to client-side Piped/Invidious racing...",e.message),await Ev(i)}}async function Aa(i,e,t){let n=i;if(!i){ia=null,ot&&(ot.destroy(),ot=null),Q&&(Q.pause(),Q.removeAttribute("src"),Q.load()),At&&(At.dispose(),At=null);return}const r=dh(i);if(r)try{n=await fh(r)}catch(a){console.error("Failed to resolve YouTube video:",a);return}if(n===ia&&Q){Q.loop=e,Q.muted=!t,Q.dataset.shouldPlayAudio=!!t;return}ia=n,ot&&(ot.destroy(),ot=null);let s=!1;Q||(Q=document.createElement("video"),Q.preload="auto",Q.playsInline=!0,Q.webkitPlaysInline=!0,Q.crossOrigin="anonymous",s=!0),Q.loop=e,Q.muted=!t,Q.dataset.shouldPlayAudio=!!t,Q.crossOrigin="anonymous";const o=ch(n);if(o.includes(".m3u8")&&typeof Hls<"u"?Hls.isSupported()?(ot=new Hls({maxBufferLength:8,maxMaxBufferLength:12,enableWorker:!0,lowLatencyMode:!0}),ot.loadSource(o),ot.attachMediaElement(Q),ot.on(Hls.Events.MANIFEST_PARSED,()=>{console.log("[HLS.js] Manifest loaded, playing...")}),ot.on(Hls.Events.ERROR,(a,l)=>{if(l.fatal)switch(l.type){case Hls.ErrorTypes.NETWORK_ERROR:console.warn("[HLS.js] Network error, attempting recovery...",l),ot.startLoad();break;case Hls.ErrorTypes.MEDIA_ERROR:console.warn("[HLS.js] Media error, attempting recovery...",l),ot.recoverMediaError();break;default:console.error("[HLS.js] Unrecoverable error",l);break}})):Q.canPlayType("application/vnd.apple.mpegurl")&&(Q.src=o,Q.load()):(Q.src=o,Q.load()),s)try{qa(Q)}catch(a){console.error("Audio filter setup failed:",a)}At||(At=new $u(Q),At.colorSpace=Qe,At.minFilter=pt,At.generateMipmaps=!1),Q.play().then(()=>{console.log("Preset video play started successfully.")}).catch(a=>{console.log("Preset video autoplay blocked. Retrying with mute...",a),Q.muted=!0,Q.play().then(()=>{console.log("Preset muted fallback autoplay succeeded!");const l=()=>{Q.muted=!t,at&&at.state==="suspended"&&at.resume(),console.log("User interacted. Restored preset audio state."),document.removeEventListener("click",l),document.removeEventListener("keydown",l),document.removeEventListener("touchstart",l)};document.addEventListener("click",l),document.addEventListener("keydown",l),document.addEventListener("touchstart",l)}).catch(l=>{console.error("Preset even muted autoplay failed:",l)})})}function Tv(){new th;const i=document.createElement("canvas");i.width=1,i.height=1;const e=new $r(i);return e.colorSpace=Qe,Qn=null,bi=e,Ys=e,Mn=null,new Promise(t=>{Xt=t,setTimeout(()=>{Xt&&(Xt(),Xt=null)},1800),Xa()})}function su(i){const e=Math.floor(i/60),t=i%60;if(e!==Ea){Ea=e,Qo=[];const s=Math.max(1,ah),o=Math.max(.1,sh),a=Math.max(o,oh),l=60/s;for(let c=0;c<s;c++){const u=o+Math.random()*(a-o),h=c*l,d=Math.max(0,l-u),m=h+Math.random()*d;Qo.push({start:m,end:m+u})}}let n=!1;for(const s of Qo)if(t>=s.start&&t<=s.end){n=!0;break}return ea+=((n?1:0)-ea)*.12,Math.min(Math.max(ea,0),1)}function bv(i,e,t){if(!i)return;i.uIsVideo&&(i.uIsVideo.value=Ft.mode==="video"?1:0),i.uPowerOff&&(i.uPowerOff.value=Ft.mode==="custom_image"&&!yt?1:0),i.uScaleX&&i.uScaleY&&(i.uScaleX.value=1,i.uScaleY.value=1),i.uTextureText.value=Mr,typeof i.uFilterMode<"u"&&(i.uFilterMode.value=In),i.uFilterColor&&i.uFilterColor.value.set(Yr);const n=()=>{ft?dt(ft):ta>0?(ta-=t,dt(Ns("283f4b3c3c"),"top-left")):dt("")};if(qn==="transition_in"){if(an+=t,xt=!0,Xn(),dt(""),i.uTexture.value=Ut,i.uChildVisibility.value=0,an>=ru){if(qn="active",an=0,xt=!1,mi.clearRect(0,0,gn.width,gn.height),Mn&&Mn.image){mi.save(),mi.filter="invert(1)";const s=720,o=s*(769/612),a=(gn.width-s)/2,l=(gn.height-o)/2;mi.drawImage(Mn.image,a,l,s,o),mi.restore()}ei.needsUpdate=!0}return}if(qn==="active"){an+=t,xt=!1,ft?dt(ft,nr):an<=2?dt(Ns("283f4b3a3f342f2f"),"top-left"):dt(""),i.uScaleX&&(i.uScaleX.value=1.936872),i.uTexture.value=ei,i.uChildVisibility.value=0,an>=Ta&&(qn="transition_out",an=0,xt=!0);return}if(qn==="transition_out"){an+=t,xt=!0,Xn(),dt(""),i.uTexture.value=Ut,i.uChildVisibility.value=0,an>=ru&&(qn="idle",an=0,xt=!1,ta=2);return}if(cn==="static"){xt=!1,Xn(),i.uTexture.value=Ut,i.uChildVisibility.value=0,dt(ft||"");return}if(cn==="custom_image"&&yt){xt=!1,i.uTexture.value=yt,i.uChildVisibility.value=0,dt(ft||"");return}if(Ft.mode==="static"){xt=!1,Xn(),i.uTexture.value=Ut,dt(ft||""),i.uChildVisibility.value=0;return}if(Ft.mode==="custom_image"){xt=!1,yt?i.uTexture.value=yt:(mi.fillStyle="#000000",mi.fillRect(0,0,gn.width,gn.height),ei.needsUpdate=!0,i.uTexture.value=ei),dt(ft||""),i.uChildVisibility.value=0;return}if(Ft.mode==="default"){xt=!1,n(),yt||Qn?(i.uScaleX&&(i.uScaleX.value=1.936872),i.uTexture.value=yt||Qn,i.uTextureChild.value=bi,i.uChildVisibility.value=su(e)):(Xn(),i.uTexture.value=Ut,ft||dt("SEÑAL PENDIENTE"),i.uChildVisibility.value=0);return}if(Ft.mode==="video"){xt=!1,At&&Q&&(Q.readyState>=2||Q.currentTime>0)?(Q.readyState>=2&&(At.needsUpdate=!0),i.uTexture.value=At):(Xn(),i.uTexture.value=Ut),dt(ft||""),i.uChildVisibility.value=0;return}if(Ft.mode==="slideshow"){const s=Ft.slideshow.images;if(!s||s.length===0){xt=!1,Xn(),i.uTexture.value=Ut,ft||dt("SEÑAL PENDIENTE"),i.uChildVisibility.value=0;return}if(s.length<=1){xt=!1;const o=s[0],a=eu[o]||Qn;n(),i.uTexture.value=a,i.uChildVisibility.value=0;return}if(Lr+=t,xt)Xn(),dt(""),i.uTexture.value=Ut,i.uChildVisibility.value=0,Lr>=Ft.slideshow.transitionDuration&&(Jo=(Jo+1)%s.length,Lr=0,xt=!1);else{const o=s[Jo],a=eu[o]||Qn;n(),i.uTexture.value=a,o===Ns("4407340345130a03")?(i.uScaleX&&(i.uScaleX.value=1.936872),i.uTextureChild.value=bi,i.uChildVisibility.value=su(e)):i.uChildVisibility.value=0,Lr>=Ft.slideshow.slideDuration&&(Lr=0,xt=!0)}}const r=i.uTexture.value;if(r&&r.image){const s=r.image;let o=!0;if(s instanceof HTMLVideoElement&&(s.readyState<2||s.paused)&&(o=!1),o)try{tu.drawImage(s,0,0,1,1);const a=tu.getImageData(0,0,1,1).data;let l=a[0]/255,c=a[1]/255,u=a[2]/255;const h=.299*l+.587*c+.114*u;if(In===1)l=h*.22*1.35,c=h*1*1.35,u=h*.08*1.35;else if(In===2)l=h*1*1.35,c=h*.15*1.35,u=h*.15*1.35;else if(In===3)l=h*1*1.35,c=h*.82*1.35,u=0;else if(In===4){const g=e*.15%1,_=new we().setHSL(g,1,.5);l=h*_.r*1.5,c=h*_.g*1.5,u=h*_.b*1.5}else if(In===5){const g=new we(Yr);l=h*g.r*1.35,c=h*g.g*1.35,u=h*g.b*1.35}else l=l*.68,c=c*.73,u=u*.9;const d=.299*l+.587*c+.114*u;let m=1;d>.82&&(m=.82/d),Ur.setRGB(l*m,c*m,u*m)}catch{Ur.setHex(11196671)}else Ur.setHex(11196671)}else Ur.setHex(11196671)}function Av(){Mt&&(clearTimeout(Mt),Mt=null),Qt=!1,Q&&(Q.pause(),Q.src="",Q.load()),Yt&&Yt.close(),yt&&yt.dispose(),ei.dispose(),Ut.dispose(),Mr.dispose(),At&&At.dispose()}const ja=()=>{Ft.mode==="video"&&Q&&Q.paused&&Q.play().catch(()=>{})};window.addEventListener("click",ja);window.addEventListener("pointerdown",ja);window.addEventListener("touchstart",ja);/*! REJECTED FALSE ICONS (5/7) */const ou=i=>{const e=new fn;let t=!1;return i.traverse(n=>{if(n.isMesh){const r=new fn().setFromObject(n);t?e.union(r):(e.copy(r),t=!0)}}),e};function wv(i,e,t,n){const r=new N0,s=new Promise((o,a)=>{r.load("/crt-tv.glb",l=>{Dr("model",50),o(l)},l=>{let c=l.total;(!c||c===0)&&(c=4862760);const u=Math.min(l.loaded/c,1);Dr("model",u*50)},l=>{console.error("Error loading TV GLTF:",l),a(l)})});return Dr("texture1",10),Dr("texture2",10),s.then(o=>Tv().then(()=>o)).then(o=>{const a=new $n;i.add(a);const l=o.scene;a.add(l),l.position.set(0,0,0),l.rotation.set(0,0,0),l.scale.set(1,1,1),l.updateMatrixWorld(!0);const c=2.4,h=ou(l).getSize(new P),d=c/h.y;l.scale.setScalar(d),l.updateMatrixWorld(!0);const m=ou(l),g=m.getCenter(new P);l.position.x=-g.x,l.position.y=-m.min.y,l.position.z=-g.z,l.rotation.y=Math.PI,l.updateMatrixWorld(!0),l.traverse(Z=>{Z.isMesh&&(Z.castShadow=!0,Z.receiveShadow=!0,Z.material&&(Z.material.roughness=Math.max(Z.material.roughness,.45),Z.material.metalness=Math.min(Z.material.metalness,.8)))});const _=new mr(1.75,1.54,16,16),p=new Fn({vertexShader:mv,fragmentShader:gv,uniforms:{uTime:{value:0},uTexture:{value:null},uTextureChild:{value:null},uTextureText:{value:null},uChildVisibility:{value:0},uMagneticCenter:{value:new be(-10,-10)},uMagneticTime:{value:0},uMagneticIntensity:{value:0},uMagneticBuildup:{value:0},uMagneticVelocity:{value:new be(0,0)},uFilterMode:{value:0},uFilterColor:{value:new we("#ffffff")},uScaleX:{value:1},uScaleY:{value:1},uIsVideo:{value:0},uPowerOff:{value:0}}}),f=new Ht(_,p),E=m.max.z-g.z;f.position.set(0,1.3,E+2.01),a.add(f);const M=new Ws(11196671,12,9,Math.PI/2.2,.95,1.1);M.position.set(0,1.3,E+2.05);const b=new nt;b.position.set(0,0,E+5.5),a.add(b),M.target=b,a.add(M);const C=new Ws(16733457,14,3.2,Math.PI/2.5,.9,2);C.position.set(0,1.3,E+.3);const R=new nt;R.position.set(0,1.3,E-.5),a.add(R),C.target=R,a.add(C),a.position.set(0,0,12),e.target.set(0,1.3,12),n.position.set(0,1.3,12),t.target=n;let A=!1,z=0;const x=3.5,T=.22;let D=0,W=0,$=0,I=0,O=0,V=0;return{tvGroup:a,crtScreen:f,crtLight:M,internalCabinetLight:C,update:(Z,B)=>{if(p.uniforms.uTime.value=Z,V=Math.max(V-B*5,0),I*=Math.max(1-B*6,0),O*=Math.max(1-B*6,0),A){z=Math.min(z+B,x);const X=z/x;p.uniforms.uMagneticIntensity.value=Math.min(.15+X*.85+V*.4,1.3),p.uniforms.uMagneticBuildup.value=X,p.uniforms.uMagneticTime.value+=B,p.uniforms.uMagneticVelocity.value.set(I,O);const ae=Math.min(X*.032,.032);ae>.001?a.position.set((Math.random()-.5)*ae,(Math.random()-.5)*ae,12+(Math.random()-.5)*ae):a.position.set(0,0,12)}else if(W>0)if($+=B,p.uniforms.uMagneticTime.value+=B,p.uniforms.uMagneticVelocity.value.set(0,0),$<0){const X=($+T)/T,ae=Math.sin(X*Math.PI)*.55,de=Math.min(D+ae,1.4);p.uniforms.uMagneticIntensity.value=de,p.uniforms.uMagneticBuildup.value=de,a.position.set(0,0,12)}else{const X=Math.min($/W,1),ae=1-X*X,de=D*ae;if(de<=.001||X>=1)p.uniforms.uMagneticIntensity.value=0,p.uniforms.uMagneticBuildup.value=0,W=0,a.position.set(0,0,12);else{p.uniforms.uMagneticIntensity.value=de,p.uniforms.uMagneticBuildup.value=de;const me=de*.032;a.position.set((Math.random()-.5)*me,(Math.random()-.5)*me,12+(Math.random()-.5)*me)}}else p.uniforms.uMagneticVelocity.value.set(0,0),xt?a.position.set((Math.random()-.5)*.012,(Math.random()-.5)*.012,12+(Math.random()-.5)*.012):a.position.set(0,0,12);bv(p.uniforms,Z,B),M.color.lerp(Ur,.12),M.intensity=(1.4+Math.sin(Z*35)*.18+Math.sin(Z*7)*.06)*16,C.intensity=10+Math.sin(Z*22)*.8+Math.sin(Z*4)*.25,l.position.set(-g.x,-m.min.y,-g.z)},destroy:()=>{_.dispose(),p.dispose(),Av(),i.remove(a)},startMagneticHold:Z=>{A=!0,z=p.uniforms.uMagneticBuildup.value*x,W=0,$=0,p.uniforms.uMagneticCenter.value.copy(Z)},stopMagneticHold:()=>{A&&(A=!1,D=p.uniforms.uMagneticBuildup.value,W=1.5+D*9,$=-T)},setVelocityBoost:(Z,B)=>{const X=Math.sqrt(Z*Z+B*B);V=Math.min(X*12,.6),I=Z*8,O=B*8}}})}/*! EL Psy Koongro (6/7) */function Rv(i,e,t){let n=-10,r=!1,s=!0,o=-10,a=0;const l=i.position.distanceTo(e.target);let c=0,u=Math.PI/2-.15,h=l,d=0,m=Math.PI/2-.15,g=l,_=1;const p=5.5,f=z=>{n=z},E=()=>{r=!0,s=!0,a=0},M=()=>{r&&(s=!0,a=0)},b=()=>{r=!1,s=!0,a=0},C=()=>{s=!0,a=0};return t.addEventListener("pointerdown",E),t.addEventListener("pointermove",M),t.addEventListener("pointerup",b),t.addEventListener("wheel",C),{update:(z,x)=>{r&&f(z);const T=z-n;if(!r&&T>5){const I=i.position.x,O=i.position.y-1.3,V=i.position.z-12,j=Math.sqrt(I*I+O*O+V*V),Y=Math.acos(O/j),K=Math.atan2(I,V);z-o>5.5&&(s?(c=K,u=Y,h=j,s=!1):(c=d,u=m,h=g),d=(Math.random()-.5)*.28,m=Math.PI/2-.15+(Math.random()-.5)*.06,window.innerWidth<768?g=6.8+Math.random()*.7:g=5.2+Math.random()*.5,_=0,o=z),_=Math.min(_+x/p,1);const q=_,re=q*q*q*(q*(q*6-15)+10),Z=Zn.lerp(c,d,re),B=Zn.lerp(u,m,re),X=Zn.lerp(h,g,re);a=Zn.lerp(a,1,.015);const ae=Z+Math.sin(z*.15)*.02*a,de=B+Math.cos(z*.2)*.015*a,me=X+Math.sin(z*.1)*.08*a;i.position.x=me*Math.sin(de)*Math.sin(ae),i.position.y=1.3+me*Math.cos(de),i.position.z=12+me*Math.sin(de)*Math.cos(ae)}e.update(),i.position.y<.2&&(i.position.y=.2),e.target.y<0&&(e.target.y=0)},destroy:()=>{t.removeEventListener("pointerdown",E),t.removeEventListener("pointermove",M),t.removeEventListener("pointerup",b),t.removeEventListener("wheel",C)}}}const ai=document.getElementById("webgl-canvas"),Cv=document.getElementById("app-container"),{scene:io,camera:ro,renderer:sa,controls:so}=C0(Cv,ai);no("scene");const oa=I0();no("overlay");const wa=D0(io);no("lights");const Lv=U0(io);no("particles");const Pv=Rv(ro,so,ai);let Ra=null,si=null;wv(io,so,wa.spotlight,wa.spotTarget).then(i=>{Ra=i.update,si=i,window.tvGroup=i.tvGroup,window.crtScreen=i.crtScreen,window.crtLight=i.crtLight,window.internalCabinetLight=i.internalCabinetLight,Qc()}).catch(i=>{console.error("TV Model failed to load:",i),Qc()});const zr=new A0,rr=new be;let Gr=null,Qi=null,Ca={x:0,y:0},Ka=!1;const Iv=950,Dv=6,au=new dn,lu=new P,cu=new P,aa=new P,uu=new Pn,hu=new be(-1,-1),Uv=i=>{if(!window.crtScreen||!si)return;const e=ai.getBoundingClientRect();rr.x=(i.clientX-e.left)/e.width*2-1,rr.y=-((i.clientY-e.top)/e.height)*2+1,zr.setFromCamera(rr,ro);const t=window.crtScreen.material.uniforms.uMagneticCenter.value,n=t.x,r=t.y,s=zr.intersectObject(window.crtScreen);s.length>0&&s[0].uv?t.copy(s[0].uv):(window.crtScreen.updateWorldMatrix(!0,!1),window.crtScreen.getWorldQuaternion(au),window.crtScreen.getWorldPosition(lu),uu.setFromNormalAndCoplanarPoint(new P(0,0,1).applyQuaternion(au),lu),zr.ray.intersectPlane(uu,cu)&&(window.crtScreen.worldToLocal(aa.copy(cu)),t.set(Zn.clamp(aa.x/1.75+.5,.02,.98),Zn.clamp(aa.y/1.54+.5,.02,.98)))),hu.x>=0&&si.setVelocityBoost&&si.setVelocityBoost(t.x-n,t.y-r),hu.set(t.x,t.y)},ph=()=>{Gr&&(clearTimeout(Gr),Gr=null),Qi=null},oo=()=>{ph(),Ka=!1,so.enabled=!0,si&&si.stopMagneticHold()};ai.addEventListener("pointerdown",i=>{const e=ai.getBoundingClientRect();if(Ca={x:i.clientX,y:i.clientY},rr.x=(i.clientX-e.left)/e.width*2-1,rr.y=-((i.clientY-e.top)/e.height)*2+1,zr.setFromCamera(rr,ro),window.crtScreen&&si){const t=zr.intersectObject(window.crtScreen);t.length>0&&t[0].uv&&(Qi=t[0].uv.clone(),Gr=setTimeout(()=>{Qi&&(so.enabled=!1,Ka=!0,si.startMagneticHold(Qi),Qi=null),Gr=null},Iv))}});ai.addEventListener("pointermove",i=>{if(Qi&&i.buttons>0){const e=i.clientX-Ca.x,t=i.clientY-Ca.y;Math.sqrt(e*e+t*t)>Dv&&ph()}Ka&&Uv(i)});ai.addEventListener("pointerup",oo);ai.addEventListener("pointercancel",oo);document.addEventListener("visibilitychange",()=>{document.hidden&&oo()});window.addEventListener("blur",oo);const du=new g0,mh=()=>{requestAnimationFrame(mh);const i=Math.min(du.getDelta(),.1),e=du.getElapsedTime();oa.update(e),wa.update(e),Lv.update(e),Ra&&Ra(e,i),Pv.update(e,i),sa.clear(),sa.render(io,ro),sa.render(oa.overlayScene,oa.overlayCamera)};mh();
